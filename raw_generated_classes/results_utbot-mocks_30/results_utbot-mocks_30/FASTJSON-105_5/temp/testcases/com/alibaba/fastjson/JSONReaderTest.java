...
public class JSONReaderTest {
    ...
    public void testReadLong2() throws Throwable  {
        ...
        try {
            ...
            setField(jSONReader, "context", null);
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            javax.print.event.PrintJobAttributeEvent[] printJobAttributeEventArray = new javax.print.event.PrintJobAttributeEvent[0];
            when(defaultJSONParserMock.parse()).thenReturn(((Object) printJobAttributeEventArray));
            setField(jSONReader, "parser", defaultJSONParserMock);
    ...
    public void testReadObject13() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] longSortingSinkArray = createArray("java.util.stream.SortedOps$LongSortingSink", 0);
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Map.class))).thenReturn(((Object) longSortingSinkArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(longSortingSinkArray, actual));
    }
    ///endregion
    ...
    public void testReadObject16() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        javax.swing.DefaultListCellRenderer.UIResource[][] uIResourceArray = new javax.swing.DefaultListCellRenderer.UIResource[0][];
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) uIResourceArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(uIResourceArray, actual));
    }
    ///endregion
