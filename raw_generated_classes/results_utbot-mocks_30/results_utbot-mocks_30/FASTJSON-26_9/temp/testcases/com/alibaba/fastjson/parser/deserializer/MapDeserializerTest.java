...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        Object defaultProgressMeteringPolicy = createInstance("sun.net.DefaultProgressMeteringPolicy");
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class wildcardTypeImplType = Class.forName("java.lang.reflect.Type");
        Class defaultProgressMeteringPolicyType = Class.forName("java.lang.Object");
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, wildcardTypeImplType, defaultProgressMeteringPolicyType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = wildcardTypeImpl;
        deserialzeMethodArguments[2] = defaultProgressMeteringPolicy;
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        java.lang.Object[] privilegedThreadFactoryArray = createArray("java.util.concurrent.Executors$PrivilegedThreadFactory", 0);
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class parameterizedTypeImplType = Class.forName("java.lang.reflect.Type");
        Class privilegedThreadFactoryArrayType = Class.forName("java.lang.Object");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, parameterizedTypeImplType, privilegedThreadFactoryArrayType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[3];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = parameterizedTypeImpl;
        deserialzeMethodArguments[2] = ((Object) privilegedThreadFactoryArray);
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
    ...
    public void testParseMap1() throws Throwable  {
        Class class1 = Object.class;
        javax.swing.plaf.basic.BasicBorders[] basicBordersArray = new javax.swing.plaf.basic.BasicBorders[0];
        
        MapDeserializer.parseMap(null, null, class1, basicBordersArray);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        Class class1 = Object.class;
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        javax.sound.sampled.AudioPermission[] audioPermissionArray = new javax.sound.sampled.AudioPermission[0];
        
        MapDeserializer.parseMap(null, null, class1, typeVariableImpl, audioPermissionArray);
    }
    ///endregion
