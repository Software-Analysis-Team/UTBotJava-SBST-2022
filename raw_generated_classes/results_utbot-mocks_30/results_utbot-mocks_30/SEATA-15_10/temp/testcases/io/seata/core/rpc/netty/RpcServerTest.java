...
public class RpcServerTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        RpcServer rpcServer = ((RpcServer) createInstance("io.seata.core.rpc.netty.RpcServer"));
        java.lang.Object[] derIndefLenConverterArray = createArray("sun.security.util.DerIndefLenConverter", 0);
        
        rpcServer.userEventTriggered(((ChannelHandlerContext) null), derIndefLenConverterArray);
    }
    ///endregion
