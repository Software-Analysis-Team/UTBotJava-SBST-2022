...
public class ReverseOrderingTest {
    ...
    public void testMin8() throws Throwable  {
        ...
        when(orderingMock.max(any(), any(), any(), any())).thenReturn(((Object) operatorArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        Object actual = reverseOrdering.min(connectionResetExceptionArray, findOpArray, null, ((java.lang.Object[]) null));
    ...
    public void testMax8() throws Throwable  {
        ...
        Object actual = reverseOrdering.max(connectionResetExceptionArray, handlerArray, fifoWaitQueueArray, ((java.lang.Object[]) null));
