...
public class JSONReaderTest {
    ...
    public void testReadObject5() throws Throwable  {
        ...
        when(defaultJSONParserMock.parse()).thenReturn(((Object) attributeArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(attributeArray, actual));
    }
    ///endregion
    ...
    public void testReadObject15() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        DefaultListCellRenderer.UIResource uIResource = ((DefaultListCellRenderer.UIResource) createInstance("javax.swing.DefaultListCellRenderer$UIResource"));
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) uIResource));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(uIResource, actual));
    }
    ///endregion
