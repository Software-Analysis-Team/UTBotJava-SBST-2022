...
public class ReverseOrderingTest {
    ...
    public void testMin4() throws Throwable  {
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(nativeSeedGeneratorArray, actual));
    }
    ///endregion
    ...
    public void testMin6() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] delegatedScheduledExecutorServiceArray = createArray("java.util.concurrent.Executors$DelegatedScheduledExecutorService", 0);
        when(orderingMock.max(any(), any())).thenReturn(((Object) delegatedScheduledExecutorServiceArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] fifoWaitQueueArray = createArray("java.util.concurrent.SynchronousQueue$FifoWaitQueue", 0);
        
        Object actual = reverseOrdering.min(fifoWaitQueueArray, null);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(delegatedScheduledExecutorServiceArray, actual));
    }
    ///endregion
    ...
    public void testMin8() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] attributeEntryArray = createArray("[Ljava.text.AttributeEntry;", 0);
        when(orderingMock.max(any(), any(), any(), any())).thenReturn(((Object) attributeEntryArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        JarEntry jarEntry = ((JarEntry) createInstance("java.util.jar.JarEntry"));
        
        Object actual = reverseOrdering.min(jarEntry, null, null, ((java.lang.Object[]) null));
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(attributeEntryArray, actual));
    }
    ///endregion
    ...
    public void testMax2() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        javax.crypto.spec.DHParameterSpec[][] dHParameterSpecArray = new javax.crypto.spec.DHParameterSpec[0][];
        
        Object actual = reverseOrdering.max(null, dHParameterSpecArray);
    ...
    public void testMax8() throws Throwable  {
        ...
        Object actual = reverseOrdering.max(connectionResetExceptionArray, fifoWaitQueueArray, handlerArray, ((java.lang.Object[]) null));
