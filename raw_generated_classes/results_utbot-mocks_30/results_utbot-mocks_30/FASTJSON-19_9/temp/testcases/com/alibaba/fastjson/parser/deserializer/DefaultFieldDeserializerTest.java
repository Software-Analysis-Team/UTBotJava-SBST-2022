...
public class DefaultFieldDeserializerTest {
    ...
    public void testParseField5() throws Throwable  {
        ...
        setField(defaultFieldDeserializer, "fieldInfo", fieldInfoMock);
        ObjectDeserializer objectDeserializerMock = mock(ObjectDeserializer.class);
        java.lang.Object[] serialCallbackContextArray = createArray("[Ljava.io.SerialCallbackContext;", 0);
        when(objectDeserializerMock.deserialze(any(), any(), any())).thenReturn(((Object) serialCallbackContextArray));
        defaultFieldDeserializer.fieldValueDeserilizer = objectDeserializerMock;
        jdk.net.SocketFlow.Status[][] statusArray = new jdk.net.SocketFlow.Status[0][];
        Class class1 = Object.class;
        
        defaultFieldDeserializer.parseField(((DefaultJSONParser) null), statusArray, class1, ((Map) null));
    }
    ///endregion
    ...
    public void testParseFieldUnwrapped2() throws Throwable  {
        DefaultFieldDeserializer defaultFieldDeserializer = ((DefaultFieldDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer"));
        java.lang.Object[] systemClassLoaderActionArray = createArray("java.lang.SystemClassLoaderAction", 0);
        Class class1 = Object.class;
        
        defaultFieldDeserializer.parseFieldUnwrapped(null, systemClassLoaderActionArray, class1, null);
    }
    ///endregion
