...
public class JSONReaderTest {
    ...
    public void testReadObject2() throws Throwable  {
        ...
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) defaultMXBeanMappingFactoryArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(defaultMXBeanMappingFactoryArray, actual));
    }
    ///endregion
    ...
    public void testReadInteger2() throws Throwable  {
        ...
        try {
            ...
            setField(jSONReader, "context", null);
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            javax.swing.ComponentInputMap[] componentInputMapArray = new javax.swing.ComponentInputMap[0];
            when(defaultJSONParserMock.parse()).thenReturn(((Object) componentInputMapArray));
            setField(jSONReader, "parser", defaultJSONParserMock);
