...
public class JSONReaderTest {
    ...
    public void testReadInteger2() throws Throwable  {
        ...
        try {
            ...
            setField(jSONReader, "context", null);
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            org.springframework.beans.propertyeditors.CharArrayPropertyEditor[] charArrayPropertyEditorArray = new org.springframework.beans.propertyeditors.CharArrayPropertyEditor[0];
            when(defaultJSONParserMock.parse()).thenReturn(((Object) charArrayPropertyEditorArray));
            setField(jSONReader, "parser", defaultJSONParserMock);
    ...
    public void testReadObject13() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] collectionNodeArray = createArray("java.util.stream.Nodes$CollectionNode", 0);
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Map.class))).thenReturn(((Object) collectionNodeArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(collectionNodeArray, actual));
    }
    ///endregion
    ...
    public void testReadObject21() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] patternInfoArray = createArray("org.springframework.util.AntPathMatcher$AntPatternComparator$PatternInfo", 0);
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) patternInfoArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(patternInfoArray, actual));
    }
    ///endregion
    ...
    public void testReadObject27() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] actionsArray = createArray("javax.swing.plaf.basic.BasicTreeUI$Actions", 0);
