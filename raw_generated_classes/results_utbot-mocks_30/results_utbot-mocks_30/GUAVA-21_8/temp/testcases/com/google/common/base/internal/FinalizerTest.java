...
public class FinalizerTest {
    ...
    public void testRun3() throws Throwable  {
        ...
        try {
            ...
            setField(cleaner, "next", null);
            setField(cleaner, "queue", null);
            setField(cleaner, "referent", null);
            setField(softReference, "next", cleaner);
            setField(softReference, "queue", null);
