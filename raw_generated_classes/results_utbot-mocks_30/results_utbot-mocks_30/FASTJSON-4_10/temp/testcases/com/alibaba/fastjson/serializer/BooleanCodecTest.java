...
public class BooleanCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        javax.swing.plaf.metal.MetalToolBarUI[] metalToolBarUIArray = new javax.swing.plaf.metal.MetalToolBarUI[0];
        org.glassfish.jersey.internal.util.collection.ClassTypePair[] classTypePairArray = new org.glassfish.jersey.internal.util.collection.ClassTypePair[0];
        ...
        booleanCodec.write(null, metalToolBarUIArray, classTypePairArray, typeVariableImpl, 0);
    }
    ///endregion
    ...
    public void testDeserialze2() throws Throwable  {
        ...
        booleanCodec.deserialze(null, class1, ofRefArray);
    }
    ///endregion
    ...
    public void testDeserialze4() throws Throwable  {
        ...
        try {
            ...
            BooleanCodec booleanCodec = ((BooleanCodec) createInstance("com.alibaba.fastjson.serializer.BooleanCodec"));
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            java.io.FileDescriptor[] fileDescriptorArray = new java.io.FileDescriptor[0];
            when(defaultJSONParserMock.parse()).thenReturn(((Object) fileDescriptorArray));
            JSONLexer jSONLexerMock = mock(JSONLexer.class);
            when(jSONLexerMock.token()).thenReturn(0, 0, 0);
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
            java.lang.Object[] ofRefArray = createArray("java.util.stream.Nodes$CollectorTask$OfRef", 0);
            
            Object actual = booleanCodec.deserialze(defaultJSONParserMock, null, ofRefArray);
    ...
    public void testDeserialze5() throws Throwable  {
        ...
        try {
            ...
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
            Class class1 = Object.class;
            java.lang.Object[] ofRefArray1 = createArray("java.util.stream.Nodes$CollectorTask$OfRef", 0);
            
            booleanCodec.deserialze(defaultJSONParserMock, class1, ofRefArray1);
