...
public class DefaultFieldDeserializerTest {
    ...
    public void testParseField5() throws Throwable  {
        ...
        setField(defaultFieldDeserializer, "fieldInfo", fieldInfoMock);
        ObjectDeserializer objectDeserializerMock = mock(ObjectDeserializer.class);
        sun.misc.ObjectInputFilter.Config[][] configArray = new sun.misc.ObjectInputFilter.Config[9][];
        configArray[0] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[1] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[2] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[3] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[4] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[5] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[6] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[7] = ((sun.misc.ObjectInputFilter.Config[]) null);
        configArray[8] = ((sun.misc.ObjectInputFilter.Config[]) null);
        ...
        defaultFieldDeserializer.parseField(((DefaultJSONParser) null), pascalNameFilterArray, class1, ((Map) null));
    }
    ///endregion
    ...
    public void testParseFieldUnwrapped2() throws Throwable  {
        DefaultFieldDeserializer defaultFieldDeserializer = ((DefaultFieldDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer"));
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] compositeBuilderViaFromArray = createArray("[Lcom.sun.jmx.mbeanserver.DefaultMXBeanMappingFactory$CompositeBuilderViaFrom;", 0);
        
        defaultFieldDeserializer.parseFieldUnwrapped(defaultJSONParserMock, compositeBuilderViaFromArray, null, null);
    }
    ///endregion
