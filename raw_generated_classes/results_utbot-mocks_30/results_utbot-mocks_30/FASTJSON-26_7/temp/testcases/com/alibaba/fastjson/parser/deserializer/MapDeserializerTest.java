...
public class MapDeserializerTest {
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, parameterizedTypeImplType, ofRefArrayType);
    ...
    public void testDeserialze8() throws Throwable  {
        ...
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, ofRefArrayType, linkedHashMapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
    ...
    public void testParseMap1() throws Throwable  {
        ...
        java.lang.Object[] mapReduceValuesToDoubleTaskArray = createArray("java.util.concurrent.ConcurrentHashMap$MapReduceValuesToDoubleTask", 0);
        
        MapDeserializer.parseMap(null, null, parameterizedTypeImpl, mapReduceValuesToDoubleTaskArray);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        ...
        java.lang.Object[] expiringCacheArray = createArray("java.io.ExpiringCache", 0);
        
        MapDeserializer.parseMap(null, null, typeVariableImpl, typeVariableImpl1, expiringCacheArray);
    }
    ///endregion
