...
public class ReverseOrderingTest {
    ...
    public void testCompare2() throws Throwable  {
        ...
        int actual = reverseOrdering.compare(handlerArray, null);
    ...
    public void testMin6() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] findTaskArray = createArray("[Ljava.util.stream.FindOps$FindTask;", 0);
        
        Object actual = reverseOrdering.min(findTaskArray, null);
    ...
    public void testMin8() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        javax.security.auth.callback.UnsupportedCallbackException[][] unsupportedCallbackExceptionArray = new javax.security.auth.callback.UnsupportedCallbackException[0][];
        sun.security.x509.ReasonFlags[] reasonFlagsArray = new sun.security.x509.ReasonFlags[0];
        java.security.spec.ECFieldF2m[] eCFieldF2mArray = new java.security.spec.ECFieldF2m[0];
        
        Object actual = reverseOrdering.min(unsupportedCallbackExceptionArray, reasonFlagsArray, eCFieldF2mArray, ((java.lang.Object[]) null));
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(uCompactIntArrayArray, actual));
    }
    ///endregion
    ...
    public void testMax2() throws Throwable  {
        ...
        Object actual = reverseOrdering.max(handlerArray, null);
    ...
    public void testMax4() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] uRLJarFileEntryArray = createArray("sun.net.www.protocol.jar.URLJarFile$URLJarFileEntry", 0);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(uRLJarFileEntryArray, actual));
    }
    ///endregion
    ...
    public void testMax8() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] serializedFormArray = createArray("com.google.common.collect.RegularImmutableMap$KeySet$SerializedForm", 0);
        ...
        java.lang.Object[] handlerArray1 = createArray("[Ljdk.internal.org.objectweb.asm.Handler;", 0);
        java.lang.Object[] objectArray = new java.lang.Object[10];
        
        Object actual = reverseOrdering.max(handlerArray, handlerArray1, null, objectArray);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(serializedFormArray, actual));
    }
    ///endregion
