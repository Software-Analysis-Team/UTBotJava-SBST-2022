...
public class RpcServerHandlerTest {
    ...
    public void testExceptionCaught2() throws Throwable  {
        ...
        ProviderMismatchException providerMismatchException = ((ProviderMismatchException) createInstance("java.nio.file.ProviderMismatchException"));
        
        rpcServerHandler.exceptionCaught(((ChannelHandlerContext) null), providerMismatchException);
    }
    ///endregion
    ...
    public void testUserEventTriggered2() throws Throwable  {
        RpcServerHandler rpcServerHandler = ((RpcServerHandler) createInstance("io.seata.core.rpc.netty.RpcServerHandler"));
        io.netty.util.ReferenceCountUtil[] referenceCountUtilArray = new io.netty.util.ReferenceCountUtil[0];
        
        rpcServerHandler.userEventTriggered(((ChannelHandlerContext) null), referenceCountUtilArray);
    }
    ///endregion
