...
public class MapEntryNodeTest {
    ...
    public void testReplaceNode5() throws Throwable  {
        ...
        mapEntryNode.replaceNode(rootNodeMock, rootNodeMock1);
    }
    ///endregion
    ...
    public void testReplaceNode6() throws Throwable  {
        ...
        setField(mapEntryNode, "key", rootNodeMock);
        RootNode rootNodeMock1 = mock(RootNode.class);
        RootNode rootNodeMock2 = mock(RootNode.class);
        
        mapEntryNode.replaceNode(rootNodeMock1, rootNodeMock2);
    }
    ///endregion
    ...
    public void testGenerateTargets2() throws Throwable  {
        ...
        mapEntryNode.generateTargets(null, resultHolderMock, immutableMapMock);
    }
    ///endregion
    ...
    public void testIsTryNextMatch2() throws Throwable  {
        ...
        boolean actual = mapEntryNode.isTryNextMatch(immutableMapMock);
    ...
    public void testMatchTarget2() throws Throwable  {
        ...
        mapEntryNode.matchTarget(scaledBlitArray, immutableMapMock);
    }
    ///endregion
    ...
    public void testSetValue2() throws Throwable  {
        ...
        Object initialEntryValue = getFieldValue(entry, "value");
        
        Class entryClazz = Class.forName("spoon.pattern.internal.node.MapEntryNode$Entry");
        Class ctElementMockType = Class.forName("spoon.reflect.declaration.CtElement");
        Method setValueMethod = entryClazz.getDeclaredMethod("setValue", ctElementMockType);
        setValueMethod.setAccessible(true);
        java.lang.Object[] setValueMethodArguments = new java.lang.Object[1];
        setValueMethodArguments[0] = ctElementMock;
        CtElement actual = ((CtElement) setValueMethod.invoke(entry, setValueMethodArguments));
        
        assertNull(actual);
        
        Object finalEntryValue = getFieldValue(entry, "value");
        
        assertFalse(initialEntryValue == finalEntryValue);
    }
    ///endregion
