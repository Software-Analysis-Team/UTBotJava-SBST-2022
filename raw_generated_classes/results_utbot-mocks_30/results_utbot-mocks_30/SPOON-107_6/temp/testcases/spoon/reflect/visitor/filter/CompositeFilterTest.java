...
public class CompositeFilterTest {
    ...
    public void testMatches7() throws Throwable  {
        ...
        try {
            ...
            spoon.reflect.visitor.filter.FilteringOperator[] filteringOperatorArray = new spoon.reflect.visitor.filter.FilteringOperator[35];
            ...
            when(filteringOperatorMock.ordinal()).thenReturn(2, 1, 0);
    ...
    public void testMatches10() throws Throwable  {
        ...
        try {
            ...
            CompositeFilter compositeFilter = ((CompositeFilter) createInstance("spoon.reflect.visitor.filter.CompositeFilter"));
            FilteringOperator filteringOperatorMock = mock(FilteringOperator.class);
            when(filteringOperatorMock.ordinal()).thenReturn(0, 2, 2, 0);
            compositeFilter.operator = filteringOperatorMock;
    ...
    public void testMatches12() throws Throwable  {
        ...
        try {
            ...
            CompositeFilter compositeFilter = ((CompositeFilter) createInstance("spoon.reflect.visitor.filter.CompositeFilter"));
            FilteringOperator filteringOperatorMock = mock(FilteringOperator.class);
            when(filteringOperatorMock.ordinal()).thenReturn(0, 0, 2, 0);
            compositeFilter.operator = filteringOperatorMock;
            setField(compositeFilter, "filters", null);
    ...
    public void testMatches21() throws Throwable  {
        ...
        try {
            ...
            when(filterMock.matches(any())).thenReturn(true);
            filterArray[0] = filterMock;
            FilteringOperator filteringOperatorMock1 = mock(FilteringOperator.class);
            when(filteringOperatorMock1.ordinal()).thenReturn(0);
            filterArray[2] = ((Filter) filteringOperatorMock1);
            filterArray[3] = ((Filter) filteringOperatorMock1);
            filterArray[4] = ((Filter) filteringOperatorMock1);
            filterArray[5] = ((Filter) filteringOperatorMock1);
            filterArray[6] = ((Filter) filteringOperatorMock1);
            filterArray[7] = ((Filter) filteringOperatorMock1);
            filterArray[8] = ((Filter) filteringOperatorMock1);
            compositeFilter.filters = filterArray;
    ...
    public void testMatches22() throws Throwable  {
        ...
        try {
            ...
            spoon.reflect.visitor.Filter[] filterArray = new spoon.reflect.visitor.Filter[9];
            FilteringOperator filteringOperatorMock1 = mock(FilteringOperator.class);
            when(filteringOperatorMock1.ordinal()).thenReturn(2);
            filterArray[1] = ((Filter) filteringOperatorMock1);
            filterArray[2] = ((Filter) filteringOperatorMock1);
            filterArray[3] = ((Filter) filteringOperatorMock1);
            filterArray[4] = ((Filter) filteringOperatorMock1);
            filterArray[5] = ((Filter) filteringOperatorMock1);
    ...
    public void testHasMatch3() throws Throwable  {
        ...
        Method hasMatchMethod = compositeFilterClazz.getDeclaredMethod("hasMatch", filterType, ctElementMockType);
        hasMatchMethod.setAccessible(true);
        java.lang.Object[] hasMatchMethodArguments = new java.lang.Object[2];
        hasMatchMethodArguments[0] = null;
        hasMatchMethodArguments[1] = ctElementMock;
        try {
            hasMatchMethod.invoke(compositeFilter, hasMatchMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
