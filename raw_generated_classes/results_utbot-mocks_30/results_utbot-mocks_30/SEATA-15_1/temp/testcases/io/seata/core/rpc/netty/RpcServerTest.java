...
public class RpcServerTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        ...
        rpcServer.userEventTriggered(((ChannelHandlerContext) null), directFloatBufferSArray);
    }
    ///endregion
    ...
    public void testDispatch2() throws Throwable  {
        RpcServer rpcServer = ((RpcServer) createInstance("io.seata.core.rpc.netty.RpcServer"));
        com.sun.jmx.mbeanserver.MBeanInstantiator[] mBeanInstantiatorArray = new com.sun.jmx.mbeanserver.MBeanInstantiator[0];
        
        rpcServer.dispatch(0L, ((ChannelHandlerContext) null), mBeanInstantiatorArray);
    }
    ///endregion
