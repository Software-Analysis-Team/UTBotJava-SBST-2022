...
public class RmRpcClientTest {
    ...
    public void testOnRegisterMsgFail2() throws Throwable  {
        ...
        java.util.concurrent.locks.ReentrantReadWriteLock[] reentrantReadWriteLockArray = new java.util.concurrent.locks.ReentrantReadWriteLock[0];
        
        rmRpcClient.onRegisterMsgFail(string, channelMock, reentrantReadWriteLockArray, null);
    }
    ///endregion
