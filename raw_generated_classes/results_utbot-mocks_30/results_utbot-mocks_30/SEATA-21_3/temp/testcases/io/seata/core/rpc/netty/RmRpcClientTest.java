...
public class RmRpcClientTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        ...
        rmRpcClient.userEventTriggered(channelHandlerContextMock, oIDInfoArray);
    }
    ///endregion
    ...
    public void testOnRegisterMsgFail2() throws Throwable  {
        ...
        rmRpcClient.onRegisterMsgFail(string, channelMock, timeZoneNameUtilityArray, abstractMessageMock);
    }
    ///endregion
