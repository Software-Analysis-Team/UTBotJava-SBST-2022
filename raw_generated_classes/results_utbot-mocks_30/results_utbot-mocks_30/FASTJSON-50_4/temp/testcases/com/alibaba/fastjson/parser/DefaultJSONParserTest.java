...
public class DefaultJSONParserTest {
    ...
    public void testCheckMapResolve2() throws Throwable  {
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        defaultJSONParser.resolveStatus = 0;
        sun.reflect.generics.factory.CoreReflectionFactory[] coreReflectionFactoryArray = new sun.reflect.generics.factory.CoreReflectionFactory[0];
        
        defaultJSONParser.checkMapResolve(null, coreReflectionFactoryArray);
    }
    ///endregion
