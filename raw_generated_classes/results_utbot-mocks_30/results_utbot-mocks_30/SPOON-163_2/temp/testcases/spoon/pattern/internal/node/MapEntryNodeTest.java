...
public class MapEntryNodeTest {
    ...
    public void testGenerateTargets4() throws Throwable  {
        ...
        spoon.support.reflect.cu.CompilationUnitImpl[] compilationUnitImplArray = new spoon.support.reflect.cu.CompilationUnitImpl[0];
        when(defaultGeneratorMock.generateSingleTarget(any(), any(), any())).thenReturn(((Object) string), ((Object) compilationUnitImplArray));
