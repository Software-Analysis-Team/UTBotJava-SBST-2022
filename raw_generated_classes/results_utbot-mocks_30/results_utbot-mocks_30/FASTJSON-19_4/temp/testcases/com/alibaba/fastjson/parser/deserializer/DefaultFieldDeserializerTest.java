...
public class DefaultFieldDeserializerTest {
    ...
    public void testParseField5() throws Throwable  {
        ...
        defaultFieldDeserializer.fieldValueDeserilizer = objectDeserializerMock;
        java.lang.Object[] compositeBuilderViaProxyArray = createArray("[[[Lcom.sun.jmx.mbeanserver.DefaultMXBeanMappingFactory$CompositeBuilderViaProxy;", 0);
        ...
        defaultFieldDeserializer.parseField(((DefaultJSONParser) null), compositeBuilderViaProxyArray, wildcardTypeImpl1, ((Map) null));
    }
    ///endregion
    ...
    public void testParseFieldUnwrapped2() throws Throwable  {
        DefaultFieldDeserializer defaultFieldDeserializer = ((DefaultFieldDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer"));
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        org.springframework.expression.spel.ast.VariableReference[][] variableReferenceArray = new org.springframework.expression.spel.ast.VariableReference[0][];
        
        defaultFieldDeserializer.parseFieldUnwrapped(defaultJSONParserMock, variableReferenceArray, null, null);
    }
    ///endregion
