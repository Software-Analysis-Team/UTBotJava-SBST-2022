...
public class DefaultFieldDeserializerTest {
    ...
    public void testParseField5() throws Throwable  {
        ...
        setField(defaultFieldDeserializer, "fieldInfo", fieldInfoMock);
        ObjectDeserializer objectDeserializerMock = mock(ObjectDeserializer.class);
        ObjectInputFilter.Config config = ((ObjectInputFilter.Config) createInstance("sun.misc.ObjectInputFilter$Config"));
        when(objectDeserializerMock.deserialze(any(), any(), any())).thenReturn(((Object) config));
        defaultFieldDeserializer.fieldValueDeserilizer = objectDeserializerMock;
        javax.swing.text.DefaultStyledDocument.AttributeUndoableEdit[] attributeUndoableEditArray = new javax.swing.text.DefaultStyledDocument.AttributeUndoableEdit[0];
        Class class1 = Object.class;
        
        defaultFieldDeserializer.parseField(((DefaultJSONParser) null), attributeUndoableEditArray, class1, ((Map) null));
    }
    ///endregion
    ...
    public void testParseField6() throws Throwable  {
        ...
        try {
            ...
            Method parseFieldMethod = defaultFieldDeserializerClazz.getDeclaredMethod("parseField", defaultJSONParserMockType, class1, parameterizedTypeImplType, linkedHashMapType);
            parseFieldMethod.setAccessible(true);
            java.lang.Object[] parseFieldMethodArguments = new java.lang.Object[4];
    ...
    public void testParseFieldUnwrapped2() throws Throwable  {
        DefaultFieldDeserializer defaultFieldDeserializer = ((DefaultFieldDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer"));
        com.alibaba.fastjson.serializer.SerializeWriter[] serializeWriterArray = new com.alibaba.fastjson.serializer.SerializeWriter[0];
        Object wildcardTypeImpl = createInstance("com.sun.beans.WildcardTypeImpl");
        
        Class defaultFieldDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class serializeWriterArrayType = Class.forName("java.lang.Object");
        Class wildcardTypeImplType = Class.forName("java.lang.reflect.Type");
        Class mapType = Class.forName("java.util.Map");
        Method parseFieldUnwrappedMethod = defaultFieldDeserializerClazz.getDeclaredMethod("parseFieldUnwrapped", defaultJSONParserType, serializeWriterArrayType, wildcardTypeImplType, mapType);
        parseFieldUnwrappedMethod.setAccessible(true);
        java.lang.Object[] parseFieldUnwrappedMethodArguments = new java.lang.Object[4];
        parseFieldUnwrappedMethodArguments[0] = null;
        parseFieldUnwrappedMethodArguments[1] = ((Object) serializeWriterArray);
