...
public class ClobSeriliazerTest {
    ...
    public void testWrite2() throws Throwable  {
        ClobSeriliazer clobSeriliazer = ((ClobSeriliazer) createInstance("com.alibaba.fastjson.serializer.ClobSeriliazer"));
        java.lang.Object[] inProgressArray = createArray("sun.management.MappedMXBeanType$InProgress", 0);
        java.lang.Object[] annotatedElementAdapterArray = createArray("org.springframework.core.convert.TypeDescriptor$AnnotatedElementAdapter", 0);
        ...
        clobSeriliazer.write(null, inProgressArray, annotatedElementAdapterArray, typeVariableImpl, 0);
    }
    ///endregion
