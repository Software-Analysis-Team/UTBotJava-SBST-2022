...
public class JSONReaderTest {
    ...
    public void testReadObject16() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        org.springframework.expression.spel.SpelCompilerMode[] spelCompilerModeArray = new org.springframework.expression.spel.SpelCompilerMode[0];
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) spelCompilerModeArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(spelCompilerModeArray, actual));
    }
    ///endregion
