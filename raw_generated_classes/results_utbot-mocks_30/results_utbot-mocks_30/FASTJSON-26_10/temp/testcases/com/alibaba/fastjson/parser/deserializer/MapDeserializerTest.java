...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        sun.util.locale.provider.LocaleServiceProviderPool[] localeServiceProviderPoolArray = new sun.util.locale.provider.LocaleServiceProviderPool[0];
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class wildcardTypeImplType = Class.forName("java.lang.reflect.Type");
        Class localeServiceProviderPoolArrayType = Class.forName("java.lang.Object");
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, wildcardTypeImplType, localeServiceProviderPoolArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = wildcardTypeImpl;
        deserialzeMethodArguments[2] = ((Object) localeServiceProviderPoolArray);
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        java.lang.Object[] loaderEntryArray = createArray("com.sun.jmx.mbeanserver.ClassLoaderRepositorySupport$LoaderEntry", 0);
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class genericArrayTypeImplType = Class.forName("java.lang.reflect.Type");
        Class loaderEntryArrayType = Class.forName("java.lang.Object");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, loaderEntryArrayType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[3];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = genericArrayTypeImpl;
        deserialzeMethodArguments[2] = ((Object) loaderEntryArray);
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
    ...
    public void testParseMap1() throws Throwable  {
        Class class1 = Object.class;
        sun.management.MemoryUsageCompositeData[] memoryUsageCompositeDataArray = new sun.management.MemoryUsageCompositeData[0];
        
        MapDeserializer.parseMap(null, null, class1, memoryUsageCompositeDataArray);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        Class class1 = Object.class;
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        com.sun.jmx.mbeanserver.DescriptorCache[] descriptorCacheArray = new com.sun.jmx.mbeanserver.DescriptorCache[0];
        
        MapDeserializer.parseMap(null, null, class1, typeVariableImpl, descriptorCacheArray);
    }
    ///endregion
    ...
    public void testParseMap4() throws Throwable  {
        ...
        Method parseMapMethod = mapDeserializerClazz.getDeclaredMethod("parseMap", defaultJSONParserMockType, mapType, genericArrayTypeImplType, genericArrayTypeImplType, ofDoubleArrayType);
        ...
        parseMapMethodArguments[2] = genericArrayTypeImpl;
