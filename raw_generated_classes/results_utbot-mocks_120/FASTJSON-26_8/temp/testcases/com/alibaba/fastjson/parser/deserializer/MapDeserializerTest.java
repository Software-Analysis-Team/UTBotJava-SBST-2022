...
public class MapDeserializerTest {
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        org.springframework.context.expression.BeanExpressionContextAccessor[][] beanExpressionContextAccessorArray = new org.springframework.context.expression.BeanExpressionContextAccessor[0][];
        
        mapDeserializer.deserialze(null, parameterizedTypeImpl, beanExpressionContextAccessorArray);
    }
    ///endregion
    ...
    public void testDeserialze7() throws Throwable  {
        ...
        mapDeserializer.deserialze(defaultJSONParserMock, wildcardTypeImpl, null);
    }
    ///endregion
    ...
    public void testDeserialze17() throws Throwable  {
        MapDeserializer mapDeserializer = ((MapDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.MapDeserializer"));
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.time.OffsetDateTime[] offsetDateTimeArray = new java.time.OffsetDateTime[0];
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class typeVariableImplType = Class.forName("java.lang.reflect.Type");
        Class offsetDateTimeArrayType = Class.forName("java.lang.Object");
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, typeVariableImplType, offsetDateTimeArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = typeVariableImpl;
        deserialzeMethodArguments[2] = ((Object) offsetDateTimeArray);
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testParseMap1() throws Throwable  {
        Class class1 = Object.class;
        javax.swing.BoxLayout[][] boxLayoutArray = new javax.swing.BoxLayout[0][];
        
        MapDeserializer.parseMap(null, null, class1, boxLayoutArray);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        ...
        java.lang.Object[] arraysKtArraysJVMKtArray = createArray("kotlin.collections.ArraysKt__ArraysJVMKt", 0);
        
        MapDeserializer.parseMap(null, null, typeVariableImpl, typeVariableImpl1, arraysKtArraysJVMKtArray);
    }
    ///endregion
    ...
    public void testParseMap7() throws Throwable  {
        ...
        Class parameterizedTypeImplType = Class.forName("java.lang.reflect.Type");
        Class ofDoubleArrayType = Class.forName("java.lang.Object");
        Method parseMapMethod = mapDeserializerClazz.getDeclaredMethod("parseMap", defaultJSONParserMockType, mapType, parameterizedTypeImplType, parameterizedTypeImplType, ofDoubleArrayType);
        parseMapMethod.setAccessible(true);
        java.lang.Object[] parseMapMethodArguments = new java.lang.Object[5];
        parseMapMethodArguments[0] = defaultJSONParserMock;
        parseMapMethodArguments[1] = null;
        parseMapMethodArguments[2] = parameterizedTypeImpl;
