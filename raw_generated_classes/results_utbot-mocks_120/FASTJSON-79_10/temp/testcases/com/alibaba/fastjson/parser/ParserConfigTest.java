...
public class ParserConfigTest {
    ...
    @Test(timeout = 10000)
    public void testAddItemsToDeny6() throws Throwable  {
    ...
    @Test(timeout = 10000)
    public void testAddItemsToAccept5() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        java.lang.String[] stringArray = new java.lang.String[1];
        String string = ((String) createInstance("java.lang.String"));
        stringArray[0] = string;
    ...
    @Test(timeout = 10000)
    public void testAddItemsToAccept6() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(com.alibaba.fastjson.util.TypeUtils.class);
            mockedStatic.when(() -> {
    ...
    public void testGetDerializers1() throws Throwable  {
        ...
        Class class2 = java.util.TimeZone.class;
        ...
        Class class3 = java.lang.ref.WeakReference.class;
        ...
        setField(entry2, "value", referenceCodec);
        ...
        Class class8 = java.util.concurrent.atomic.AtomicLongArray.class;
        ...
        Class class11 = Comparable.class;
        ...
        Class class13 = javax.xml.datatype.XMLGregorianCalendar.class;
        ...
        setField(entry12, "value", calendarCodec);
        ...
        Class class14 = java.util.Locale.class;
        ...
        Class class15 = StringBuilder.class;
        ...
        Class class21 = java.util.concurrent.atomic.AtomicIntegerArray.class;
        setField(entry20, "key", class21);
        setField(entry20, "value", atomicCodec);
        ...
        Class class24 = java.net.Inet4Address.class;
        ...
        Class class25 = java.io.Closeable.class;
        ...
        Class class26 = BigInteger.class;
        ...
        setField(entry25, "value", bigIntegerCodec);
        ...
        Class class27 = SoftReference.class;
        ...
        Class class28 = java.net.InetSocketAddress.class;
        ...
        Class class29 = Map.class;
        setField(entry28, "key", class29);
        setField(entry28, "value", mapDeserializer);
        ...
        Class class31 = java.util.Currency.class;
        ...
        Class class36 = StringBuffer.class;
        setField(entry35, "key", class36);
        setField(entry35, "value", stringCodec);
        ...
        setField(entry36, "hashCode", 1168420930);
        Class class37 = com.alibaba.fastjson.JSONPath.class;
        setField(entry36, "key", class37);
        setField(entry36, "value", miscCodec);
        setField(entry36, "next", null);
        entryArray[4162] = entry36;
        Object entry37 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry37, "hashCode", 895766599);
        Class class38 = java.util.concurrent.atomic.AtomicBoolean.class;
        ...
        setField(entry47, "value", timeDeserializer);
        setField(entry47, "next", null);
        entryArray[5264] = entry47;
        Object entry48 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry48, "hashCode", 1746572565);
        Class class49 = char.class;
        ...
        setField(entry50, "value", sqlDateDeserializer);
        ...
        Class class56 = java.text.SimpleDateFormat.class;
        setField(entry55, "key", class56);
        setField(entry55, "value", miscCodec);
        ...
        setField(entry56, "hashCode", 249034932);
        Class class57 = java.util.concurrent.atomic.AtomicReference.class;
        setField(entry56, "key", class57);
        setField(entry56, "value", referenceCodec);
        setField(entry56, "next", null);
        entryArray[6324] = entry56;
        Object entry57 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry57, "hashCode", 1902237905);
        Class class58 = java.util.concurrent.ConcurrentMap.class;
        setField(entry57, "key", class58);
        setField(entry57, "value", mapDeserializer);
        setField(entry57, "next", null);
        entryArray[6353] = entry57;
        Object entry58 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry58, "hashCode", 1126185196);
        Class class59 = java.util.Collection.class;
        setField(entry58, "key", class59);
        setField(entry58, "value", collectionCodec);
        setField(entry58, "next", null);
        entryArray[6380] = entry58;
        Object entry59 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry59, "hashCode", 681842940);
        Class class60 = int.class;
        setField(entry59, "key", class60);
        setField(entry59, "value", integerCodec);
        setField(entry59, "next", null);
        entryArray[6396] = entry59;
        Object entry60 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry60, "hashCode", 932583850);
        Class class61 = Float.class;
        setField(entry60, "key", class61);
        setField(entry60, "value", floatCodec);
        setField(entry60, "next", null);
        entryArray[6570] = entry60;
        Object entry61 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry61, "hashCode", 914504136);
        Class class62 = java.util.Calendar.class;
        setField(entry61, "key", class62);
        setField(entry61, "value", calendarCodec);
        setField(entry61, "next", null);
        entryArray[6600] = entry61;
        ...
        setField(entry63, "hashCode", 1186339926);
        Class class64 = java.io.Serializable.class;
        setField(entry63, "key", class64);
        setField(entry63, "value", javaObjectDeserializer);
        setField(entry63, "next", null);
        entryArray[7254] = entry63;
        Object entry64 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry64, "hashCode", 1062714541);
        Class class65 = java.sql.Timestamp.class;
        ...
        setField(entry64, "value", sqlDateDeserializer1);
        ...
        Class class66 = java.net.Inet6Address.class;
        ...
        Class class68 = java.util.UUID.class;
    ...
    public void testGetDeserializer1() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.util.concurrent.SynchronousQueue[] synchronousQueueArray = new java.util.concurrent.SynchronousQueue[0];
        when(identityHashMapMock.get(any())).thenReturn(((Object) synchronousQueueArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        ...
        parserConfig.getDeserializer(null, wildcardTypeImpl);
    }
    ///endregion
    ...
    public void testGetDeserializer3() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        org.springframework.messaging.support.ErrorMessage[] errorMessageArray = new org.springframework.messaging.support.ErrorMessage[0];
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) errorMessageArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        ...
        Method getDeserializerMethod = parserConfigClazz.getDeclaredMethod("getDeserializer", classType, syntheticParameterizedTypeType);
        getDeserializerMethod.setAccessible(true);
        java.lang.Object[] getDeserializerMethodArguments = new java.lang.Object[2];
        getDeserializerMethodArguments[0] = null;
        getDeserializerMethodArguments[1] = syntheticParameterizedType;
        try {
            getDeserializerMethod.invoke(parserConfig, getDeserializerMethodArguments);
    ...
    public void testGetDeserializer4() throws Throwable  {
        ...
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) forEachOrderedTaskArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
        
        parserConfig.getDeserializer(class1, null);
    }
    ///endregion
    ...
    public void testGetDeserializer5() throws Throwable  {
        ...
        try {
            ...
            ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
            IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
            when(identityHashMapMock.get(any())).thenReturn(null, null);
            setField(parserConfig, "deserializers", identityHashMapMock);
            Class class1 = Object.class;
            ...
            parserConfig.getDeserializer(class1, genericArrayTypeImpl);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testGetDeserializer6() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        CollectionCodec collectionCodec = ((CollectionCodec) createInstance("com.alibaba.fastjson.serializer.CollectionCodec"));
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) collectionCodec));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
        
        ObjectDeserializer actual = parserConfig.getDeserializer(class1, class1);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(collectionCodec, actual));
    }
    ///endregion
    ...
    public void testGetDeserializer8() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] doubleFixedNodeBuilderArray = createArray("java.util.stream.Nodes$DoubleFixedNodeBuilder", 0);
        when(identityHashMapMock.get(any())).thenReturn(((Object) doubleFixedNodeBuilderArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer9() throws Throwable  {
        ...
        when(identityHashMapMock.get(any())).thenReturn(((Object) throwableDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer10() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] doubleFixedNodeBuilderArray = createArray("java.util.stream.Nodes$DoubleFixedNodeBuilder", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, null, ((Object) doubleFixedNodeBuilderArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
        
        parserConfig.getDeserializer(class1);
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer11() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        when(identityHashMapMock.get(any())).thenReturn(null);
        setField(parserConfig, "deserializers", identityHashMapMock);
        WildcardTypeImpl wildcardTypeImpl = ((WildcardTypeImpl) createInstance("sun.reflect.generics.reflectiveObjects.WildcardTypeImpl"));
        java.lang.reflect.Type[] typeArray = new java.lang.reflect.Type[0];
        setField(wildcardTypeImpl, "upperBounds", typeArray);
        
        parserConfig.getDeserializer(wildcardTypeImpl);
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testGetDeserializer12() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        ThrowableDeserializer throwableDeserializer = ((ThrowableDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.ThrowableDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) throwableDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    @Test(timeout = 10000)
    public void testGetDeserializer13() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        ThrowableDeserializer throwableDeserializer = ((ThrowableDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.ThrowableDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, null, ((Object) throwableDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer14() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] doubleFixedNodeBuilderArray = createArray("java.util.stream.Nodes$DoubleFixedNodeBuilder", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) doubleFixedNodeBuilderArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    @Test(timeout = 10000)
    public void testGetDeserializer15() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        ThrowableDeserializer throwableDeserializer = ((ThrowableDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.ThrowableDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) throwableDeserializer));
        ...
        ObjectDeserializer actual = parserConfig.getDeserializer(parameterizedTypeImpl);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer16() throws Throwable  {
        ParserConfig parserConfig = new ParserConfig();
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer17() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer18() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] ofRefArray = createArray("java.util.stream.Nodes$ToArrayTask$OfRef", 0);
        when(identityHashMapMock.get(any())).thenReturn(((Object) ofRefArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        ...
        parserConfig.getDeserializer(fieldInfoMock);
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testGetDeserializer19() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        NumberDeserializer numberDeserializer = ((NumberDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.NumberDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) numberDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        FieldInfo fieldInfoMock = mock(FieldInfo.class);
        Class class1 = Object.class;
        setField(fieldInfoMock, "fieldType", class1);
        ...
        ObjectDeserializer actual = parserConfig.getDeserializer(fieldInfoMock);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer20() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] ofRefArray = createArray("java.util.stream.Nodes$ToArrayTask$OfRef", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) ofRefArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        FieldInfo fieldInfoMock = mock(FieldInfo.class);
        Class class1 = Object.class;
        setField(fieldInfoMock, "fieldType", class1);
    ...
    @Test(timeout = 10000)
    public void testGetDeserializer21() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        ThrowableDeserializer throwableDeserializer = ((ThrowableDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.ThrowableDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(((Object) throwableDeserializer));
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer22() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(com.alibaba.fastjson.util.TypeUtils.class);
            Annotation annotationMock = mock(Annotation.class);
    ...
    public void testCreateFieldDeserializer2() throws Throwable  {
        ...
        parserConfig.createFieldDeserializer(parserConfig1, null, fieldInfoMock);
    }
    ///endregion
    ...
    public void testCreateFieldDeserializer4() throws Throwable  {
        ...
        when(jSONFieldMock.deserializeUsing()).thenReturn(class1, class1);
        when(fieldInfoMock.getAnnotation()).thenReturn(jSONFieldMock, jSONFieldMock);
        setField(fieldInfoMock, "fieldClass", class1);
        
        FieldDeserializer actual = parserConfig.createFieldDeserializer(null, javaBeanInfoMock, fieldInfoMock);
        
        DefaultFieldDeserializer expected = ((DefaultFieldDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer"));
        setField(expected, "clazz", class1);
        setField(expected, "fieldInfo", fieldInfoMock);
        setField(expected, "customDeserilizer", true);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer5() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
        ...
        Class initialFieldInfoMockFieldClass = fieldInfoMock.fieldClass;
        ...
        Class finalFieldInfoMockFieldClass = fieldInfoMock.fieldClass;
        
        Class expectedFinalFieldInfoMockFieldClass = ArrayList.class;
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(expectedFinalFieldInfoMockFieldClass, finalFieldInfoMockFieldClass));
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer6() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        ParserConfig parserConfig1 = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        ...
        JSONField jSONFieldMock = mock(JSONField.class);
        when(jSONFieldMock.deserializeUsing()).thenReturn(class1);
        JSONField jSONFieldMock1 = mock(JSONField.class);
        when(jSONFieldMock1.deserializeUsing()).thenReturn(((Class) null));
        when(fieldInfoMock.getAnnotation()).thenReturn(jSONFieldMock, jSONFieldMock1);
        setField(fieldInfoMock, "fieldClass", class1);
        
        FieldDeserializer actual = parserConfig.createFieldDeserializer(parserConfig1, javaBeanInfoMock, fieldInfoMock);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer7() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        ParserConfig parserConfig1 = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        ...
        JSONField jSONFieldMock = mock(JSONField.class);
        when(jSONFieldMock.deserializeUsing()).thenReturn(class1);
        when(fieldInfoMock.getAnnotation()).thenReturn(jSONFieldMock, ((JSONField) null));
        setField(fieldInfoMock, "fieldClass", class1);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer8() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
        ...
        Class expectedFinalFieldInfoMockFieldClass = List.class;
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer9() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
        ...
        when(jSONFieldMock.deserializeUsing()).thenReturn(class1);
        JSONField jSONFieldMock1 = mock(JSONField.class);
        when(jSONFieldMock1.deserializeUsing()).thenReturn(class1);
        when(fieldInfoMock.getAnnotation()).thenReturn(jSONFieldMock, jSONFieldMock1);
        setField(fieldInfoMock, "fieldClass", class1);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer10() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
        ...
        setField(expected, "clazz", class1);
        setField(expected, "fieldInfo", fieldInfoMock);
        setField(expected, "itemType", typeVariableImpl);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer11() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer12() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        ParserConfig parserConfig1 = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
        FieldInfo fieldInfoMock = mock(FieldInfo.class);
        when(fieldInfoMock.getAnnotation()).thenReturn(((JSONField) null), ((JSONField) null));
        setField(fieldInfoMock, "fieldClass", class1);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateFieldDeserializer13() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        ParserConfig parserConfig1 = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        ...
        parserConfig.createFieldDeserializer(parserConfig1, javaBeanInfoMock, fieldInfoMock);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer14() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        ParserConfig parserConfig1 = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        ...
        setField(expected, "clazz", class1);
        setField(expected, "fieldInfo", fieldInfoMock);
        setField(expected, "itemType", wildcardTypeImpl);
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer15() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        ParserConfig parserConfig1 = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateFieldDeserializer16() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        ParserConfig parserConfig1 = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
    ...
    @Test(timeout = 10000)
    public void testCreateFieldDeserializer17() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateFieldDeserializer18() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        JavaBeanInfo javaBeanInfoMock = mock(JavaBeanInfo.class);
        Class class1 = Object.class;
        setField(javaBeanInfoMock, "clazz", class1);
        ...
        parserConfig.createFieldDeserializer(null, javaBeanInfoMock, fieldInfoMock);
    ...
    public void testPutDeserializer2() throws Throwable  {
        ...
        parserConfig.putDeserializer(typeVariableImpl, objectDeserializerMock);
    }
    ///endregion
