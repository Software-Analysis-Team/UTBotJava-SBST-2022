...
public class RpcServerTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        RpcServer rpcServer = ((RpcServer) createInstance("io.seata.core.rpc.netty.RpcServer"));
        ChannelHandlerContext channelHandlerContextMock = mock(ChannelHandlerContext.class);
        java.time.format.DateTimeFormatterBuilder[] dateTimeFormatterBuilderArray = new java.time.format.DateTimeFormatterBuilder[0];
        
        rpcServer.userEventTriggered(channelHandlerContextMock, dateTimeFormatterBuilderArray);
    }
    ///endregion
