...
public class ReverseOrderingTest {
    ...
    public void testEquals3() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        java.lang.Object[] ofDoubleArray = createArray("java.util.stream.Nodes$CollectorTask$OfDouble", 0);
    ...
    public void testMin6() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] ofIntArray = createArray("java.util.stream.StreamSpliterators$SliceSpliterator$OfInt", 0);
        when(orderingMock.max(any(), any())).thenReturn(((Object) ofIntArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.time.chrono.ThaiBuddhistDate[] thaiBuddhistDateArray = new java.time.chrono.ThaiBuddhistDate[0];
        
        Object actual = reverseOrdering.min(null, thaiBuddhistDateArray);
    ...
    public void testMax2() throws Throwable  {
        ...
        Object actual = reverseOrdering.max(null, thaiBuddhistDateArray);
    ...
    public void testMax6() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] isAcceptableArray = createArray("sun.text.normalizer.UBiDiProps$IsAcceptable", 0);
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterator.class))).thenReturn(((Object) isAcceptableArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(isAcceptableArray, actual));
    }
    ///endregion
