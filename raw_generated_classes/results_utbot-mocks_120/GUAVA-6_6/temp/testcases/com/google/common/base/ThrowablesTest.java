...
public class ThrowablesTest {
    ...
    public void testThrowIfUnchecked3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.lang.Object[] serverSocketChannelImplArray = createArray("sun.nio.ch.ServerSocketChannelImpl", 0);
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) serverSocketChannelImplArray));
    ...
    public void testThrowIfInstanceOf1() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            Object inheritedServerSocketChannelImpl = createInstance("sun.nio.ch.InheritedChannel$InheritedServerSocketChannelImpl");
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(inheritedServerSocketChannelImpl);
