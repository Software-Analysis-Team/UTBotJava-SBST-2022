...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        Object unixAsBasicFileAttributes = createInstance("sun.nio.fs.UnixFileAttributes$UnixAsBasicFileAttributes");
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class wildcardTypeImplType = Class.forName("java.lang.reflect.Type");
        Class unixAsBasicFileAttributesType = Class.forName("java.lang.Object");
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, wildcardTypeImplType, unixAsBasicFileAttributesType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = wildcardTypeImpl;
        deserialzeMethodArguments[2] = unixAsBasicFileAttributes;
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        javax.swing.text.html.FormSubmitEvent[] formSubmitEventArray = new javax.swing.text.html.FormSubmitEvent[0];
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class genericArrayTypeImplType = Class.forName("java.lang.reflect.Type");
        Class formSubmitEventArrayType = Class.forName("java.lang.Object");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, formSubmitEventArrayType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[3];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = genericArrayTypeImpl;
        deserialzeMethodArguments[2] = ((Object) formSubmitEventArray);
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
    ...
    public void testDeserialze13() throws Throwable  {
        ...
        when(defaultJSONParserMock.setContext(org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.any())).thenReturn(parseContextMock);
        when(defaultJSONParserMock.parseObject(any(Map.class), any(Object.class))).thenReturn(null);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0);
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
    ...
    public void testParseMap1() throws Throwable  {
        Class class1 = Object.class;
        com.alibaba.fastjson.parser.deserializer.MapDeserializer[] mapDeserializerArray = new com.alibaba.fastjson.parser.deserializer.MapDeserializer[0];
        
        MapDeserializer.parseMap(null, null, class1, mapDeserializerArray);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        Class class1 = Object.class;
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.time.chrono.IsoChronology[] isoChronologyArray = new java.time.chrono.IsoChronology[0];
        
        MapDeserializer.parseMap(null, null, class1, typeVariableImpl, isoChronologyArray);
    }
    ///endregion
