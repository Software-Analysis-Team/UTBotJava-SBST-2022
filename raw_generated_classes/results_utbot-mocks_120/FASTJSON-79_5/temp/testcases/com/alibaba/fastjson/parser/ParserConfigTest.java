...
public class ParserConfigTest {
    ...
    public void testGetDeserializer1() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        okhttp3.ConnectionPool[] connectionPoolArray = new okhttp3.ConnectionPool[0];
        when(identityHashMapMock.get(any())).thenReturn(((Object) connectionPoolArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer3() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] objectInputStreamWithLoaderArray = createArray("com.sun.jmx.mbeanserver.ObjectInputStreamWithLoader", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) objectInputStreamWithLoaderArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        ...
        Method getDeserializerMethod = parserConfigClazz.getDeclaredMethod("getDeserializer", class1Type, syntheticParameterizedTypeType);
        getDeserializerMethod.setAccessible(true);
        java.lang.Object[] getDeserializerMethodArguments = new java.lang.Object[2];
        getDeserializerMethodArguments[0] = class1;
    ...
    public void testGetDeserializer4() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        okhttp3.ConnectionPool[] connectionPoolArray = new okhttp3.ConnectionPool[0];
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) connectionPoolArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    public void testGetDeserializer5() throws Throwable  {
        ...
        try {
            ...
            parserConfig.getDeserializer(class1, typeVariableImpl);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testGetDeserializer6() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        MapDeserializer mapDeserializer = ((MapDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.MapDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) mapDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    public void testGetDeserializer9() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] ofLongArray = createArray("java.util.stream.Nodes$SizedCollectorTask$OfLong", 0);
        when(identityHashMapMock.get(any())).thenReturn(((Object) ofLongArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer11() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] ofLongArray = createArray("java.util.stream.Nodes$SizedCollectorTask$OfLong", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) ofLongArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        FieldInfo fieldInfoMock = mock(FieldInfo.class);
        Class class1 = Object.class;
        setField(fieldInfoMock, "fieldType", class1);
    ...
    public void testGetDeserializer16() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        CollectionCodec collectionCodec = ((CollectionCodec) createInstance("com.alibaba.fastjson.serializer.CollectionCodec"));
        when(identityHashMapMock.get(any())).thenReturn(((Object) collectionCodec));
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer17() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] forEachOrderedTaskArray = createArray("java.util.stream.ForEachOps$ForEachOrderedTask", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, null, ((Object) forEachOrderedTaskArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    public void testGetDeserializer20() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        NumberDeserializer numberDeserializer = ((NumberDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.NumberDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, null, ((Object) numberDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    public void testCreateFieldDeserializer2() throws Throwable  {
        ...
        parserConfig.createFieldDeserializer(parserConfig, null, null);
    }
    ///endregion
