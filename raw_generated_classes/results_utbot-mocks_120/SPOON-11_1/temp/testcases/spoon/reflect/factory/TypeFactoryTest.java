...
public class TypeFactoryTest {
    ...
    public void testCreateReference8() throws Throwable  {
        ...
        when(ctTypeMock.getPackage()).thenReturn(((CtPackage) null));
        String string = new String("");
        when(ctTypeMock.getSimpleName()).thenReturn(string);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateArrayReference12() throws Throwable  {
        TypeFactory typeFactory = ((TypeFactory) createInstance("spoon.reflect.factory.TypeFactory"));
        setField(typeFactory, "factory", null);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateArrayReference13() throws Throwable  {
        TypeFactory typeFactory = ((TypeFactory) createInstance("spoon.reflect.factory.TypeFactory"));
        Factory factoryMock = mock(Factory.class);
        when(factoryMock.Core()).thenReturn(((CoreFactory) null));
        typeFactory.factory = factoryMock;
    ...
    public void testCreateWildcardStaticTypeMemberReference9() throws Throwable  {
        ...
        String string = new String("");
        when(ctTypeReferenceMock.getSimpleName()).thenReturn(string);
        CtReference ctReferenceMock = mock(CtReference.class);
        when(ctTypeReferenceMock.setSimpleName(anyString())).thenReturn(ctReferenceMock);
        when(coreFactoryMock.createWildcardStaticTypeMemberReference()).thenReturn(ctTypeReferenceMock);
        when(factoryMock.Core()).thenReturn(coreFactoryMock);
    ...
    public void testCreateIntersectionTypeReferenceWithBounds4() throws Throwable  {
        ...
        Factory factoryMock = mock(Factory.class);
        CoreFactory coreFactoryMock = mock(CoreFactory.class);
        when(coreFactoryMock.createIntersectionTypeReference()).thenReturn(((CtIntersectionTypeReference) null));
        when(factoryMock.Core()).thenReturn(coreFactoryMock);
        typeFactory.factory = factoryMock;
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateIntersectionTypeReferenceWithBounds7() throws Throwable  {
        TypeFactory typeFactory = ((TypeFactory) createInstance("spoon.reflect.factory.TypeFactory"));
        Factory factoryMock = mock(Factory.class);
        CoreFactory coreFactoryMock = mock(CoreFactory.class);
        when(coreFactoryMock.createIntersectionTypeReference()).thenReturn(((CtIntersectionTypeReference) null));
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateIntersectionTypeReferenceWithBounds8() throws Throwable  {
        TypeFactory typeFactory = ((TypeFactory) createInstance("spoon.reflect.factory.TypeFactory"));
        Factory factoryMock = mock(Factory.class);
        CoreFactory coreFactoryMock = mock(CoreFactory.class);
        when(coreFactoryMock.createIntersectionTypeReference()).thenReturn(((CtIntersectionTypeReference) null));
        ...
        CtTypeReference ctTypeReferenceMock = mock(CtTypeReference.class);
        when(ctTypeReferenceMock.clone()).thenReturn(((CtTypeReference) null));
        arrayList.add(ctTypeReferenceMock);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateIntersectionTypeReferenceWithBounds9() throws Throwable  {
        TypeFactory typeFactory = ((TypeFactory) createInstance("spoon.reflect.factory.TypeFactory"));
        Factory factoryMock = mock(Factory.class);
        CoreFactory coreFactoryMock = mock(CoreFactory.class);
        when(coreFactoryMock.createIntersectionTypeReference()).thenReturn(((CtIntersectionTypeReference) null));
        ...
        when(ctTypeReferenceMock1.getSimpleName()).thenReturn(((String) null));
    ...
    @Test(timeout = 10000)
    public void testCreateIntersectionTypeReferenceWithBounds10() throws Throwable  {
        TypeFactory typeFactory = ((TypeFactory) createInstance("spoon.reflect.factory.TypeFactory"));
        Factory factoryMock = mock(Factory.class);
        CoreFactory coreFactoryMock = mock(CoreFactory.class);
        CtIntersectionTypeReference ctIntersectionTypeReferenceMock = mock(CtIntersectionTypeReference.class);
        ...
        when(coreFactoryMock.createIntersectionTypeReference()).thenReturn(ctIntersectionTypeReferenceMock);
        when(factoryMock.Core()).thenReturn(coreFactoryMock);
        typeFactory.factory = factoryMock;
        ArrayList arrayList = new ArrayList();
        CtTypeReference ctTypeReferenceMock = mock(CtTypeReference.class);
        CtTypeReference ctTypeReferenceMock1 = mock(CtTypeReference.class);
        when(ctTypeReferenceMock1.getSimpleName()).thenReturn(((String) null));
        when(ctTypeReferenceMock1.getDeclaringType()).thenReturn(((CtTypeReference) null));
        when(ctTypeReferenceMock1.getPackage()).thenReturn(((CtPackageReference) null));
        when(ctTypeReferenceMock1.getActualTypeArguments()).thenReturn(((List) null));
        when(ctTypeReferenceMock.clone()).thenReturn(ctTypeReferenceMock1);
        arrayList.add(ctTypeReferenceMock);
        
        CtIntersectionTypeReference actual = typeFactory.createIntersectionTypeReferenceWithBounds(arrayList);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(ctIntersectionTypeReferenceMock, actual));
    }
    ///endregion
