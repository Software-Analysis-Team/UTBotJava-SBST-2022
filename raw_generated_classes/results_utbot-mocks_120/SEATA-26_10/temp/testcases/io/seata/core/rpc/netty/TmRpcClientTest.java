...
public class TmRpcClientTest {
    ...
    public void testUserEventTriggered1() throws Throwable  {
        ...
        tmRpcClient.userEventTriggered(((ChannelHandlerContext) null), byteBufferAsLongBufferBArray);
    }
    ///endregion
    ...
    public void testSendMsgWithResponse1() throws Throwable  {
        ...
        try {
            ...
            tmRpcClient.sendMsgWithResponse(byteBufferAsLongBufferBArray, 0L);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
        }
    ...
    public void testSendMsgWithResponse2() throws Throwable  {
        ...
        try {
            ...
            String string = new String("");
            setField(tmRpcClient, "transactionServiceGroup", string);
            java.lang.Object[] byteBufferAsLongBufferBArray1 = createArray("java.nio.ByteBufferAsLongBufferB", 0);
            
            tmRpcClient.sendMsgWithResponse(byteBufferAsLongBufferBArray1, 0L);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
            mockedStatic2.close();
    ...
    public void testSendMsgWithResponse3() throws Throwable  {
        ...
        try {
            ...
            tmRpcClient.sendMsgWithResponse(directFloatBufferSArray);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
            mockedStatic2.close();
    ...
    public void testGetExistAliveChannel1() throws Throwable  {
        ...
        Method getExistAliveChannelMethod = tmRpcClientClazz.getDeclaredMethod("getExistAliveChannel", channelMockType, stringType);
        ...
        Channel actual = ((Channel) getExistAliveChannelMethod.invoke(tmRpcClient, getExistAliveChannelMethodArguments));
    ...
    public void testGetExistAliveChannel2() throws Throwable  {
        ...
        Class stringType = Class.forName("java.lang.String");
        Method getExistAliveChannelMethod = tmRpcClientClazz.getDeclaredMethod("getExistAliveChannel", channelType, stringType);
        getExistAliveChannelMethod.setAccessible(true);
        java.lang.Object[] getExistAliveChannelMethodArguments = new java.lang.Object[2];
        getExistAliveChannelMethodArguments[0] = null;
        getExistAliveChannelMethodArguments[1] = null;
        try {
            getExistAliveChannelMethod.invoke(tmRpcClient, getExistAliveChannelMethodArguments);
    ...
    public void testGetExistAliveChannel3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(NettyClientConfig.class);
            mockedStatic.when(NettyClientConfig::getMaxCheckAliveRetry).thenReturn(0, 2);
            TmRpcClient tmRpcClient = ((TmRpcClient) createInstance("io.seata.core.rpc.netty.TmRpcClient"));
            Channel channelMock = mock(Channel.class);
    ...
    public void testSetTransactionServiceGroup1() throws Throwable  {
        ...
        tmRpcClient.setTransactionServiceGroup(null);
    }
    ///endregion
