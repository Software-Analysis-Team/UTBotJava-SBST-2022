...
public class ResolveFieldDeserializerTest {
    ...
    public void testParseField2() throws Throwable  {
        ...
        resolveFieldDeserializer.parseField(defaultJSONParserMock, null, ((Type) null), ((Map) null));
    }
    ///endregion
    ...
    public void testSetValue2() throws Throwable  {
        ...
        Object ofInt = createInstance("java.util.stream.StreamSpliterators$UnorderedSliceSpliterator$OfInt");
        ...
        resolveFieldDeserializer.setValue(ofInt, toggleComponentOrientationActionArray);
    }
    ///endregion
