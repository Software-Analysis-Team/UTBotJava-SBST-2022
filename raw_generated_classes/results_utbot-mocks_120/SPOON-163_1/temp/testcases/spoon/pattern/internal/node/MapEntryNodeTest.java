...
public class MapEntryNodeTest {
    ...
    public void testGenerateTargets4() throws Throwable  {
        ...
        spoon.support.reflect.cu.position.BodyHolderSourcePositionImpl[] bodyHolderSourcePositionImplArray = new spoon.support.reflect.cu.position.BodyHolderSourcePositionImpl[0];
        when(defaultGeneratorMock.generateSingleTarget(any(), any(), any())).thenReturn(((Object) string), ((Object) bodyHolderSourcePositionImplArray));
