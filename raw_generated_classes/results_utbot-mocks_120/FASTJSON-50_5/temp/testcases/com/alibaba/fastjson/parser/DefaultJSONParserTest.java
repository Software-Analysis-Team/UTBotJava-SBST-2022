...
public class DefaultJSONParserTest {
    ...
    public void testParseObject13() throws Throwable  {
        ...
        Method parseObjectMethod = defaultJSONParserClazz.getDeclaredMethod("parseObject", genericArrayTypeImplType, ofRefArrayType);
        parseObjectMethod.setAccessible(true);
        java.lang.Object[] parseObjectMethodArguments = new java.lang.Object[2];
        parseObjectMethodArguments[0] = genericArrayTypeImpl;
        parseObjectMethodArguments[1] = ((Object) ofRefArray);
        try {
    ...
    public void testSetConfig2() throws Throwable  {
        ...
        ParserConfig initialDefaultJSONParserConfig = defaultJSONParser.config;
        
        defaultJSONParser.setConfig(parserConfigMock);
        
        ParserConfig finalDefaultJSONParserConfig = defaultJSONParser.config;
        
        assertFalse(initialDefaultJSONParserConfig == finalDefaultJSONParserConfig);
    }
    ///endregion
