...
public class ShortsTest {
    ...
    public void testIndexOf13() throws Throwable  {
        ...
        try {
            ...
            }).thenReturn(null, ((Object) thaiBuddhistDateArray));
            short[] shortArray = new short[9];
            
            Shorts.indexOf(shortArray, ((short[]) null));
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testEquals4() throws Throwable  {
        Object shortArrayAsList = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList, "end", 9586980);
        setField(shortArrayAsList, "start", -67108864);
        ...
        setField(shortArrayAsList1, "start", -96);
    ...
    public void testEquals5() throws Throwable  {
        Object shortArrayAsList = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList, "end", -2071770842);
        setField(shortArrayAsList, "start", -2097153);
        Object shortArrayAsList1 = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList1, "end", 1910505353);
        setField(shortArrayAsList1, "start", -314788254);
    ...
    public void testEquals6() throws Throwable  {
        Object shortArrayAsList = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList, "end", -2147483625);
        setField(shortArrayAsList, "start", 40);
        short[] shortArray = new short[40];
        setField(shortArrayAsList, "array", shortArray);
        Object shortArrayAsList1 = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList1, "end", -12);
        setField(shortArrayAsList1, "start", -2147483643);
    ...
    public void testEquals7() throws Throwable  {
        Object shortArrayAsList = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList, "end", 75712806);
        setField(shortArrayAsList, "start", -2097153);
        short[] shortArray = new short[12];
        setField(shortArrayAsList, "array", shortArray);
        Object shortArrayAsList1 = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList1, "end", 1910505353);
        setField(shortArrayAsList1, "start", 1832695394);
        setField(shortArrayAsList1, "array", null);
    ...
    public void testEquals8() throws Throwable  {
        Object shortArrayAsList = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList, "end", 1815068719);
        setField(shortArrayAsList, "start", 0);
        short[] shortArray = new short[9];
        setField(shortArrayAsList, "array", shortArray);
        Object shortArrayAsList1 = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList1, "end", 198172672);
        setField(shortArrayAsList1, "start", -1616896047);
    ...
    public void testEquals9() throws Throwable  {
        ...
        setField(shortArrayAsList, "array", shortArray);
        Object shortArrayAsList1 = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList1, "end", -2147483608);
        setField(shortArrayAsList1, "start", 41);
        short[] shortArray1 = new short[40];
    ...
    public void testEquals12() throws Throwable  {
        Object shortArrayAsList = createInstance("com.google.common.primitives.Shorts$ShortArrayAsList");
        setField(shortArrayAsList, "end", -1064154844);
        setField(shortArrayAsList, "start", 1006632960);
        Object synchronizedRandomAccessList = createInstance("com.google.common.collect.Synchronized$SynchronizedRandomAccessList");
        
        Class shortArrayAsListClazz = Class.forName("com.google.common.primitives.Shorts$ShortArrayAsList");
        Class synchronizedRandomAccessListType = Class.forName("java.lang.Object");
        Method equalsMethod = shortArrayAsListClazz.getDeclaredMethod("equals", synchronizedRandomAccessListType);
        equalsMethod.setAccessible(true);
        java.lang.Object[] equalsMethodArguments = new java.lang.Object[1];
        equalsMethodArguments[0] = synchronizedRandomAccessList;
        try {
            equalsMethod.invoke(shortArrayAsList, equalsMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
