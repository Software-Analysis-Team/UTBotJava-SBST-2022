...
public class CtExtendedModifierTest {
    ...
    public void testEquals_errors()
     {
        ...
        // 
        // 1 occurrences of:
        // org/eclipse/core/resources/IWorkspaceRunnable has been compiled by a more recent version of
        // the Java Runtime (class file version 55.0), this version of
    ...
    public void testHashCode4() throws Throwable  {
        CtExtendedModifier ctExtendedModifier = ((CtExtendedModifier) createInstance("spoon.support.reflect.CtExtendedModifier"));
        ModifierKind modifierKindMock = mock(ModifierKind.class);
        setField(ctExtendedModifier, "kind", modifierKindMock);
        setField(ctExtendedModifier, "implicit", true);
    ...
    public void testGetPosition2() throws Throwable  {
        CtExtendedModifier ctExtendedModifier = ((CtExtendedModifier) createInstance("spoon.support.reflect.CtExtendedModifier"));
        SourcePosition sourcePositionMock = mock(SourcePosition.class);
        setField(ctExtendedModifier, "position", sourcePositionMock);
        
        SourcePosition actual = ctExtendedModifier.getPosition();
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(sourcePositionMock, actual));
    }
    ///endregion
