...
public class ThrowablesTest {
    ...
    public void testThrowIfUnchecked3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.lang.Object[] linearCongruentialGeneratorArray = createArray("[Lcom.google.common.hash.Hashing$LinearCongruentialGenerator;", 0);
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) linearCongruentialGeneratorArray));
