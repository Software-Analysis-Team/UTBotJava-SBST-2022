...
public class CharArrayCodecTest {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        try {
            ...
            CharArrayCodec charArrayCodec = ((CharArrayCodec) createInstance("com.alibaba.fastjson.serializer.CharArrayCodec"));
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            java.lang.Object[] keyIteratorArray = createArray("java.util.HashMap$KeyIterator", 0);
            when(defaultJSONParserMock.parse()).thenReturn(((Object) keyIteratorArray));
            JSONLexer jSONLexerMock = mock(JSONLexer.class);
            when(jSONLexerMock.token()).thenReturn(0, 0);
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
            ...
            Object actual = charArrayCodec.deserialze(defaultJSONParserMock, typeVariableImpl, null);
    ...
    public void testDeserialze12() throws Throwable  {
        ...
        try {
            ...
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            java.lang.Object[] accessibleJToolBarArray = createArray("[Ljavax.swing.JToolBar$AccessibleJToolBar;", 0);
            when(defaultJSONParserMock.parse()).thenReturn(((Object) accessibleJToolBarArray));
            JSONLexer jSONLexerMock = mock(JSONLexer.class);
            when(jSONLexerMock.token()).thenReturn(0, 0);
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
    ...
    public void testDeserialze15() throws Throwable  {
        ...
        try {
            ...
            when(defaultJSONParserMock.parse()).thenReturn(((Object) nullPointerExceptionArray));
            JSONLexer jSONLexerMock = mock(JSONLexer.class);
            when(jSONLexerMock.token()).thenReturn(0, 0);
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
