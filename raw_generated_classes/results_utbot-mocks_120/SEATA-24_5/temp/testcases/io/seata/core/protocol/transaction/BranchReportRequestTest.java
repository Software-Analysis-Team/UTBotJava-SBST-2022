...
public class BranchReportRequestTest {
    ...
    public void testDecode3() throws Throwable  {
        ...
        try {
            ...
            when(byteBufferMock.getInt()).thenReturn(-2146959360);
            ...
            assertNull(finalBranchReportRequestStatus);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
        }
    ...
    public void testEncode4() throws Throwable  {
        ...
        ByteBuffer byteBufferMock2 = mock(ByteBuffer.class);
        when(byteBufferMock.putInt(anyInt())).thenReturn(byteBufferMock2);
        branchReportRequest.byteBuffer = byteBufferMock;
    ...
    public void testHandle3() throws Throwable  {
        ...
        branchReportRequest.handle(rpcContextMock);
    }
    ///endregion
