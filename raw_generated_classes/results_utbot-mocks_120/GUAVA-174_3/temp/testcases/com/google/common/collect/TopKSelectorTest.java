...
public class TopKSelectorTest {
    ...
    public void testTrim4() throws Throwable  {
        ...
        try {
            ...
            setField(topKSelector, "buffer", objectArray);
            NullsLastOrdering nullsLastOrdering = ((NullsLastOrdering) createInstance("com.google.common.collect.NullsLastOrdering"));
            setField(topKSelector, "comparator", nullsLastOrdering);
