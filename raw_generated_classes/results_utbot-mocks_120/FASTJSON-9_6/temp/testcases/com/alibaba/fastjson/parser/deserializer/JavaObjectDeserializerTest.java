...
public class JavaObjectDeserializerTest {
    ...
    public void testDeserialze18() throws Throwable  {
        ...
        java.lang.reflect.Type[] typeArray = new java.lang.reflect.Type[0];
        setField(typeVariableImpl, "bounds", typeArray);
        setField(genericArrayTypeImpl, "componentType", typeVariableImpl);
        
        Class javaObjectDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.JavaObjectDeserializer");
        ...
        Method deserialzeMethod = javaObjectDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserMockType, genericArrayTypeImplType, objectType);
        ...
        try {
            deserialzeMethod.invoke(javaObjectDeserializer, deserialzeMethodArguments);
    ...
    public void testDeserialze20() throws Throwable  {
        ...
        GenericArrayTypeImpl genericArrayTypeImpl = ((GenericArrayTypeImpl) createInstance("sun.reflect.generics.reflectiveObjects.GenericArrayTypeImpl"));
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        CoreReflectionFactory coreReflectionFactory = ((CoreReflectionFactory) createInstance("sun.reflect.generics.factory.CoreReflectionFactory"));
        setField(typeVariableImpl, "factory", coreReflectionFactory);
        sun.reflect.generics.tree.FieldTypeSignature[] fieldTypeSignatureArray = new sun.reflect.generics.tree.FieldTypeSignature[1];
        ClassTypeSignature classTypeSignature = ((ClassTypeSignature) createInstance("sun.reflect.generics.tree.ClassTypeSignature"));
        ArrayList arrayList = new ArrayList();
        setField(classTypeSignature, "path", arrayList);
        fieldTypeSignatureArray[0] = ((FieldTypeSignature) classTypeSignature);
        setField(typeVariableImpl, "boundASTs", fieldTypeSignatureArray);
        setField(typeVariableImpl, "bounds", null);
        setField(genericArrayTypeImpl, "genericComponentType", typeVariableImpl);
        java.lang.Object[] ofLongArray = createArray("java.util.stream.ForEachOps$ForEachOp$OfLong", 0);
        
        javaObjectDeserializer.deserialze(defaultJSONParserMock, genericArrayTypeImpl, ofLongArray);
    }
    ///endregion
    ...
    public void testDeserialze21() throws Throwable  {
        ...
        setField(coreReflectionFactory, "decl", method);
        setField(typeVariableImpl, "factory", coreReflectionFactory);
        sun.reflect.generics.tree.FieldTypeSignature[] fieldTypeSignatureArray = new sun.reflect.generics.tree.FieldTypeSignature[1];
        SimpleClassTypeSignature simpleClassTypeSignature = ((SimpleClassTypeSignature) createInstance("sun.reflect.generics.tree.SimpleClassTypeSignature"));
        String string = new String("");
        setField(simpleClassTypeSignature, "name", string);
        fieldTypeSignatureArray[0] = ((FieldTypeSignature) simpleClassTypeSignature);
        setField(typeVariableImpl, "boundASTs", fieldTypeSignatureArray);
        setField(typeVariableImpl, "bounds", null);
        setField(genericArrayTypeImpl, "genericComponentType", typeVariableImpl);
    ...
    public void testDeserialze22() throws Throwable  {
        ...
        setField(constructor, "clazz", null);
        setField(coreReflectionFactory, "decl", constructor);
        setField(typeVariableImpl, "factory", coreReflectionFactory);
        sun.reflect.generics.tree.FieldTypeSignature[] fieldTypeSignatureArray = new sun.reflect.generics.tree.FieldTypeSignature[1];
        SimpleClassTypeSignature simpleClassTypeSignature = ((SimpleClassTypeSignature) createInstance("sun.reflect.generics.tree.SimpleClassTypeSignature"));
        String string = new String("");
