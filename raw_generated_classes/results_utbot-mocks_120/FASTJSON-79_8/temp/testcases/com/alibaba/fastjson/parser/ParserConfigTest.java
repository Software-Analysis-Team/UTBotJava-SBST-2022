...
public class ParserConfigTest {
    ...
    public void testGetDeserializer3() throws Throwable  {
        ...
        when(identityHashMapMock.get(any())).thenReturn(((Object) javaBeanDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(javaBeanDeserializer, actual));
    }
    ///endregion
    ...
    public void testGetDeserializer10() throws Throwable  {
        ...
        try {
            ...
            ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
            IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
            when(identityHashMapMock.get(any())).thenReturn(null, null, null);
            setField(parserConfig, "deserializers", identityHashMapMock);
            Class class1 = Object.class;
    ...
    public void testGetDeserializer11() throws Throwable  {
        ...
        parserConfig.getDeserializer(parameterizedTypeImpl);
    }
    ///endregion
    ...
    public void testGetDeserializer12() throws Throwable  {
        ...
        Method getDeserializerMethod = parserConfigClazz.getDeclaredMethod("getDeserializer", wildcardTypeImplType);
        getDeserializerMethod.setAccessible(true);
        java.lang.Object[] getDeserializerMethodArguments = new java.lang.Object[1];
        getDeserializerMethodArguments[0] = wildcardTypeImpl;
        try {
    ...
    public void testGetDeserializer13() throws Throwable  {
        ...
        setField(wildcardTypeImpl, "upperBoundASTs", fieldTypeSignatureArray);
        setField(wildcardTypeImpl, "upperBounds", null);
        
        parserConfig.getDeserializer(wildcardTypeImpl);
        
        Object finalWildcardTypeImplUpperBounds = getFieldValue(wildcardTypeImpl, "upperBounds");
    ...
    public void testGetDeserializer16() throws Throwable  {
        ...
        Method getDeserializerMethod = parserConfigClazz.getDeclaredMethod("getDeserializer", class1Type, parameterizedTypeImplType);
        getDeserializerMethod.setAccessible(true);
        java.lang.Object[] getDeserializerMethodArguments = new java.lang.Object[2];
        getDeserializerMethodArguments[0] = class1;
        getDeserializerMethodArguments[1] = parameterizedTypeImpl;
        try {
            getDeserializerMethod.invoke(parserConfig, getDeserializerMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
    ...
    public void testGetDeserializer18() throws Throwable  {
        ...
        try {
            ...
            Class class1Type = Class.forName("java.lang.Class");
            Class wildcardTypeImplType = Class.forName("java.lang.reflect.Type");
            Method getDeserializerMethod = parserConfigClazz.getDeclaredMethod("getDeserializer", class1Type, wildcardTypeImplType);
            getDeserializerMethod.setAccessible(true);
            java.lang.Object[] getDeserializerMethodArguments = new java.lang.Object[2];
            getDeserializerMethodArguments[0] = class1;
    ...
    public void testGetDeserializer19() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        SqlDateDeserializer sqlDateDeserializer = ((SqlDateDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.SqlDateDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) sqlDateDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
        WildcardTypeImpl wildcardTypeImpl = ((WildcardTypeImpl) createInstance("sun.reflect.generics.reflectiveObjects.WildcardTypeImpl"));
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(sqlDateDeserializer, actual));
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testGetDeserializer23() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        NumberDeserializer numberDeserializer = ((NumberDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.NumberDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) numberDeserializer));
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer24() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] ofRefArray = createArray("java.util.stream.Nodes$ToArrayTask$OfRef", 0);
    ...
    @Test(timeout = 10000)
    public void testGetDeserializer25() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        ThrowableDeserializer throwableDeserializer = ((ThrowableDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.ThrowableDeserializer"));
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer26() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(com.alibaba.fastjson.util.TypeUtils.class);
            Annotation annotationMock = mock(Annotation.class);
