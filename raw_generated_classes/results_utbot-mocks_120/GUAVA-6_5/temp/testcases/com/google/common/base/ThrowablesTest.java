...
public class ThrowablesTest {
    ...
    public void testGetRootCause3() throws Throwable  {
        SocketTimeoutException socketTimeoutException = ((SocketTimeoutException) createInstance("java.net.SocketTimeoutException"));
        setField(socketTimeoutException, "cause", socketTimeoutException);
        
        Throwable actual = Throwables.getRootCause(socketTimeoutException);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(socketTimeoutException, actual));
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testGetRootCause4() throws Throwable  {
        NotActiveException notActiveException = ((NotActiveException) createInstance("java.io.NotActiveException"));
        ...
        setField(notActiveException, "cause", instantiationError);
        
        Throwable actual = Throwables.getRootCause(notActiveException);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetRootCause5() throws Throwable  {
        ...
        DateTimeException dateTimeException = ((DateTimeException) createInstance("java.time.DateTimeException"));
        setField(dateTimeException, "cause", characterCodingException);
        setField(characterCodingException, "cause", dateTimeException);
        
        Throwables.getRootCause(characterCodingException);
    }
    ///endregion
    ...
    public void testGetRootCause6() throws Throwable  {
        ...
        setField(throwable, "cause", undeclaredThrowableException);
        
        Throwable actual = Throwables.getRootCause(throwable);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(undeclaredThrowableException, actual));
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testGetRootCause7() throws Throwable  {
        InterruptedException interruptedException = ((InterruptedException) createInstance("java.lang.InterruptedException"));
        IllegalFormatWidthException illegalFormatWidthException = ((IllegalFormatWidthException) createInstance("java.util.IllegalFormatWidthException"));
        SocketException socketException = ((SocketException) createInstance("java.net.SocketException"));
        setField(socketException, "cause", socketException);
        setField(illegalFormatWidthException, "cause", socketException);
        setField(interruptedException, "cause", illegalFormatWidthException);
        
        Throwable actual = Throwables.getRootCause(interruptedException);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(socketException, actual));
    }
    ///endregion
    ...
    public void testPropagate3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.nio.charset.UnsupportedCharsetException[] unsupportedCharsetExceptionArray = new java.nio.charset.UnsupportedCharsetException[0];
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) unsupportedCharsetExceptionArray));
            IllegalAccessError illegalAccessError = ((IllegalAccessError) createInstance("java.lang.IllegalAccessError"));
            
            Throwables.propagate(illegalAccessError);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testThrowIfUnchecked2() throws Throwable  {
        ...
        try {
            ...
            BufferOverflowException bufferOverflowException = ((BufferOverflowException) createInstance("java.nio.BufferOverflowException"));
            
            Throwables.throwIfUnchecked(bufferOverflowException);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testThrowIfUnchecked3() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) inheritedServerSocketChannelImplArray));
    ...
    public void testGetCausalChain2() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) transferStackArray));
    ...
    public void testGetCausalChain3() throws Throwable  {
        ...
        try {
            ...
            AsynchronousCloseException asynchronousCloseException = ((AsynchronousCloseException) createInstance("java.nio.channels.AsynchronousCloseException"));
            setField(asynchronousCloseException, "cause", asynchronousCloseException);
            
            List actual = Throwables.getCausalChain(asynchronousCloseException);
    ...
    public void testThrowIfInstanceOf1() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.lang.Object[] defaultThreadFactoryArray = createArray("java.util.concurrent.Executors$DefaultThreadFactory", 0);
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) defaultThreadFactoryArray));
    ...
    public void testThrowIfInstanceOf2() throws Throwable  {
        ...
        try {
            ...
            Throwables.throwIfInstanceOf(null, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testThrowIfInstanceOf3() throws Throwable  {
        ...
        try {
            ...
            Throwables.throwIfInstanceOf(invalidClassException, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testPropagateIfInstanceOf2() throws Throwable  {
        ...
        try {
            ...
            IllegalThreadStateException illegalThreadStateException = ((IllegalThreadStateException) createInstance("java.lang.IllegalThreadStateException"));
            Class class1 = Object.class;
            
            Throwables.propagateIfInstanceOf(illegalThreadStateException, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testPropagateIfInstanceOf3() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Preconditions.class);
            mockedStatic.when(() -> {
            ...
            Throwables.propagateIfInstanceOf(portUnreachableException, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testPropagateIfInstanceOf4() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Preconditions.class);
            mockedStatic.when(() -> {
    ...
    public void testPropagateIfPossible1() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) blockingArray), null);
            BootstrapMethodError bootstrapMethodError = ((BootstrapMethodError) createInstance("java.lang.BootstrapMethodError"));
            Class class1 = Object.class;
            
            Throwables.propagateIfPossible(bootstrapMethodError, class1, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testPropagateIfPossible2() throws Throwable  {
        ...
        try {
            ...
            AtomicMoveNotSupportedException atomicMoveNotSupportedException = ((AtomicMoveNotSupportedException) createInstance("java.nio.file.AtomicMoveNotSupportedException"));
            Class class1 = Object.class;
            
            Throwables.propagateIfPossible(atomicMoveNotSupportedException, class1, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testPropagateIfPossible4() throws Throwable  {
        ...
        try {
            ...
            Object timestampException = createInstance("sun.security.timestamp.TSResponse$TimestampException");
            Class class1 = Object.class;
            
            Class throwablesClazz = Class.forName("com.google.common.base.Throwables");
            Class timestampExceptionType = Class.forName("java.lang.Throwable");
            Class class1Type = Class.forName("java.lang.Class");
            Method propagateIfPossibleMethod = throwablesClazz.getDeclaredMethod("propagateIfPossible", timestampExceptionType, class1Type, class1Type);
            propagateIfPossibleMethod.setAccessible(true);
            java.lang.Object[] propagateIfPossibleMethodArguments = new java.lang.Object[3];
            propagateIfPossibleMethodArguments[0] = timestampException;
            propagateIfPossibleMethodArguments[1] = class1;
            propagateIfPossibleMethodArguments[2] = class1;
            try {
                propagateIfPossibleMethod.invoke(null, propagateIfPossibleMethodArguments);
    ...
    public void testPropagateIfPossible5() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.time.zone.ZoneRulesException[] zoneRulesExceptionArray = new java.time.zone.ZoneRulesException[0];
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(null, ((Object) zoneRulesExceptionArray));
            ZoneRulesException zoneRulesException = ((ZoneRulesException) createInstance("java.time.zone.ZoneRulesException"));
            Class class1 = Object.class;
            
            Throwables.propagateIfPossible(zoneRulesException, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testPropagateIfPossible7() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.util.IllegalFormatPrecisionException[] illegalFormatPrecisionExceptionArray = new java.util.IllegalFormatPrecisionException[0];
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) illegalFormatPrecisionExceptionArray), null);
            AssertionError assertionError = ((AssertionError) createInstance("java.lang.AssertionError"));
            Class class1 = Object.class;
            
            Throwables.propagateIfPossible(assertionError, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000)
    public void testPropagateIfPossible10() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.net.HttpRetryException[] httpRetryExceptionArray = new java.net.HttpRetryException[0];
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) httpRetryExceptionArray), null);
            SocketException socketException = ((SocketException) createInstance("java.net.SocketException"));
            Class class1 = Object.class;
            
            Throwables.propagateIfPossible(socketException, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000)
    public void testPropagateIfPossible11() throws Throwable  {
        Throwable throwable = new Throwable();
    ...
    @Test(timeout = 10000)
    public void testPropagateIfPossible12() throws Throwable  {
    ...
    @Test(timeout = 10000)
    public void testPropagateIfPossible13() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Preconditions.class);
            mockedStatic.when(() -> {
            ...
            Throwables.propagateIfPossible(iOException);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testPropagateIfPossible14() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Preconditions.class);
            mockedStatic.when(() -> {
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testPropagateIfPossible15() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Preconditions.class);
            mockedStatic.when(() -> {
            ...
            InvalidParameterException invalidParameterException = ((InvalidParameterException) createInstance("java.security.InvalidParameterException"));
            
            Throwables.propagateIfPossible(invalidParameterException);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCauseAs4() throws Throwable  {
        UndeclaredThrowableException undeclaredThrowableException = ((UndeclaredThrowableException) createInstance("java.lang.reflect.UndeclaredThrowableException"));
        setField(undeclaredThrowableException, "undeclaredThrowable", null);
        
        Throwables.getCauseAs(undeclaredThrowableException, null);
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCauseAs5() throws Throwable  {
        ...
        Throwables.getCauseAs(classNotFoundException, null);
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCauseAs6() throws Throwable  {
        ...
        Throwables.getCauseAs(invocationTargetException, null);
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCauseAs7() throws Throwable  {
        ...
        Throwables.getCauseAs(sAXException, null);
    }
    ///endregion
    ...
    public void testInvokeAccessibleNonThrowingMethod1() throws Throwable  {
        Object defaultThreadFactory = createInstance("java.util.concurrent.Executors$DefaultThreadFactory");
        
        Class throwablesClazz = Class.forName("com.google.common.base.Throwables");
        Class methodType = Class.forName("java.lang.reflect.Method");
        Class defaultThreadFactoryType = Class.forName("java.lang.Object");
        Class objectArrayType = Class.forName("[Ljava.lang.Object;");
        Method invokeAccessibleNonThrowingMethodMethod = throwablesClazz.getDeclaredMethod("invokeAccessibleNonThrowingMethod", methodType, defaultThreadFactoryType, objectArrayType);
        ...
        invokeAccessibleNonThrowingMethodMethodArguments[1] = defaultThreadFactory;
