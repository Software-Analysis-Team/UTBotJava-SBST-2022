...
public class DefaultServerMessageListenerImplTest {
    ...
    public void testOnTrxMessage2() throws Throwable  {
        DefaultServerMessageListenerImpl defaultServerMessageListenerImpl = ((DefaultServerMessageListenerImpl) createInstance("io.seata.core.rpc.DefaultServerMessageListenerImpl"));
        sun.security.x509.IssuerAlternativeNameExtension[] issuerAlternativeNameExtensionArray = new sun.security.x509.IssuerAlternativeNameExtension[0];
        ServerMessageSender serverMessageSenderMock = mock(ServerMessageSender.class);
        
        defaultServerMessageListenerImpl.onTrxMessage(0L, null, issuerAlternativeNameExtensionArray, serverMessageSenderMock);
    }
    ///endregion
    ...
    public void testOnRegRmMessage2() throws Throwable  {
        ...
        defaultServerMessageListenerImpl.onRegRmMessage(0L, null, null, serverMessageSenderMock, registerCheckAuthHandlerMock);
    }
    ///endregion
    ...
    public void testOnRegTmMessage2() throws Throwable  {
        ...
        defaultServerMessageListenerImpl.onRegTmMessage(0L, null, registerTMRequestMock, serverMessageSenderMock, registerCheckAuthHandlerMock);
    }
    ///endregion
