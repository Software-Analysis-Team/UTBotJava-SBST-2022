...
public class IntMathTest {
    ...
    public void testDivide3() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any());
            }).thenReturn(((Object) breakDictionaryArray));
            
            int actual = IntMath.divide(0, 4194304, null);
    ...
    public void testDivide5() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any());
            }).thenReturn(((Object) nativePRNGArray));
            RoundingMode roundingMode = RoundingMode.UP;
            
            int actual = IntMath.divide(-16777216, 801112064, roundingMode);
