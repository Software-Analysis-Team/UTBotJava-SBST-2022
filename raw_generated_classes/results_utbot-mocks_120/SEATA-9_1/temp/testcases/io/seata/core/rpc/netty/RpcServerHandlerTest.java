...
public class RpcServerHandlerTest {
    ...
    public void testExceptionCaught2() throws Throwable  {
        ...
        ClosedSelectorException closedSelectorException = ((ClosedSelectorException) createInstance("java.nio.channels.ClosedSelectorException"));
        
        rpcServerHandler.exceptionCaught(((ChannelHandlerContext) null), closedSelectorException);
    }
    ///endregion
