...
public class JSONSerializerTest {
    ...
    public void testWriteReference2() throws Throwable  {
        JSONSerializer jSONSerializer = ((JSONSerializer) createInstance("com.alibaba.fastjson.serializer.JSONSerializer"));
        setField(jSONSerializer, "context", null);
        java.lang.Object[] unixUserPrincipalsArray = createArray("sun.nio.fs.UnixUserPrincipals", 0);
        
        jSONSerializer.writeReference(unixUserPrincipalsArray);
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testHasNameFilters6() throws Throwable  {
        JSONSerializer jSONSerializer = ((JSONSerializer) createInstance("com.alibaba.fastjson.serializer.JSONSerializer"));
        ArrayList arrayList = new ArrayList();
    ...
    @Test(timeout = 10000)
    public void testHasNameFilters7() throws Throwable  {
        JSONSerializer jSONSerializer = ((JSONSerializer) createInstance("com.alibaba.fastjson.serializer.JSONSerializer"));
        ArrayList arrayList = new ArrayList();
        arrayList.add(null);
        arrayList.add(null);
