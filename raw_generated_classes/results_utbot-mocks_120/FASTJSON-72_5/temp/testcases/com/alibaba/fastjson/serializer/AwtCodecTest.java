...
public class AwtCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        sun.text.normalizer.UBiDiProps[] uBiDiPropsArray = new sun.text.normalizer.UBiDiProps[0];
        sun.net.util.URLUtil[] uRLUtilArray = new sun.net.util.URLUtil[0];
        Class class1 = Object.class;
        
        awtCodec.write(null, uBiDiPropsArray, uRLUtilArray, class1, 0);
    }
    ///endregion
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        javax.swing.text.Segment[] segmentArray = new javax.swing.text.Segment[0];
        
        awtCodec.deserialze(null, typeVariableImpl, segmentArray);
    }
    ///endregion
    ...
    public void testParsePoint1() throws Throwable  {
        AwtCodec awtCodec = ((AwtCodec) createInstance("com.alibaba.fastjson.serializer.AwtCodec"));
        java.lang.Object[] parameterMapArray = createArray("javax.print.MimeType$ParameterMap", 0);
        
        Class awtCodecClazz = Class.forName("com.alibaba.fastjson.serializer.AwtCodec");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class parameterMapArrayType = Class.forName("java.lang.Object");
        Method parsePointMethod = awtCodecClazz.getDeclaredMethod("parsePoint", defaultJSONParserType, parameterMapArrayType);
        ...
        parsePointMethodArguments[1] = ((Object) parameterMapArray);
        try {
    ...
    public void testParseRef2() throws Throwable  {
        ...
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class parameterMapArrayType = Class.forName("java.lang.Object");
        Method parseRefMethod = awtCodecClazz.getDeclaredMethod("parseRef", defaultJSONParserType, parameterMapArrayType);
        parseRefMethod.setAccessible(true);
        java.lang.Object[] parseRefMethodArguments = new java.lang.Object[2];
        parseRefMethodArguments[0] = null;
        parseRefMethodArguments[1] = ((Object) parameterMapArray);
        try {
            parseRefMethod.invoke(awtCodec, parseRefMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
