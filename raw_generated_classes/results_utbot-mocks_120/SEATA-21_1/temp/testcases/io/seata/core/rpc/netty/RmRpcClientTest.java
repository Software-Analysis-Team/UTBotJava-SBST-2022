...
public class RmRpcClientTest {
    ...
    public void testSendMsgWithResponse4() throws Throwable  {
        ...
        try {
            ...
            rmRpcClient.sendMsgWithResponse(threadPoolExecutorArray, 0L);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
        }
    ...
    public void testSendMsgWithResponse5() throws Throwable  {
        ...
        try {
            ...
            mockedStatic1 = mockStatic(io.seata.discovery.loadbalance.LoadBalanceFactory.class);
            LoadBalance loadBalanceMock = mock(LoadBalance.class);
            java.lang.Object[] zoneNameArray = createArray("java.time.format.ZoneName", 0);
            when(loadBalanceMock.select(org.mockito.ArgumentMatchers.any())).thenReturn(((Object) zoneNameArray));
            mockedStatic1.when(io.seata.discovery.loadbalance.LoadBalanceFactory::getInstance).thenReturn(loadBalanceMock);
            ...
            String string = new String("");
            setField(rmRpcClient, "transactionServiceGroup", string);
            java.time.zone.ZoneOffsetTransitionRule[] zoneOffsetTransitionRuleArray = new java.time.zone.ZoneOffsetTransitionRule[0];
            
            rmRpcClient.sendMsgWithResponse(zoneOffsetTransitionRuleArray, 0L);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
            mockedStatic2.close();
