...
public class RmRpcClientTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        ...
        rmRpcClient.userEventTriggered(channelHandlerContextMock, null);
    }
    ///endregion
    ...
    public void testOnRegisterMsgFail2() throws Throwable  {
        RmRpcClient rmRpcClient = ((RmRpcClient) createInstance("io.seata.core.rpc.netty.RmRpcClient"));
        String string = new String("");
        java.lang.Object[] nullProviderArray = createArray("sun.util.locale.provider.AuxLocaleProviderAdapter$NullProvider", 0);
        
        rmRpcClient.onRegisterMsgFail(string, null, nullProviderArray, null);
    }
    ///endregion
    ...
    public void testSendMsgWithResponse1() throws Throwable  {
        ...
        try {
            ...
            rmRpcClient.sendMsgWithResponse(hijrahDateArray, 0L);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
        }
    ...
    public void testSendMsgWithResponse2() throws Throwable  {
        ...
        try {
            ...
            mockedStatic1 = mockStatic(io.seata.discovery.loadbalance.LoadBalanceFactory.class);
            LoadBalance loadBalanceMock = mock(LoadBalance.class);
            java.time.zone.ZoneOffsetTransitionRule.TimeDefinition[] timeDefinitionArray = new java.time.zone.ZoneOffsetTransitionRule.TimeDefinition[0];
            when(loadBalanceMock.select(org.mockito.ArgumentMatchers.any())).thenReturn(((Object) timeDefinitionArray));
            mockedStatic1.when(io.seata.discovery.loadbalance.LoadBalanceFactory::getInstance).thenReturn(loadBalanceMock);
            ...
            String string = new String("");
            setField(rmRpcClient, "transactionServiceGroup", string);
            java.lang.Object[] jumboEnumSetArray = createArray("java.util.JumboEnumSet", 0);
            
            rmRpcClient.sendMsgWithResponse(jumboEnumSetArray, 0L);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
            mockedStatic2.close();
    ...
    public void testSendMsgWithResponse4() throws Throwable  {
        ...
        try {
            ...
            String string = new String("");
            setField(rmRpcClient, "transactionServiceGroup", string);
            java.lang.Object[] ofLongArray = createArray("java.util.stream.SpinedBuffer$OfLong", 0);
            
            rmRpcClient.sendMsgWithResponse(ofLongArray);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
            mockedStatic2.close();
    ...
    public void testGetExistAliveChannel4() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(NettyClientConfig.class);
            mockedStatic.when(NettyClientConfig::getMaxCheckAliveRetry).thenReturn(-2147483647, 2);
            RmRpcClient rmRpcClient = ((RmRpcClient) createInstance("io.seata.core.rpc.netty.RmRpcClient"));
            Channel channelMock = mock(Channel.class);
