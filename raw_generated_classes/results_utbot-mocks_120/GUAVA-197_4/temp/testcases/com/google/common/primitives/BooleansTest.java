...
public class BooleansTest {
    ...
    public void testIndexOf2() throws Throwable  {
        ...
        try {
            ...
            java.util.zip.ZipInputStream[] zipInputStreamArray = new java.util.zip.ZipInputStream[0];
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any(), any());
            }).thenReturn(null, ((Object) zipInputStreamArray));
    ...
    public void testEquals5() throws Throwable  {
        Object booleanArrayAsList = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList, "end", 2147482491);
        setField(booleanArrayAsList, "start", -1073741822);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", -1686897776);
        setField(booleanArrayAsList1, "start", -613154793);
    ...
    public void testEquals7() throws Throwable  {
        Object booleanArrayAsList = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList, "end", 1073741819);
        setField(booleanArrayAsList, "start", -1073737726);
        boolean[] booleanArray = new boolean[12];
        setField(booleanArrayAsList, "array", booleanArray);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", 1534326800);
        setField(booleanArrayAsList1, "start", -613152745);
        setField(booleanArrayAsList1, "array", null);
    ...
    public void testEquals9() throws Throwable  {
        ...
        setField(booleanArrayAsList, "array", booleanArray);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", -2147352577);
        setField(booleanArrayAsList1, "start", 131072);
        setField(booleanArrayAsList1, "array", booleanArray);
