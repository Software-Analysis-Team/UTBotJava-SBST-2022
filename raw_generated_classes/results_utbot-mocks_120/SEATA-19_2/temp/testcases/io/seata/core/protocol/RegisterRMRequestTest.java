...
public class RegisterRMRequestTest {
    ...
    public void testDecode6() throws Throwable  {
        ...
        when(byteBufMock.readShort()).thenReturn(java.lang.Short.MIN_VALUE, java.lang.Short.MIN_VALUE, java.lang.Short.MIN_VALUE, (short) 0);
        when(byteBufMock.readInt()).thenReturn(0);
