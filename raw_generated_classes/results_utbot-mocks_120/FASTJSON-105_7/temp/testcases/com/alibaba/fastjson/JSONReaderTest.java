...
public class JSONReaderTest {
    ...
    public void testReadObject2() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        javax.swing.JToolBar.Separator[] separatorArray = new javax.swing.JToolBar.Separator[0];
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) separatorArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(separatorArray, actual));
    }
    ///endregion
