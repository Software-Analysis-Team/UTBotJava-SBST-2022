...
public class ResolveFieldDeserializerTest {
    ...
    public void testParseField2() throws Throwable  {
        ...
        java.lang.Object[] immutableEndOfTrackArray = createArray("javax.sound.midi.Track$ImmutableEndOfTrack", 0);
        ...
        resolveFieldDeserializer.parseField(defaultJSONParserMock, immutableEndOfTrackArray, typeVariableImpl, ((Map) null));
    }
    ///endregion
    ...
    public void testSetValue2() throws Throwable  {
        ...
        java.lang.Object[] listItrArray = createArray("[Ljava.util.ArrayList$ListItr;", 0);
        setField(resolveFieldDeserializer, "key", listItrArray);
        Object ofDouble = createInstance("java.util.stream.StreamSpliterators$UnorderedSliceSpliterator$OfDouble");
        
        resolveFieldDeserializer.setValue(ofDouble, null);
    }
    ///endregion
