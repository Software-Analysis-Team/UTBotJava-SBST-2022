...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        javax.management.openmbean.KeyAlreadyExistsException[] keyAlreadyExistsExceptionArray = new javax.management.openmbean.KeyAlreadyExistsException[0];
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class typeVariableImplType = Class.forName("java.lang.reflect.Type");
        Class keyAlreadyExistsExceptionArrayType = Class.forName("java.lang.Object");
        Class linkedHashMapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, typeVariableImplType, keyAlreadyExistsExceptionArrayType, linkedHashMapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = typeVariableImpl;
        deserialzeMethodArguments[2] = ((Object) keyAlreadyExistsExceptionArray);
    ...
    public void testParseMap1() throws Throwable  {
        ...
        java.lang.Object[] listMXBeanTypeArray = createArray("sun.management.MappedMXBeanType$ListMXBeanType", 0);
        
        MapDeserializer.parseMap(null, null, typeVariableImpl, typeVariableImpl1, listMXBeanTypeArray);
    }
    ///endregion
    ...
    public void testParseMap8() throws Throwable  {
        ...
        java.lang.Object[] serviceKeyArray = createArray("java.security.Provider$ServiceKey", 0);
        
        MapDeserializer.parseMap(null, null, parameterizedTypeImpl, serviceKeyArray);
    }
    ///endregion
