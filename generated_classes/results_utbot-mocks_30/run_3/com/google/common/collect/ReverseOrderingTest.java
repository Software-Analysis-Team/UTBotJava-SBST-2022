...
public class ReverseOrderingTest {
    ...
    public void testMin4() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        Object keyIterator = createInstance("java.util.WeakHashMap$KeyIterator");
        
        Class reverseOrderingClazz = Class.forName("com.google.common.collect.ReverseOrdering");
        Class keyIteratorType = Class.forName("java.util.Iterator");
        Method minMethod = reverseOrderingClazz.getDeclaredMethod("min", keyIteratorType);
        minMethod.setAccessible(true);
        java.lang.Object[] minMethodArguments = new java.lang.Object[1];
        minMethodArguments[0] = keyIterator;
    ...
    public void testMin8() throws Throwable  {
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(jarEntry, actual));
    }
    ///endregion
    ...
    public void testMax2() throws Throwable  {
        ...
        Object actual = reverseOrdering.max(fifoWaitQueueArray, null);
    ...
    public void testMax8() throws Throwable  {
        ...
        java.lang.Object[] safeCharIteratorArray = createArray("[Lsun.util.locale.provider.RuleBasedBreakIterator$SafeCharIterator;", 0);
        
        Object actual = reverseOrdering.max(blockingArray, null, safeCharIteratorArray, ((java.lang.Object[]) null));
