...
public class ParserConfigTest {
    ...
    public void testGetDeserializer2() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.VerifyError[] verifyErrorArray = new java.lang.VerifyError[0];
        when(identityHashMapMock.get(any())).thenReturn(((Object) verifyErrorArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer5() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        javax.swing.text.html.HTMLDocument.HTMLReader[] hTMLReaderArray = new javax.swing.text.html.HTMLDocument.HTMLReader[0];
        when(identityHashMapMock.get(any())).thenReturn(((Object) hTMLReaderArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
