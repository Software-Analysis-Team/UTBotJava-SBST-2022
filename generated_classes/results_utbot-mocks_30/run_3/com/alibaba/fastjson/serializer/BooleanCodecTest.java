...
public class BooleanCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        java.lang.Object[] responseBodyConverterArray = createArray("com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory$ResponseBodyConverter", 0);
        ...
        booleanCodec.write(null, responseBodyConverterArray, compositeBuilderViaConstructorArray, typeVariableImpl, 0);
    }
    ///endregion
    ...
    public void testDeserialze2() throws Throwable  {
        ...
        booleanCodec.deserialze(null, typeVariableImpl, networkPermissionArray);
    }
    ///endregion
    ...
    public void testDeserialze4() throws Throwable  {
        ...
        try {
            ...
            when(jSONLexerMock.token()).thenReturn(0, 0, 0);
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
            Object ofRef = createInstance("java.util.stream.Nodes$CollectorTask$OfRef");
            
            Object actual = booleanCodec.deserialze(defaultJSONParserMock, null, ofRef);
