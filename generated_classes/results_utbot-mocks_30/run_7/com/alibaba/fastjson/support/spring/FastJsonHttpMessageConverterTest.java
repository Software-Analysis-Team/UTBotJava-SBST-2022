...
public class FastJsonHttpMessageConverterTest {
    ...
    public void testReadType3() throws Throwable  {
        ...
        when(httpInputMessageMock.getBody()).thenReturn(((java.io.InputStream) dataInputStream));
    ...
    public void testGetType21() throws Throwable  {
        ...
        try {
            ...
            when(resolvableTypeMock2.forType(org.mockito.ArgumentMatchers.any())).thenReturn(resolvableTypeMock3);
