...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, typeVariableImplType, longArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = typeVariableImpl;
        deserialzeMethodArguments[2] = ((Object) longArray);
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        mapDeserializer.deserialze(null, typeVariableImpl, delegatedExecutorServiceArray);
    }
    ///endregion
    ...
    public void testParseMap1() throws Throwable  {
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.lang.Object[] characterData01Array = createArray("[Ljava.lang.CharacterData01;", 0);
        
        MapDeserializer.parseMap(null, null, typeVariableImpl, characterData01Array);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        Class class1 = Object.class;
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.lang.ArrayIndexOutOfBoundsException[] arrayIndexOutOfBoundsExceptionArray = new java.lang.ArrayIndexOutOfBoundsException[0];
        
        MapDeserializer.parseMap(null, null, class1, typeVariableImpl, arrayIndexOutOfBoundsExceptionArray);
    }
    ///endregion
    ...
    public void testParseMap4() throws Throwable  {
        ...
        MapDeserializer.parseMap(defaultJSONParserMock, null, class1, typeVariableImpl, ofDoubleArray);
    }
    ///endregion
