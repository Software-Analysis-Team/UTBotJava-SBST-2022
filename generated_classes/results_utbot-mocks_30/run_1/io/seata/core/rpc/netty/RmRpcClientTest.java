...
public class RmRpcClientTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        ...
        java.lang.Object[] selfPermissionArray = createArray("sun.security.provider.PolicyFile$SelfPermission", 0);
        
        rmRpcClient.userEventTriggered(channelHandlerContextMock, selfPermissionArray);
    }
    ///endregion
    ...
    public void testOnRegisterMsgSuccess2() throws Throwable  {
        ...
        try {
            ...
            rmRpcClient.onRegisterMsgSuccess(null, null, byteBufferAsLongBufferBArray, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testOnRegisterMsgFail2() throws Throwable  {
        RmRpcClient rmRpcClient = ((RmRpcClient) createInstance("io.seata.core.rpc.netty.RmRpcClient"));
        String string = new String("");
        java.lang.Object[] regularEnumSetArray = createArray("java.util.RegularEnumSet", 0);
        
        rmRpcClient.onRegisterMsgFail(string, null, regularEnumSetArray, null);
    }
    ///endregion
