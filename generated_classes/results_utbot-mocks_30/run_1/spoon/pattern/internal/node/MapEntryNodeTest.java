...
public class MapEntryNodeTest {
    ...
    public void testGenerateTargets4() throws Throwable  {
        ...
        org.apache.log4j.spi.NOPLoggerRepository[] nOPLoggerRepositoryArray = new org.apache.log4j.spi.NOPLoggerRepository[0];
        when(defaultGeneratorMock.generateSingleTarget(any(), any(), any())).thenReturn(((Object) string), ((Object) nOPLoggerRepositoryArray));
        ResultHolder resultHolderMock = mock(ResultHolder.class);
    ...
    public void testMatchTarget2() throws Throwable  {
        ...
        mapEntryNode.matchTarget(rgbaArray, immutableMapMock);
    }
    ///endregion
