...
import com.huawei.utbot.engine.pc.UtLongSort;
...
public class ReverseOrderingTest {
    ...
    public void testEquals3() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        com.huawei.utbot.engine.pc.UtLongSort[] utLongSortArray = new com.huawei.utbot.engine.pc.UtLongSort[0];
        
        boolean actual = reverseOrdering.equals(utLongSortArray);
    ...
    public void testCompare2() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] standardKeySetArray = createArray("com.google.common.collect.ForwardingMap$StandardKeySet", 0);
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        int actual = reverseOrdering.compare(standardKeySetArray, operatorArray);
    ...
    public void testMin6() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.StackOverflowError[] stackOverflowErrorArray = new java.lang.StackOverflowError[0];
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.min(stackOverflowErrorArray, operatorArray);
    ...
    public void testMin8() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] itrArray = createArray("java.util.concurrent.PriorityBlockingQueue$Itr", 0);
        when(orderingMock.max(any(), any(), any(), any())).thenReturn(((Object) itrArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        sun.text.CompactByteArray[] compactByteArrayArray = new sun.text.CompactByteArray[0];
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.min(null, compactByteArrayArray, operatorArray, ((java.lang.Object[]) null));
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(itrArray, actual));
    }
    ///endregion
    ...
    public void testMax2() throws Throwable  {
        ...
        when(orderingMock.min(any(), any())).thenReturn(((Object) reasonFlagsArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.max(null, operatorArray);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(reasonFlagsArray, actual));
    }
    ///endregion
    ...
    public void testMax8() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] anyOfArray = createArray("com.google.common.base.CharMatcher$AnyOf", 0);
        jdk.internal.org.xml.sax.SAXException[] sAXExceptionArray = new jdk.internal.org.xml.sax.SAXException[0];
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.max(anyOfArray, sAXExceptionArray, operatorArray, ((java.lang.Object[]) null));
