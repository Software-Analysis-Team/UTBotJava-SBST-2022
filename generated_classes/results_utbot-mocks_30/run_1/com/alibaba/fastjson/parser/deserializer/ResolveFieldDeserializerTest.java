...
public class ResolveFieldDeserializerTest {
    ...
    public void testParseField2() throws Throwable  {
        ...
        Method parseFieldMethod = resolveFieldDeserializerClazz.getDeclaredMethod("parseField", defaultJSONParserType, compositeBuilderViaFromArrayType, syntheticParameterizedTypeType, mapType);
