...
public class ClobSeriliazerTest {
    ...
    public void testWrite2() throws Throwable  {
        ClobSeriliazer clobSeriliazer = ((ClobSeriliazer) createInstance("com.alibaba.fastjson.serializer.ClobSeriliazer"));
        JSONSerializer jSONSerializerMock = mock(JSONSerializer.class);
        java.lang.Object[] reflectionErrorArray = createArray("[Lsun.nio.ch.Reflect$ReflectionError;", 0);
        java.lang.Object[] lockArray = createArray("java.lang.ref.Reference$Lock", 0);
        Class class1 = Object.class;
        
        clobSeriliazer.write(jSONSerializerMock, reflectionErrorArray, lockArray, class1, 0);
    }
    ///endregion
