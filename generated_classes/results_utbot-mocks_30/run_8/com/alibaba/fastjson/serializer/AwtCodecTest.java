...
public class AwtCodecTest {
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        java.nio.file.AccessDeniedException[] accessDeniedExceptionArray = new java.nio.file.AccessDeniedException[0];
        
        awtCodec.deserialze(null, typeVariableImpl, accessDeniedExceptionArray);
    }
    ///endregion
    ...
    public void testParsePoint1() throws Throwable  {
        AwtCodec awtCodec = ((AwtCodec) createInstance("com.alibaba.fastjson.serializer.AwtCodec"));
        java.lang.Object[] breakDictionaryArray = createArray("sun.util.locale.provider.BreakDictionary", 0);
        
        Class awtCodecClazz = Class.forName("com.alibaba.fastjson.serializer.AwtCodec");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class breakDictionaryArrayType = Class.forName("java.lang.Object");
        Method parsePointMethod = awtCodecClazz.getDeclaredMethod("parsePoint", defaultJSONParserType, breakDictionaryArrayType);
        ...
        parsePointMethodArguments[1] = ((Object) breakDictionaryArray);
        try {
    ...
    public void testParseRef2() throws Throwable  {
        ...
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class breakDictionaryArrayType = Class.forName("java.lang.Object");
        Method parseRefMethod = awtCodecClazz.getDeclaredMethod("parseRef", defaultJSONParserType, breakDictionaryArrayType);
        parseRefMethod.setAccessible(true);
        java.lang.Object[] parseRefMethodArguments = new java.lang.Object[2];
        parseRefMethodArguments[0] = null;
        parseRefMethodArguments[1] = ((Object) breakDictionaryArray);
        try {
            parseRefMethod.invoke(awtCodec, parseRefMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
