...
public class BooleanCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        java.lang.Object[] annotationHelperArray = createArray("[Lcom.sun.jmx.mbeanserver.DefaultMXBeanMappingFactory$CompositeBuilderViaConstructor$AnnotationHelper;", 0);
        Class class1 = Object.class;
        
        booleanCodec.write(null, forEachTaskArray, annotationHelperArray, class1, 0);
    }
    ///endregion
    ...
    public void testDeserialze2() throws Throwable  {
        ...
        java.lang.Object[] accessibleJScrollPaneArray = createArray("[Ljavax.swing.JScrollPane$AccessibleJScrollPane;", 0);
    ...
    public void testDeserialze4() throws Throwable  {
        ...
        try {
            ...
            BooleanCodec booleanCodec = ((BooleanCodec) createInstance("com.alibaba.fastjson.serializer.BooleanCodec"));
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            java.lang.invoke.MethodType[] methodTypeArray = new java.lang.invoke.MethodType[0];
            when(defaultJSONParserMock.parse()).thenReturn(((Object) methodTypeArray));
            JSONLexer jSONLexerMock = mock(JSONLexer.class);
            when(jSONLexerMock.token()).thenReturn(0, 0, 0);
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
