...
public class RpcServerHandlerTest {
    ...
    public void testExceptionCaught2() throws Throwable  {
        ...
        UnmappableCharacterException unmappableCharacterException = ((UnmappableCharacterException) createInstance("java.nio.charset.UnmappableCharacterException"));
        
        rpcServerHandler.exceptionCaught(((ChannelHandlerContext) null), unmappableCharacterException);
    }
    ///endregion
