...
public class JSONReaderTest {
    ...
    public void testReadObject9() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        sun.util.logging.PlatformLogger[] platformLoggerArray = new sun.util.logging.PlatformLogger[0];
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) platformLoggerArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(platformLoggerArray, actual));
    }
    ///endregion
