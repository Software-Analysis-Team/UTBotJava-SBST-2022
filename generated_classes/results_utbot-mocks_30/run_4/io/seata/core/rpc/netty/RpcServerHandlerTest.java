...
public class RpcServerHandlerTest {
    ...
    public void testExceptionCaught2() throws Throwable  {
        ...
        MalformedInputException malformedInputException = ((MalformedInputException) createInstance("java.nio.charset.MalformedInputException"));
        
        rpcServerHandler.exceptionCaught(((ChannelHandlerContext) null), malformedInputException);
    }
    ///endregion
