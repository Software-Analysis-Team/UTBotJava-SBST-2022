...
public class ReverseOrderingTest {
    ...
    public void testCompare2() throws Throwable  {
        ...
        int actual = reverseOrdering.compare(null, operatorArray);
    ...
    public void testMin2() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.nio.file.FileSystemLoopException[] fileSystemLoopExceptionArray = new java.nio.file.FileSystemLoopException[0];
        when(orderingMock.max(org.mockito.ArgumentMatchers.any(Iterable.class))).thenReturn(((Object) fileSystemLoopExceptionArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(fileSystemLoopExceptionArray, actual));
    }
    ///endregion
    ...
    public void testMin4() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.util.concurrent.locks.ReentrantReadWriteLock.ReadLock[] readLockArray = new java.util.concurrent.locks.ReentrantReadWriteLock.ReadLock[0];
        when(orderingMock.max(org.mockito.ArgumentMatchers.any(Iterator.class))).thenReturn(((Object) readLockArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(readLockArray, actual));
    }
    ///endregion
    ...
    public void testMin6() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.CloneNotSupportedException[] cloneNotSupportedExceptionArray = new java.lang.CloneNotSupportedException[0];
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.min(cloneNotSupportedExceptionArray, operatorArray);
    ...
    public void testMin8() throws Throwable  {
        ...
        when(orderingMock.max(any(), any(), any(), any())).thenReturn(((Object) longArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        
        Object actual = reverseOrdering.min(null, null, null, ((java.lang.Object[]) null));
        
        assertArrayEquals(longArray, ((long[]) actual));
    }
    ///endregion
    ...
    public void testMax2() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] cleanupMapTaskArray = createArray("com.google.common.collect.MapMakerInternalMap$CleanupMapTask", 0);
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.max(cleanupMapTaskArray, operatorArray);
    ...
    public void testMax6() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] reverseListArray = createArray("com.google.common.collect.Lists$ReverseList", 0);
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterator.class))).thenReturn(((Object) reverseListArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(reverseListArray, actual));
    }
    ///endregion
    ...
    public void testMax8() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] singletonListArray = createArray("java.util.Collections$SingletonList", 0);
        when(orderingMock.min(any(), any(), any(), any())).thenReturn(((Object) singletonListArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(singletonListArray, actual));
    }
    ///endregion
