...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        Class jCSArrayType = Class.forName("java.lang.Object");
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, wildcardTypeImplType, jCSArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = wildcardTypeImpl;
        deserialzeMethodArguments[2] = ((Object) jCSArray);
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        Object loaderEntry = createInstance("com.sun.jmx.mbeanserver.ClassLoaderRepositorySupport$LoaderEntry");
        
        mapDeserializer.deserialze(null, class1, loaderEntry);
    }
    ///endregion
    ...
    public void testParseMap1() throws Throwable  {
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.lang.Object[] entrySetArray = createArray("jersey.repackaged.com.google.common.collect.RegularImmutableMap$EntrySet", 0);
        
        MapDeserializer.parseMap(null, null, typeVariableImpl, entrySetArray);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        ...
        MapDeserializer.parseMap(null, null, class1, typeVariableImpl, longCounterSnapshotArray);
    }
    ///endregion
