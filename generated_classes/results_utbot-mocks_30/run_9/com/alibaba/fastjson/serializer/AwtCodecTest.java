...
public class AwtCodecTest {
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        java.lang.Object[] compositeBuilderViaConstructorArray = createArray("[Lcom.sun.jmx.mbeanserver.DefaultMXBeanMappingFactory$CompositeBuilderViaConstructor;", 0);
        
        awtCodec.deserialze(null, typeVariableImpl, compositeBuilderViaConstructorArray);
    }
    ///endregion
    ...
    public void testParsePoint1() throws Throwable  {
        ...
        Method parsePointMethod = awtCodecClazz.getDeclaredMethod("parsePoint", defaultJSONParserType, eventObjectArrayType);
        ...
        parsePointMethodArguments[1] = ((Object) eventObjectArray);
        try {
    ...
    public void testParseRef2() throws Throwable  {
        ...
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class eventObjectArrayType = Class.forName("java.lang.Object");
        Method parseRefMethod = awtCodecClazz.getDeclaredMethod("parseRef", defaultJSONParserType, eventObjectArrayType);
        parseRefMethod.setAccessible(true);
        java.lang.Object[] parseRefMethodArguments = new java.lang.Object[2];
        parseRefMethodArguments[0] = null;
        parseRefMethodArguments[1] = ((Object) eventObjectArray);
        try {
            parseRefMethod.invoke(awtCodec, parseRefMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
