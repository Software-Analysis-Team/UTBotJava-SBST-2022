...
public class BooleanCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        java.security.spec.InvalidKeySpecException[] invalidKeySpecExceptionArray = new java.security.spec.InvalidKeySpecException[0];
        Class class1 = Object.class;
        
        booleanCodec.write(null, compositeBuilderViaConstructorArray, invalidKeySpecExceptionArray, class1, 0);
    }
    ///endregion
    ...
    public void testDeserialze2() throws Throwable  {
        ...
        booleanCodec.deserialze(null, genericArrayTypeImpl, compositeBuilderViaConstructorArray);
    }
    ///endregion
    ...
    public void testDeserialze4() throws Throwable  {
        ...
        try {
            ...
            BooleanCodec booleanCodec = ((BooleanCodec) createInstance("com.alibaba.fastjson.serializer.BooleanCodec"));
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            Object innerClassLambdaMetafactory = createInstance("java.lang.invoke.InnerClassLambdaMetafactory");
            when(defaultJSONParserMock.parse()).thenReturn(innerClassLambdaMetafactory);
            JSONLexer jSONLexerMock = mock(JSONLexer.class);
            when(jSONLexerMock.token()).thenReturn(0, 0, 0);
            setField(defaultJSONParserMock, "lexer", jSONLexerMock);
            ...
            Class booleanCodecClazz = Class.forName("com.alibaba.fastjson.serializer.BooleanCodec");
            ...
            Method deserialzeMethod = booleanCodecClazz.getDeclaredMethod("deserialze", defaultJSONParserMockType, parameterizedTypeImplType, ofRefArrayType);
            ...
            Object actual = deserialzeMethod.invoke(booleanCodec, deserialzeMethodArguments);
