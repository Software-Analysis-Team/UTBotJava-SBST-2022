...
public class RmRpcClientTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        ...
        java.io.BufferedReader[] bufferedReaderArray = new java.io.BufferedReader[0];
        
        rmRpcClient.userEventTriggered(channelHandlerContextMock, bufferedReaderArray);
    }
    ///endregion
    ...
    public void testOnRegisterMsgFail2() throws Throwable  {
        ...
        rmRpcClient.onRegisterMsgFail(string, channelMock, null, abstractMessageMock);
    }
    ///endregion
