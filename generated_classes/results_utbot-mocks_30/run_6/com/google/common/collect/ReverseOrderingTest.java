...
public class ReverseOrderingTest {
    ...
    public void testCompare2() throws Throwable  {
        ...
        java.lang.Object[] asyncCallableInterruptibleTaskArray = createArray("com.google.common.util.concurrent.CombinedFuture$AsyncCallableInterruptibleTask", 0);
        
        int actual = reverseOrdering.compare(thaiBuddhistDateArray, asyncCallableInterruptibleTaskArray);
    ...
    public void testMin2() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        javax.security.auth.DestroyFailedException[] destroyFailedExceptionArray = new javax.security.auth.DestroyFailedException[0];
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(destroyFailedExceptionArray, actual));
    }
    ///endregion
    ...
    public void testMin4() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] tickClockArray = createArray("java.time.Clock$TickClock", 0);
        when(orderingMock.max(org.mockito.ArgumentMatchers.any(Iterator.class))).thenReturn(((Object) tickClockArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(tickClockArray, actual));
    }
    ///endregion
    ...
    public void testMin6() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        com.google.common.escape.ArrayBasedEscaperMap[] arrayBasedEscaperMapArray = new com.google.common.escape.ArrayBasedEscaperMap[0];
        when(orderingMock.max(any(), any())).thenReturn(((Object) arrayBasedEscaperMapArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.time.chrono.ThaiBuddhistDate[][] thaiBuddhistDateArray = new java.time.chrono.ThaiBuddhistDate[0][];
        
        Object actual = reverseOrdering.min(thaiBuddhistDateArray, null);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(arrayBasedEscaperMapArray, actual));
    }
    ///endregion
    ...
    public void testMax2() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] ofDoubleArray = createArray("java.util.stream.Nodes$EmptyNode$OfDouble", 0);
        when(orderingMock.min(any(), any())).thenReturn(((Object) ofDoubleArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] nativeSeedGeneratorArray = createArray("sun.security.provider.NativeSeedGenerator", 0);
        
        Object actual = reverseOrdering.max(null, nativeSeedGeneratorArray);
    ...
    public void testMax4() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] hostPortrangeArray = createArray("[Ljava.net.HostPortrange;", 0);
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterable.class))).thenReturn(((Object) hostPortrangeArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(hostPortrangeArray, actual));
    }
    ///endregion
    ...
    public void testMax8() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] fJShortArray = createArray("[Ljava.util.ArraysParallelSortHelpers$FJShort;", 0);
        when(orderingMock.min(any(), any(), any(), any())).thenReturn(((Object) fJShortArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(fJShortArray, actual));
    }
    ///endregion
