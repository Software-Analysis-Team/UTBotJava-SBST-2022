...
public class ThrowablesTest {
    ...
    public void testThrowIfInstanceOf1() throws Throwable  {
        ...
        try {
            ...
            IllegalCharsetNameException illegalCharsetNameException = ((IllegalCharsetNameException) createInstance("java.nio.charset.IllegalCharsetNameException"));
            
            Throwables.throwIfInstanceOf(illegalCharsetNameException, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testPropagateIfPossible3() throws Throwable  {
        ...
        try {
            ...
            Throwables.propagateIfPossible(fileNotFoundException);
        } finally {
            mockedStatic.close();
        }
    }
