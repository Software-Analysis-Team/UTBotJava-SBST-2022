...
public class ClobSeriliazerTest {
    ...
    public void testWrite5() throws Throwable  {
        ...
        setField(deflaterOutputStream1, "syncFlush", true);
        ...
        setField(deflaterOutputStream1, "def", deflater);
        setField(encOutputStream, "out", deflaterOutputStream1);
        ...
        setField(deflaterOutputStream, "def", deflater1);
