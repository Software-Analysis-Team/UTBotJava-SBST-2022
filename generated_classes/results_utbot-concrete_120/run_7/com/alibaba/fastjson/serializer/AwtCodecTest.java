...
public class AwtCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        awtCodec.write(null, null, eSSCertIdArray, class1, 0);
    }
    ///endregion
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        awtCodec.deserialze(null, null, ofRefArray);
    }
    ///endregion
    ...
    public void testParseFont10() throws Throwable  {
        ...
        setField(inputStreamReader, "lock", null);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testWriteClassName5() throws Throwable  {
        AwtCodec awtCodec = ((AwtCodec) createInstance("com.alibaba.fastjson.serializer.AwtCodec"));
        SerializeWriter serializeWriter = ((SerializeWriter) createInstance("com.alibaba.fastjson.serializer.SerializeWriter"));
        char[] charArray = new char[12];
        setField(serializeWriter, "lock", charArray);
        PrintWriter printWriter = ((PrintWriter) createInstance("java.io.PrintWriter"));
        sun.text.IntHashtable[] intHashtableArray = new sun.text.IntHashtable[0];
        setField(printWriter, "lock", intHashtableArray);
        SerializeWriter serializeWriter1 = ((SerializeWriter) createInstance("com.alibaba.fastjson.serializer.SerializeWriter"));
        setField(serializeWriter1, "lock", charArray);
        setField(serializeWriter1, "writer", null);
        serializeWriter1.features = 0;
        serializeWriter1.count = -239;
        serializeWriter1.buf = charArray;
        setField(printWriter, "out", serializeWriter1);
