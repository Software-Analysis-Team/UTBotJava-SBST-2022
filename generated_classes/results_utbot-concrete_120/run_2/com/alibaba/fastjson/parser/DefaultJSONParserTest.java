...
public class DefaultJSONParserTest {
    ...
    public void testParseArray51() throws Throwable  {
        ...
        jSONReaderScanner.token = 0;
        setField(defaultJSONParser, "lexer", jSONReaderScanner);
        Object invocationKeyHandler = createInstance("com.sun.java.swing.plaf.windows.WindowsComboBoxUI$WindowsComboPopup$InvocationKeyHandler");
        
        defaultJSONParser.parseArray(((Collection) null), invocationKeyHandler);
    }
    ///endregion
    ...
    public void testParseObject14() throws Throwable  {
        ...
        defaultJSONParser.config = parserConfig;
    ...
    public void testParseObject23() throws Throwable  {
        ...
        jSONReaderScanner.token = 0;
        setField(defaultJSONParser, "lexer", jSONReaderScanner);
        java.lang.Object[] intSortingSinkArray = createArray("java.util.stream.SortedOps$IntSortingSink", 0);
        
        defaultJSONParser.parseObject(((Map) null), intSortingSinkArray);
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testParseArrayWithType24() throws Throwable  {
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        JSONScanner jSONScanner = ((JSONScanner) createInstance("com.alibaba.fastjson.parser.JSONScanner"));
        jSONScanner.sp = 0;
        jSONScanner.bp = 1;
    ...
    @Test(timeout = 10000)
    public void testParseArrayWithType25() throws Throwable  {
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        JSONScanner jSONScanner = ((JSONScanner) createInstance("com.alibaba.fastjson.parser.JSONScanner"));
        jSONScanner.sp = 0;
        jSONScanner.bp = 0;
    ...
    @Test(timeout = 10000)
    public void testParseArrayWithType26() throws Throwable  {
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        JSONScanner jSONScanner = ((JSONScanner) createInstance("com.alibaba.fastjson.parser.JSONScanner"));
        jSONScanner.sp = 0;
        jSONScanner.bp = 0;
    ...
    public void testCheckMapResolve2() throws Throwable  {
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        defaultJSONParser.resolveStatus = 0;
        java.lang.Object[] sliceTaskArray = createArray("[[[Ljava.util.stream.SliceOps$SliceTask;", 0);
