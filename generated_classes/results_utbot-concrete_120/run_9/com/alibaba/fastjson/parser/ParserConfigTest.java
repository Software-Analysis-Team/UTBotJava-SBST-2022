...
public class ParserConfigTest {
    ...
    public void testGetDerializers1() throws Throwable  {
        ...
        Class class1 = SoftReference.class;
        ...
        setField(entry, "value", referenceCodec);
        ...
        Class class7 = java.util.Currency.class;
        ...
        setField(entry8, "value", bigIntegerCodec);
        ...
        Class class10 = java.nio.charset.Charset.class;
        ...
        Class class13 = com.alibaba.fastjson.JSONPath.class;
        setField(entry12, "key", class13);
        setField(entry12, "value", miscCodec);
        ...
        Class class14 = java.io.Serializable.class;
        ...
        Class class15 = java.io.Closeable.class;
        setField(entry14, "key", class15);
        setField(entry14, "value", javaObjectDeserializer);
        ...
        Class class18 = java.sql.Timestamp.class;
        ...
        Class class19 = java.util.regex.Pattern.class;
        ...
        Class class20 = java.util.concurrent.atomic.AtomicBoolean.class;
        ...
        setField(entry19, "value", booleanCodec);
        ...
        Class class21 = java.sql.Date.class;
        ...
        setField(entry20, "value", sqlDateDeserializer1);
        ...
        Class class22 = java.util.Locale.class;
        ...
        Class class23 = java.lang.ref.WeakReference.class;
        ...
        Class class27 = Number.class;
        setField(entry26, "key", class27);
        setField(entry26, "value", numberDeserializer);
        ...
        Class class30 = java.math.BigDecimal.class;
        ...
        setField(entry29, "value", bigDecimalCodec);
        ...
        Class class33 = java.text.SimpleDateFormat.class;
        setField(entry32, "key", class33);
        setField(entry32, "value", miscCodec);
        ...
        Class class34 = java.util.concurrent.atomic.AtomicLongArray.class;
        ...
        setField(entry33, "value", atomicCodec);
        ...
        Class class35 = com.alibaba.fastjson.JSONObject.class;
        setField(entry34, "key", class35);
        setField(entry34, "value", mapDeserializer);
        ...
        Class class36 = java.util.Collection.class;
        ...
        Class class37 = java.util.TimeZone.class;
        ...
        Class class38 = java.util.UUID.class;
        ...
        Class class40 = com.alibaba.fastjson.JSONPObject.class;
        ...
        setField(entry39, "value", jSONPDeserializer);
        ...
        Class class41 = AtomicInteger.class;
        ...
        Class class42 = StringBuffer.class;
        ...
        Class class45 = java.util.concurrent.atomic.AtomicIntegerArray.class;
        setField(entry44, "key", class45);
        setField(entry44, "value", atomicCodec);
        ...
        Class class46 = TreeMap.class;
        setField(entry45, "key", class46);
        setField(entry45, "value", mapDeserializer);
        ...
        Class class48 = java.net.Inet6Address.class;
        ...
        setField(entry48, "hashCode", 1855026648);
        Class class49 = Date.class;
        ...
        Class class51 = StackTraceElement.class;
        ...
        setField(entry50, "value", stackTraceElementDeserializer);
        ...
        Class class55 = java.net.Inet4Address.class;
        ...
        Class class56 = Comparable.class;
        ...
        Class class64 = LinkedHashMap.class;
        ...
        setField(entry64, "hashCode", 1265900909);
        Class class65 = com.alibaba.fastjson.JSONArray.class;
        setField(entry64, "key", class65);
        setField(entry64, "value", collectionCodec);
        setField(entry64, "next", null);
        entryArray[7533] = entry64;
        Object entry65 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry65, "hashCode", 834600351);
        Class class66 = List.class;
        setField(entry65, "key", class66);
        setField(entry65, "value", collectionCodec);
        setField(entry65, "next", null);
        entryArray[7583] = entry65;
        Object entry66 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry66, "hashCode", 634297796);
        Class class67 = StringBuilder.class;
        setField(entry66, "key", class67);
        setField(entry66, "value", stringCodec);
        setField(entry66, "next", null);
        entryArray[7620] = entry66;
        Object entry67 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry67, "hashCode", 2097905212);
        Class class68 = javax.xml.datatype.XMLGregorianCalendar.class;
        setField(entry67, "key", class68);
        setField(entry67, "value", calendarCodec);
        setField(entry67, "next", null);
        entryArray[7740] = entry67;
        Object entry68 = createInstance("com.alibaba.fastjson.util.IdentityHashMap$Entry");
        setField(entry68, "hashCode", 2028265136);
        Class class69 = java.sql.Time.class;
        ...
        setField(entry68, "value", timeDeserializer);
        setField(entry68, "next", null);
        entryArray[7856] = entry68;
    ...
    @Test(timeout = 10000)
    public void testCreateJavaBeanDeserializer5() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        setField(parserConfig, "fieldBased", true);
        setField(parserConfig, "asmEnable", false);
        Class class1 = Object.class;
    ...
    public void testAddDeny5() throws Throwable  {
        ...
        longArray[0] = -8070491985027895257L;
        setField(parserConfig, "denyHashCodes", longArray);
        String string = new String("\u2367");
