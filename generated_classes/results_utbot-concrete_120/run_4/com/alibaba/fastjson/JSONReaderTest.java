...
public class ClobSeriliazerTest {
    ...
    public void testWrite2() throws Throwable  {
        ClobSeriliazer clobSeriliazer = ((ClobSeriliazer) createInstance("com.alibaba.fastjson.serializer.ClobSeriliazer"));
        java.lang.Object[] accessibleJTreeNodeArray = createArray("javax.swing.JTree$AccessibleJTree$AccessibleJTreeNode", 0);
        
        clobSeriliazer.write(null, accessibleJTreeNodeArray, null, null, 0);
    }
    ///endregion
