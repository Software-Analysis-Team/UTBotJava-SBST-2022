...
public class CtAssignmentImplTest {
    ...
    public void testAddTypeCast4() throws Throwable  {
        ...
        setField(ctWildcardReferenceImpl, "parent", null);
        setField(ctWildcardReferenceImpl, "factory", null);
        
        Object ctAssignmentImplFactory = getFieldValue(ctAssignmentImpl, "factory");
        Object initialCtAssignmentImplFactoryEnvironment = getFieldValue(ctAssignmentImplFactory, "environment");
        
        Object initialCtWildcardReferenceImplParent = getFieldValue(ctWildcardReferenceImpl, "parent");
        ...
        Object finalCtWildcardReferenceImplParent = getFieldValue(ctWildcardReferenceImpl, "parent");
        
        assertFalse(initialCtAssignmentImplFactoryEnvironment == finalCtAssignmentImplFactoryEnvironment);
        
        assertFalse(initialCtWildcardReferenceImplParent == finalCtWildcardReferenceImplParent);
    }
    ///endregion
