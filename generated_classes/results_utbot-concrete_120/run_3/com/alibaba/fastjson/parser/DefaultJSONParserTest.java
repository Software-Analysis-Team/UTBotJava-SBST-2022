...
public class DefaultJSONParserTest {
    ...
    public void testParseArray8() throws Throwable  {
        ...
        defaultJSONParser.parseArray(null, null, ofLongArray);
    }
    ///endregion
    ...
    public void testDefaultJSONParser_errors4()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testDefaultJSONParser11() {
        ParserConfig parserConfig = new ParserConfig();
    ...
    @Test(timeout = 10000)
    public void testDefaultJSONParser12() {
        char[] charArray = new char[0];
        ParserConfig parserConfig = new ParserConfig();
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testDefaultJSONParser13() throws Throwable  {
        char[] charArray = new char[0];
