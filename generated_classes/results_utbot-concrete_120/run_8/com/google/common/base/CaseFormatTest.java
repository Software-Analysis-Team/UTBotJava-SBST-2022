...
public class CaseFormatTest {
    ...
    public void testCaseFormat1() throws Throwable  {
        String string = new String("");
        Object singleWidth = createInstance("com.google.common.base.CharMatcher$SingleWidth");
        String string1 = new String("");
        Class caseFormatClazz = Class.forName("com.google.common.base.CaseFormat");
        Class stringType = Class.forName("java.lang.String");
        Class intType = int.class;
        Class singleWidthType = Class.forName("com.google.common.base.CharMatcher");
        Constructor caseFormatConstructor = caseFormatClazz.getDeclaredConstructor(stringType, intType, singleWidthType, stringType);
        ...
        caseFormatConstructorArguments[2] = singleWidth;
