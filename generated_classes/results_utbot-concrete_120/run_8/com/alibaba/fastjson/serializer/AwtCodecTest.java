...
public class AwtCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        awtCodec.write(null, objectsArray, accessibleJComboBoxPropertyChangeListenerArray, null, 0);
    }
    ///endregion
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        java.lang.Object[] entryArray = createArray("java.util.EnumMap$EntryIterator$Entry", 0);
        
        awtCodec.deserialze(null, typeVariableImpl, entryArray);
    }
    ///endregion
    ...
    public void testWriteClassName4() throws Throwable  {
        ...
        Object serializeWriterWriter1WriterSe = getFieldValue(serializeWriterWriter1, "se");
        Object initialSerializeWriterWriterSeLock = getFieldValue(serializeWriterWriter1WriterSe, "lock");
        ...
        Object serializeWriterWriter3WriterSe = getFieldValue(serializeWriterWriter3, "se");
        Object finalSerializeWriterWriterSeLock = getFieldValue(serializeWriterWriter3WriterSe, "lock");
        
        assertNull(finalSerializeWriterLock);
        
        assertNull(finalSerializeWriterWriterLock);
        
        assertNull(finalSerializeWriterWriterSeLock);
    }
    ///endregion
    ...
    public void testParseFont18() throws Throwable  {
        ...
        assertEquals(6, finalDefaultJSONParserLexerNp);
        ...
        assertEquals(18, finalDefaultJSONParserLexerToken);
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testParseRectangle32() throws Throwable  {
        AwtCodec awtCodec = ((AwtCodec) createInstance("com.alibaba.fastjson.serializer.AwtCodec"));
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        JSONScanner jSONScanner = ((JSONScanner) createInstance("com.alibaba.fastjson.parser.JSONScanner"));
        setField(jSONScanner, "sp", 0);
    ...
    public void testParsePoint1() throws Throwable  {
        AwtCodec awtCodec = ((AwtCodec) createInstance("com.alibaba.fastjson.serializer.AwtCodec"));
        java.lang.Object[] basicMenuKeyListenerArray = createArray("javax.swing.plaf.basic.BasicPopupMenuUI$BasicMenuKeyListener", 0);
        
        Class awtCodecClazz = Class.forName("com.alibaba.fastjson.serializer.AwtCodec");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class basicMenuKeyListenerArrayType = Class.forName("java.lang.Object");
        Method parsePointMethod = awtCodecClazz.getDeclaredMethod("parsePoint", defaultJSONParserType, basicMenuKeyListenerArrayType);
        ...
        parsePointMethodArguments[1] = ((Object) basicMenuKeyListenerArray);
        try {
    ...
    @Test(timeout = 10000)
    public void testParsePoint24() throws Throwable  {
        AwtCodec awtCodec = ((AwtCodec) createInstance("com.alibaba.fastjson.serializer.AwtCodec"));
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        JSONScanner jSONScanner = ((JSONScanner) createInstance("com.alibaba.fastjson.parser.JSONScanner"));
        setField(jSONScanner, "sp", 0);
    ...
    @Test(timeout = 10000)
    public void testParsePoint25() throws Throwable  {
        AwtCodec awtCodec = ((AwtCodec) createInstance("com.alibaba.fastjson.serializer.AwtCodec"));
        DefaultJSONParser defaultJSONParser = ((DefaultJSONParser) createInstance("com.alibaba.fastjson.parser.DefaultJSONParser"));
        JSONScanner jSONScanner = ((JSONScanner) createInstance("com.alibaba.fastjson.parser.JSONScanner"));
        setField(jSONScanner, "np", 0);
    ...
    public void testParseRef2() throws Throwable  {
        ...
        Class awtCodecClazz = Class.forName("com.alibaba.fastjson.serializer.AwtCodec");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class basicComboBoxUIArrayType = Class.forName("java.lang.Object");
        Method parseRefMethod = awtCodecClazz.getDeclaredMethod("parseRef", defaultJSONParserType, basicComboBoxUIArrayType);
        parseRefMethod.setAccessible(true);
        java.lang.Object[] parseRefMethodArguments = new java.lang.Object[2];
        parseRefMethodArguments[0] = null;
        parseRefMethodArguments[1] = ((Object) basicComboBoxUIArray);
        try {
            parseRefMethod.invoke(awtCodec, parseRefMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
