...
public class FastJsonHttpMessageConverterTest {
    ...
    public void testRead3() throws Throwable  {
        ...
        try {
            ...
            ContextExposingHttpServletRequest contextExposingHttpServletRequest9 = ((ContextExposingHttpServletRequest) createInstance("org.springframework.web.context.support.ContextExposingHttpServletRequest"));
            ...
            setField(httpServletRequestWrapper3, "request", contextExposingHttpServletRequest5);
            setField(contextExposingHttpServletRequest9, "request", httpServletRequestWrapper3);
            setField(contextExposingHttpServletRequest8, "request", contextExposingHttpServletRequest9);
            setField(httpServletRequestWrapper2, "request", contextExposingHttpServletRequest8);
            setField(contextExposingHttpServletRequest7, "request", httpServletRequestWrapper2);
            setField(contextExposingHttpServletRequest6, "request", contextExposingHttpServletRequest7);
            setField(servletRequestWrapper2, "request", contextExposingHttpServletRequest6);
            setField(contextExposingHttpServletRequest5, "request", servletRequestWrapper2);
            setField(contextExposingHttpServletRequest4, "request", contextExposingHttpServletRequest5);
            setField(servletRequestWrapper1, "request", contextExposingHttpServletRequest4);
            setField(httpServletRequestWrapper1, "request", servletRequestWrapper1);
            setField(contextExposingHttpServletRequest3, "request", httpServletRequestWrapper1);
            setField(servletRequestWrapper, "request", contextExposingHttpServletRequest3);
            setField(contextExposingHttpServletRequest2, "request", servletRequestWrapper);
    ...
    public void testReadInternal3() throws Throwable  {
        ...
        try {
            ...
            ServletRequestWrapper servletRequestWrapper2 = ((ServletRequestWrapper) createInstance("javax.servlet.ServletRequestWrapper"));
            setField(servletRequestWrapper2, "request", servletRequestWrapper1);
            setField(httpServletRequestWrapper4, "request", servletRequestWrapper2);
            setField(httpServletRequestWrapper3, "request", httpServletRequestWrapper4);
            setField(httpServletRequestWrapper2, "request", httpServletRequestWrapper3);
            setField(contextExposingHttpServletRequest, "request", httpServletRequestWrapper2);
            setField(servletRequestWrapper1, "request", contextExposingHttpServletRequest);
            setField(httpServletRequestWrapper1, "request", servletRequestWrapper1);
            setField(servletRequestWrapper, "request", httpServletRequestWrapper1);
    ...
    public void testWriteInternal4() throws Throwable  {
        ...
        setField(servletResponseHttpHeaders, "headers", linkedHashMap);
        setField(servletServerHttpResponse, "headers", servletResponseHttpHeaders);
