...
public class DefaultJSONParserTest {
    ...
    public void testParseArray2() throws Throwable  {
        ...
        Object values = createInstance("com.alibaba.fastjson.util.AntiCollisionHashMap$Values");
        ...
        Class valuesType = Class.forName("java.util.Collection");
        Method parseArrayMethod = defaultJSONParserClazz.getDeclaredMethod("parseArray", typeVariableImplType, valuesType);
        parseArrayMethod.setAccessible(true);
        java.lang.Object[] parseArrayMethodArguments = new java.lang.Object[2];
        parseArrayMethodArguments[0] = typeVariableImpl;
        parseArrayMethodArguments[1] = values;
        try {
    ...
    public void testParseArray30() throws Throwable  {
        ...
        java.lang.Object[] checkedEntryArray = createArray("java.util.Collections$CheckedMap$CheckedEntrySet$CheckedEntry", 0);
        
        defaultJSONParser.parseArray(parameterizedTypeImpl, null, checkedEntryArray);
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testDefaultJSONParser5() throws Throwable  {
        char[] charArray = new char[0];
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
