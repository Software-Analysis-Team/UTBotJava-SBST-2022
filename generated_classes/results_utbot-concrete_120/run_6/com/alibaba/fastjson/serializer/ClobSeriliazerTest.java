...
import kotlin.reflect.KFunction.DefaultImpls;
...
public class ClobSeriliazerTest {
    ...
    public void testWrite2() throws Throwable  {
        ClobSeriliazer clobSeriliazer = ((ClobSeriliazer) createInstance("com.alibaba.fastjson.serializer.ClobSeriliazer"));
        kotlin.reflect.KFunction.DefaultImpls[][] defaultImplsArray = new kotlin.reflect.KFunction.DefaultImpls[0][];
        
        clobSeriliazer.write(null, defaultImplsArray, null, null, 0);
    }
    ///endregion
