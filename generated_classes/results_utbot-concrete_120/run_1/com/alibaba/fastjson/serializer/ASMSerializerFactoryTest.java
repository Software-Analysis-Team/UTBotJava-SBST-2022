...
public class FastJsonHttpMessageConverterTest {
    ...
    public void testRead3() throws Throwable  {
        ...
        try {
            ...
            setField(httpServletRequestWrapper7, "request", httpServletRequestWrapper5);
            setField(httpServletRequestWrapper6, "request", httpServletRequestWrapper7);
            setField(contextExposingHttpServletRequest1, "request", httpServletRequestWrapper6);
            setField(httpServletRequestWrapper5, "request", contextExposingHttpServletRequest1);
            setField(httpServletRequestWrapper4, "request", httpServletRequestWrapper5);
            setField(contextExposingHttpServletRequest, "request", httpServletRequestWrapper4);
            setField(servletRequestWrapper2, "request", contextExposingHttpServletRequest);
            setField(httpServletRequestWrapper3, "request", servletRequestWrapper2);
            setField(servletRequestWrapper1, "request", httpServletRequestWrapper3);
    ...
    public void testReadInternal3() throws Throwable  {
        ...
        try {
            ...
            ServletRequestWrapper servletRequestWrapper1 = ((ServletRequestWrapper) createInstance("javax.servlet.ServletRequestWrapper"));
            HttpServletRequestWrapper httpServletRequestWrapper5 = ((HttpServletRequestWrapper) createInstance("javax.servlet.http.HttpServletRequestWrapper"));
            setField(httpServletRequestWrapper5, "request", httpServletRequestWrapper5);
            setField(servletRequestWrapper1, "request", httpServletRequestWrapper5);
            setField(httpServletRequestWrapper4, "request", servletRequestWrapper1);
