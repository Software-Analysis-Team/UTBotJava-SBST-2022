...
public class PrintingContextTest {
    ...
    public void testPopCurrentThis3() throws Throwable  {
        ...
        Object node1 = createInstance("java.util.LinkedList$Node");
        setField(node1, "prev", null);
        setField(node1, "next", node1);
        setField(node1, "item", null);
        setField(node, "next", node1);
        ...
        Object finalPrintingContextCurrentThisFirst = getFieldValue(deque1, "first");
        Deque deque2 = printingContext.currentThis;
        Object finalPrintingContextCurrentThisSize = getFieldValue(deque2, "size");
        
        assertFalse(initialPrintingContextCurrentThisFirst == finalPrintingContextCurrentThisFirst);
