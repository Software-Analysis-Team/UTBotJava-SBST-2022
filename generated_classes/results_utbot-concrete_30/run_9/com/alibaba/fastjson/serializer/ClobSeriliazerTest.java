...
public class ClobSeriliazerTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        clobSeriliazer.write(null, defaultMXBeanMappingFactoryArray, null, null, 0);
    }
    ///endregion
    ...
    public void testWrite5() throws Throwable  {
        ...
        setField(streamEncoder, "haveLeftoverChar", false);
        ...
        assertEquals(5, finalJSONSerializerOutCount);
