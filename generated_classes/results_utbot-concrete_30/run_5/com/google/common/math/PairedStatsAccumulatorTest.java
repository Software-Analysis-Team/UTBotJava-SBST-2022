...
public class PairedStatsAccumulatorTest {
    ...
    public void testAdd2() throws Throwable  {
        ...
        setField(statsAccumulator, "mean", 2.0722615E-317);
        setField(statsAccumulator, "count", 8388608L);
        setField(pairedStatsAccumulator, "xStats", statsAccumulator);
        
        pairedStatsAccumulator.add(6.953355807835E-310, java.lang.Double.NaN);
        ...
        assertEquals(1.03613066E-316, ((double) finalPairedStatsAccumulatorXStatsMean), 1.0E-6);
        
        org.junit.Assert.assertEquals(8388609L, finalPairedStatsAccumulatorXStatsCount);
    }
    ///endregion
    ...
    public void testAdd3() throws Throwable  {
        ...
        assertEquals(java.lang.Double.POSITIVE_INFINITY, ((double) finalPairedStatsAccumulatorXStatsMin), 1.0E-6);
    ...
    public void testAdd5() throws Throwable  {
        ...
        StatsAccumulator statsAccumulator = ((StatsAccumulator) createInstance("com.google.common.math.StatsAccumulator"));
        setField(statsAccumulator, "mean", 0.0);
        setField(statsAccumulator, "count", -9223372036854775680L);
        setField(pairedStatsAccumulator, "xStats", statsAccumulator);
        ...
        org.junit.Assert.assertEquals(-9223372036854775679L, finalPairedStatsAccumulatorXStatsCount);
    }
    ///endregion
    ...
    public void testAddAll4() throws Throwable  {
        ...
        org.junit.Assert.assertEquals(-9223372036854775807L, finalPairedStatsAccumulatorXStatsCount);
    }
    ///endregion
    ...
    public void testAddAll5() throws Throwable  {
        ...
        setField(statsAccumulator, "count", 65536L);
        setField(pairedStatsAccumulator, "xStats", statsAccumulator);
        PairedStats pairedStats = ((PairedStats) createInstance("com.google.common.math.PairedStats"));
        Stats stats = ((Stats) createInstance("com.google.common.math.Stats"));
        ...
        org.junit.Assert.assertEquals(65537L, finalPairedStatsAccumulatorXStatsCount);
    }
    ///endregion
    ...
    public void testLeastSquaresFit7() throws Throwable  {
        PairedStatsAccumulator pairedStatsAccumulator = ((PairedStatsAccumulator) createInstance("com.google.common.math.PairedStatsAccumulator"));
        setField(pairedStatsAccumulator, "sumOfProductsOfDeltas", 2.0000152587890625);
        StatsAccumulator statsAccumulator = ((StatsAccumulator) createInstance("com.google.common.math.StatsAccumulator"));
        ...
        setField(statsAccumulator1, "mean", 0.0);
        setField(statsAccumulator1, "count", 1125899906842624L);
        setField(pairedStatsAccumulator, "xStats", statsAccumulator1);
