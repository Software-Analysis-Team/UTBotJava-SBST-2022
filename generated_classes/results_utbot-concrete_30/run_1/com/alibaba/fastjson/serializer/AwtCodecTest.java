...
public class AwtCodecTest {
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        Method deserialzeMethod = awtCodecClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, objectType);
        ...
        try {
            deserialzeMethod.invoke(awtCodec, deserialzeMethodArguments);
