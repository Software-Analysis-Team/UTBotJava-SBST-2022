...
public class BooleansTest {
    ...
    public void testIndexOf2() throws Throwable  {
        ...
        try {
            ...
            java.time.chrono.HijrahDate[] hijrahDateArray = new java.time.chrono.HijrahDate[0];
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any(), any());
            }).thenReturn(((Object) hijrahDateArray), null);
    ...
    public void testToArray3() throws Throwable  {
        ...
        setField(booleanArrayAsList, "start", 2013265920);
        boolean[] booleanArray = new boolean[9];
    ...
    public void testReverse6() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(com.google.common.base.Preconditions.class);
            jdk.net.SocketFlow.Status[] statusArray = new jdk.net.SocketFlow.Status[0];
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any());
            }).thenReturn(((Object) statusArray));
    ...
    public void testReverse11() throws Throwable  {
        ...
        try {
            ...
            Booleans.reverse(booleanArray, 0, 2);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testEquals4() throws Throwable  {
        Object booleanArrayAsList = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList, "end", -1840700270);
        ...
        setField(booleanArrayAsList1, "start", 2147457024);
    ...
    public void testEquals5() throws Throwable  {
        Object booleanArrayAsList = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList, "end", -2108798681);
        setField(booleanArrayAsList, "start", -1048576);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", 1619959857);
        setField(booleanArrayAsList1, "start", -567257334);
    ...
    public void testEquals6() throws Throwable  {
        ...
        setField(booleanArrayAsList, "array", booleanArray);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", 2147483632);
        setField(booleanArrayAsList1, "start", 1);
    ...
    public void testEquals7() throws Throwable  {
        Object booleanArrayAsList = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList, "end", 38684967);
        setField(booleanArrayAsList, "start", -1048576);
        boolean[] booleanArray = new boolean[0];
        setField(booleanArrayAsList, "array", booleanArray);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", 1619955249);
        setField(booleanArrayAsList1, "start", 1580221706);
        setField(booleanArrayAsList1, "array", null);
    ...
    public void testEquals8() throws Throwable  {
        Object booleanArrayAsList = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList, "end", 1351717255);
        setField(booleanArrayAsList, "start", 8);
        boolean[] booleanArray = new boolean[9];
        setField(booleanArrayAsList, "array", booleanArray);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", 57667291);
        setField(booleanArrayAsList1, "start", -1294049956);
    ...
    public void testEquals9() throws Throwable  {
        ...
        setField(booleanArrayAsList, "array", booleanArray);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList1, "end", -1073741817);
        setField(booleanArrayAsList1, "start", 1073741832);
        setField(booleanArrayAsList1, "array", booleanArray);
    ...
    public void testEquals11() throws Throwable  {
        Object booleanArrayAsList = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
        setField(booleanArrayAsList, "end", 9);
        setField(booleanArrayAsList, "start", 8);
        boolean[] booleanArray = new boolean[9];
        setField(booleanArrayAsList, "array", booleanArray);
        Object booleanArrayAsList1 = createInstance("com.google.common.primitives.Booleans$BooleanArrayAsList");
    ...
    public void testEquals12() throws Throwable  {
        ...
        setField(booleanArrayAsList, "start", Integer.MIN_VALUE);
        Object regularImmutableAsList = createInstance("com.google.common.collect.RegularImmutableAsList");
        
        Class booleanArrayAsListClazz = Class.forName("com.google.common.primitives.Booleans$BooleanArrayAsList");
        Class regularImmutableAsListType = Class.forName("java.lang.Object");
        Method equalsMethod = booleanArrayAsListClazz.getDeclaredMethod("equals", regularImmutableAsListType);
        equalsMethod.setAccessible(true);
        java.lang.Object[] equalsMethodArguments = new java.lang.Object[1];
        equalsMethodArguments[0] = regularImmutableAsList;
        try {
            equalsMethod.invoke(booleanArrayAsList, equalsMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
