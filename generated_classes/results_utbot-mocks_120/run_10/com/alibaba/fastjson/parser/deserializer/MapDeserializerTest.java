...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, byteArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = genericArrayTypeImpl;
        deserialzeMethodArguments[2] = ((Object) byteArray);
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        java.util.EventObject[] eventObjectArray = new java.util.EventObject[0];
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class syntheticParameterizedTypeType = Class.forName("java.lang.reflect.Type");
        Class eventObjectArrayType = Class.forName("java.lang.Object");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, syntheticParameterizedTypeType, eventObjectArrayType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[3];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = syntheticParameterizedType;
        deserialzeMethodArguments[2] = ((Object) eventObjectArray);
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
    ...
    public void testParseMap1() throws Throwable  {
        Class class1 = Object.class;
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        org.springframework.cglib.core.RejectModifierPredicate[] rejectModifierPredicateArray = new org.springframework.cglib.core.RejectModifierPredicate[0];
        
        MapDeserializer.parseMap(null, null, class1, typeVariableImpl, rejectModifierPredicateArray);
    }
    ///endregion
    ...
    public void testParseMap8() throws Throwable  {
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.lang.Object[] byteBufferAsLongBufferRLArray = createArray("java.nio.ByteBufferAsLongBufferRL", 0);
        
        MapDeserializer.parseMap(null, null, typeVariableImpl, byteBufferAsLongBufferRLArray);
    }
    ///endregion
