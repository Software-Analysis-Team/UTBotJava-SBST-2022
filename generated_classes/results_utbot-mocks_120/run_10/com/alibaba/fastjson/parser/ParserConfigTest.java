...
public class ParserConfigTest {
    ...
    public void testGetDeserializer3() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] classDataSlotArray = createArray("[Ljava.io.ObjectStreamClass$ClassDataSlot;", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) classDataSlotArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
    ...
    public void testGetDeserializer15() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] groupArray = createArray("sun.nio.fs.UnixUserPrincipals$Group", 0);
        when(identityHashMapMock.get(any())).thenReturn(((Object) groupArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        
        parserConfig.getDeserializer(typeVariableImpl);
    }
    ///endregion
    ...
    public void testGetDeserializer16() throws Throwable  {
        ...
        when(identityHashMapMock.get(any())).thenReturn(((Object) awtCodec));
        setField(parserConfig, "deserializers", identityHashMapMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(awtCodec, actual));
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetDeserializer27() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] forEachOrderedTaskArray = createArray("java.util.stream.ForEachOps$ForEachOrderedTask", 0);
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) forEachOrderedTaskArray));
