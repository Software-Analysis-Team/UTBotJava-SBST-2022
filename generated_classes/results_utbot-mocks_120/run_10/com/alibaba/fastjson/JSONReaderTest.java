...
public class JSONReaderTest {
    ...
    public void testReadObject34() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] localeKeyArray = createArray("java.util.Locale$LocaleKey", 0);
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) localeKeyArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(localeKeyArray, actual));
    }
    ///endregion
    ...
    public void testReadString2() throws Throwable  {
        ...
        try {
            ...
            setField(jSONReader, "context", null);
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            java.lang.Object[] actionsArray = createArray("[Ljavax.swing.plaf.basic.BasicPopupMenuUI$Actions;", 0);
            when(defaultJSONParserMock.parse()).thenReturn(((Object) actionsArray));
            setField(jSONReader, "parser", defaultJSONParserMock);
