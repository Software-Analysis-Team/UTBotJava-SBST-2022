...
public class StringCodecTest {
    ...
    public void testWrite5() throws Throwable  {
        ...
        Class stringCodecClazz = Class.forName("com.alibaba.fastjson.serializer.StringCodec");
        Class jSONSerializerMockType = Class.forName("com.alibaba.fastjson.serializer.JSONSerializer");
        Class defaultMXBeanMappingFactoryArrayType = Class.forName("java.lang.Object");
        Class syntheticParameterizedTypeType = Class.forName("java.lang.reflect.Type");
        Class intType = int.class;
        Method writeMethod = stringCodecClazz.getDeclaredMethod("write", jSONSerializerMockType, defaultMXBeanMappingFactoryArrayType, defaultMXBeanMappingFactoryArrayType, syntheticParameterizedTypeType, intType);
        writeMethod.setAccessible(true);
        java.lang.Object[] writeMethodArguments = new java.lang.Object[5];
        writeMethodArguments[0] = jSONSerializerMock;
        writeMethodArguments[1] = ((Object) defaultMXBeanMappingFactoryArray);
        writeMethodArguments[2] = null;
        writeMethodArguments[3] = syntheticParameterizedType;
        writeMethodArguments[4] = 0;
        try {
            writeMethod.invoke(stringCodec, writeMethodArguments);
