...
public class RpcServerTest {
    ...
    public void testDispatch2() throws Throwable  {
        RpcServer rpcServer = ((RpcServer) createInstance("io.seata.core.rpc.netty.RpcServer"));
        sun.security.util.DerValue[] derValueArray = new sun.security.util.DerValue[0];
        
        rpcServer.dispatch(0L, ((ChannelHandlerContext) null), derValueArray);
    }
    ///endregion
    ...
    public void testDispatch9() throws Throwable  {
        ...
        try {
            ...
            rpcServer.dispatch(0L, channelHandlerContextMock, nullProviderArray);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
        }
    ...
    public void testSetHandler4() throws Throwable  {
        ...
        rpcServer.setHandler(transactionMessageHandlerMock, null);
    ...
    public void testHandleDisconnect9() throws Throwable  {
        ...
        try {
            ...
            when(channelMock1.toString()).thenReturn(((String) null));
            when(channelHandlerContextMock.channel()).thenReturn(channelMock, channelMock1, channelMock1);
