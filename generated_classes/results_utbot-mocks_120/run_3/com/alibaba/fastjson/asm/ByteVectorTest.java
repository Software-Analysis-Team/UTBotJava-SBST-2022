...
public class ByteVectorTest {
    ...
    public void testPutByteArray3() throws Throwable  {
        ByteVector byteVector = ((ByteVector) createInstance("com.alibaba.fastjson.asm.ByteVector"));
        byteVector.length = 2146977022;
        byte[] byteArray = new byte[0];
        byteVector.data = byteArray;
        
        ByteVector actual = byteVector.putByteArray(null, 0, 1073726719);
        ...
        assertEquals(-1074263555, finalByteVectorLength);
    }
    ///endregion
    ...
    public void testPutByteArray5() throws Throwable  {
        ByteVector byteVector = ((ByteVector) createInstance("com.alibaba.fastjson.asm.ByteVector"));
        byteVector.length = 20;
        byte[] byteArray = new byte[20];
        byteVector.data = byteArray;
        
        ByteVector actual = byteVector.putByteArray(null, 0, 20);
        ...
        assertEquals(40, finalByteVectorLength);
    ...
    public void testPutByteArray6() throws Throwable  {
        ...
        ByteVector actual = byteVector.putByteArray(null, 0, 24);
        ...
        assertEquals(25, finalByteVectorLength);
    ...
    public void testPutByteArray7() throws Throwable  {
        ByteVector byteVector = ((ByteVector) createInstance("com.alibaba.fastjson.asm.ByteVector"));
        byteVector.length = -1074758016;
        byte[] byteArray = new byte[3];
        byteVector.data = byteArray;
        byte[] byteArray1 = new byte[18];
        
        byteVector.putByteArray(byteArray1, 0, 1074758020);
    }
    ///endregion
