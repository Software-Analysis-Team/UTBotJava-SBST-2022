...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, membershipRegistryArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        Class sAXExceptionArrayType = Class.forName("java.lang.Object");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, wildcardTypeImplType, sAXExceptionArrayType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[3];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = wildcardTypeImpl;
        deserialzeMethodArguments[2] = ((Object) sAXExceptionArray);
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
    ...
    public void testParseMap1() throws Throwable  {
        Class class1 = Object.class;
        java.lang.Object[] argumentsMatchKindArray = createArray("[Lorg.springframework.expression.spel.support.ReflectionHelper$ArgumentsMatchKind;", 0);
        
        MapDeserializer.parseMap(null, null, class1, argumentsMatchKindArray);
    }
    ///endregion
