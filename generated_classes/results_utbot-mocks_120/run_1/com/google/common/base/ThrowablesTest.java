...
public class ThrowablesTest {
    ...
    public void testThrowIfUnchecked3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.lang.Object[] ofDoubleArray = createArray("java.util.stream.Nodes$ToArrayTask$OfDouble", 0);
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) ofDoubleArray));
    ...
    public void testInvokeAccessibleNonThrowingMethod1() throws Throwable  {
        ...
        Class operatorType = Class.forName("java.lang.Object");
        Class objectArrayType = Class.forName("[Ljava.lang.Object;");
        Method invokeAccessibleNonThrowingMethodMethod = throwablesClazz.getDeclaredMethod("invokeAccessibleNonThrowingMethod", methodType, operatorType, objectArrayType);
        ...
        invokeAccessibleNonThrowingMethodMethodArguments[1] = operator;
