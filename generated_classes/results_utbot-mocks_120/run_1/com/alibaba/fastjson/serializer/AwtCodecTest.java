...
public class AwtCodecTest {
    ...
    public void testWrite2() throws Throwable  {
        ...
        javax.management.BadBinaryOpValueExpException[][] badBinaryOpValueExpExceptionArray = new javax.management.BadBinaryOpValueExpException[0][];
        java.io.IOError[] iOErrorArray = new java.io.IOError[0];
        Class class1 = Object.class;
        
        awtCodec.write(null, badBinaryOpValueExpExceptionArray, iOErrorArray, class1, 0);
    }
    ///endregion
    ...
    public void testWrite3() throws Throwable  {
        ...
        awtCodec.write(jSONSerializerMock, null, null, null, 0);
    }
    ///endregion
    ...
    public void testWrite4() throws Throwable  {
        ...
        awtCodec.write(jSONSerializerMock, forEachTaskArray, null, null, 0);
    }
    ///endregion
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        java.lang.Object[] serArray = createArray("java.time.chrono.Ser", 0);
        
        awtCodec.deserialze(null, typeVariableImpl, serArray);
    }
    ///endregion
    ...
    public void testDeserialze4() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 12);
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
    ...
    public void testDeserialze5() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 0, 16);
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 12, 0, 0);
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
        Class class1 = Object.class;
        
        awtCodec.deserialze(defaultJSONParserMock, class1, null);
    ...
    public void testDeserialze8() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 0, 16, 0, 0);
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
        Class class1 = Object.class;
    ...
    public void testDeserialze9() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 12, 0, 4, 0);
    ...
    public void testDeserialze10() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 0, 16, 0, 4, 0);
        when(jSONLexerMock.stringVal()).thenReturn(((String) null));
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
        Class class1 = Object.class;
    ...
    public void testParseFont8() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 4, 4, 0, 0, 0);
        String string = new String("namE");
        when(jSONLexerMock.stringVal()).thenReturn(string, ((String) null));
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
    ...
    public void testParseFont9() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0, 4, 4, 16, 0, 0);
        String string = new String("namE");
        when(jSONLexerMock.stringVal()).thenReturn(string, ((String) null));
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
    ...
    public void testParsePoint1() throws Throwable  {
        ...
        Class awtCodecClazz = Class.forName("com.alibaba.fastjson.serializer.AwtCodec");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class basicSplitPaneDividerArrayType = Class.forName("java.lang.Object");
        Method parsePointMethod = awtCodecClazz.getDeclaredMethod("parsePoint", defaultJSONParserType, basicSplitPaneDividerArrayType);
        ...
        parsePointMethodArguments[1] = ((Object) basicSplitPaneDividerArray);
        try {
    ...
    public void testParseRef2() throws Throwable  {
        ...
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class basicSplitPaneDividerArrayType = Class.forName("java.lang.Object");
        Method parseRefMethod = awtCodecClazz.getDeclaredMethod("parseRef", defaultJSONParserType, basicSplitPaneDividerArrayType);
        parseRefMethod.setAccessible(true);
        java.lang.Object[] parseRefMethodArguments = new java.lang.Object[2];
        parseRefMethodArguments[0] = null;
        parseRefMethodArguments[1] = ((Object) basicSplitPaneDividerArray);
        try {
            parseRefMethod.invoke(awtCodec, parseRefMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
            throw invocationTargetException.getTargetException();
