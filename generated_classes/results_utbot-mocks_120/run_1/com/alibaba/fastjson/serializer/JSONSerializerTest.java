...
public class JSONSerializerTest {
    ...
    ///region Errors report for writeReference
    
    public void testWriteReference_errors()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
    ...
    public void testHasNameFilters4() throws Throwable  {
        ...
        setField(serializeFilterableMock, "nameFilters", arrayList);
    ...
    public void testWriteWithFormat4() throws Throwable  {
        ...
        when(serializeConfigMock.getObjectWriter(any())).thenReturn(objectSerializerMock);
        setField(jSONSerializer, "config", serializeConfigMock);
        java.lang.Object[] valueSpliteratorArray = createArray("[Ljava.util.IdentityHashMap$ValueSpliterator;", 9);
        valueSpliteratorArray[0] = null;
        valueSpliteratorArray[1] = null;
        valueSpliteratorArray[2] = null;
        valueSpliteratorArray[3] = null;
        valueSpliteratorArray[4] = null;
        valueSpliteratorArray[5] = null;
        valueSpliteratorArray[6] = null;
        valueSpliteratorArray[7] = null;
        valueSpliteratorArray[8] = null;
        
        jSONSerializer.writeWithFormat(valueSpliteratorArray, null);
    }
    ///endregion
    ...
    public void testWriteWithFormat6() throws Throwable  {
        ...
        jSONSerializer.writeWithFormat(date, string);
    }
    ///endregion
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testContainsReference4() throws Throwable  {
        JSONSerializer jSONSerializer = ((JSONSerializer) createInstance("com.alibaba.fastjson.serializer.JSONSerializer"));
        IdentityHashMap identityHashMap = ((IdentityHashMap) createInstance("java.util.IdentityHashMap"));
        java.lang.Object[] objectArray = new java.lang.Object[38];
        java.lang.Object[] forEachOrderedTaskArray = createArray("java.util.stream.ForEachOps$ForEachOrderedTask", 0);
        objectArray[36] = forEachOrderedTaskArray;
        java.lang.Object[] forEachOrderedTaskArray1 = createArray("java.util.stream.ForEachOps$ForEachOrderedTask", 0);
        objectArray[37] = forEachOrderedTaskArray1;
        setField(identityHashMap, "table", objectArray);
        jSONSerializer.references = identityHashMap;
        
        jSONSerializer.containsReference(forEachOrderedTaskArray);
    }
    ///endregion
    ...
    @Test(timeout = 10000)
    public void testContainsReference5() throws Throwable  {
        JSONSerializer jSONSerializer = ((JSONSerializer) createInstance("com.alibaba.fastjson.serializer.JSONSerializer"));
        IdentityHashMap identityHashMap = ((IdentityHashMap) createInstance("java.util.IdentityHashMap"));
        java.lang.Object[] objectArray = new java.lang.Object[38];
        java.lang.Object[] forEachOrderedTaskArray = createArray("java.util.stream.ForEachOps$ForEachOrderedTask", 0);
        ...
        SerialContext serialContext = ((SerialContext) createInstance("com.alibaba.fastjson.serializer.SerialContext"));
        Integer integer = 0;
        setField(serialContext, "fieldName", integer);
        objectArray[37] = ((Object) serialContext);
        setField(identityHashMap, "table", objectArray);
        jSONSerializer.references = identityHashMap;
