...
public class JSONReaderTest {
    ...
    public void testGetLocal2() throws Throwable  {
        ...
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        Locale locale = ((Locale) createInstance("java.util.Locale"));
        when(jSONLexerMock.getLocale()).thenReturn(locale);
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(locale, actual));
    }
    ///endregion
    ...
    public void testGetTimzeZone2() throws Throwable  {
        ...
        when(jSONLexerMock.getTimeZone()).thenReturn(((TimeZone) zoneInfo));
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(zoneInfo, actual));
    }
    ///endregion
    ...
    public void testSetTimzeZone2() throws Throwable  {
        ...
        jSONReader.setTimzeZone(simpleTimeZone);
    }
    ///endregion
    ...
    public void testReadInteger2() throws Throwable  {
        ...
        try {
            ...
            when(defaultJSONParserMock.parse()).thenReturn(((Object) nodeArray));
            setField(jSONReader, "parser", defaultJSONParserMock);
    ...
    public void testReadObject10() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] itrArray = createArray("java.util.concurrent.LinkedBlockingQueue$Itr", 0);
        when(defaultJSONParserMock.parse()).thenReturn(((Object) itrArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
    ...
    public void testReadObject26() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] firstArray = createArray("java.util.regex.Pattern$First", 0);
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) firstArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(firstArray, actual));
    }
    ///endregion
    ...
    public void testReadObject41() throws Throwable  {
        ...
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] ofIntArray = createArray("java.util.stream.ForEachOps$ForEachOp$OfInt", 0);
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Class.class))).thenReturn(((Object) ofIntArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
