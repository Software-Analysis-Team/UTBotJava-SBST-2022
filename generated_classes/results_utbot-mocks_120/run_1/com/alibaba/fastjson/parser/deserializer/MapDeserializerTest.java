...
public class MapDeserializerTest {
    ...
    public void testDeserialze3() throws Throwable  {
        ...
        Class threadGroupArrayType = Class.forName("java.lang.Object");
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, threadGroupArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = genericArrayTypeImpl;
        deserialzeMethodArguments[2] = ((Object) threadGroupArray);
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        java.lang.Object[] nodeArray = createArray("java.util.concurrent.LinkedBlockingQueue$Node", 0);
        
        mapDeserializer.deserialze(null, parameterizedTypeImpl, nodeArray);
    }
    ///endregion
    ...
    public void testParseMap1() throws Throwable  {
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.lang.ClassNotFoundException[][][][] classNotFoundExceptionArray = new java.lang.ClassNotFoundException[0][][][];
        
        MapDeserializer.parseMap(null, null, typeVariableImpl, classNotFoundExceptionArray);
    }
    ///endregion
    ...
    public void testParseMap2() throws Throwable  {
        Class class1 = Object.class;
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.security.InvalidKeyException[][] invalidKeyExceptionArray = new java.security.InvalidKeyException[0][];
        
        MapDeserializer.parseMap(null, null, class1, typeVariableImpl, invalidKeyExceptionArray);
    }
    ///endregion
    ...
    public void testParseMap4() throws Throwable  {
        ...
        parseMapMethodArguments[3] = parameterizedTypeImpl;
