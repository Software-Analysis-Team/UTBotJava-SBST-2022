...
public class RpcServerTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        RpcServer rpcServer = ((RpcServer) createInstance("io.seata.core.rpc.netty.RpcServer"));
        java.util.concurrent.CopyOnWriteArrayList[] copyOnWriteArrayListArray = new java.util.concurrent.CopyOnWriteArrayList[0];
        
        rpcServer.userEventTriggered(((ChannelHandlerContext) null), copyOnWriteArrayListArray);
    }
    ///endregion
    ...
    public void testDispatch2() throws Throwable  {
        RpcServer rpcServer = ((RpcServer) createInstance("io.seata.core.rpc.netty.RpcServer"));
        java.lang.Object[] cLDSpliteratorArray = createArray("java.util.concurrent.ConcurrentLinkedDeque$CLDSpliterator", 0);
        
        rpcServer.dispatch(0L, ((ChannelHandlerContext) null), cLDSpliteratorArray);
    }
    ///endregion
