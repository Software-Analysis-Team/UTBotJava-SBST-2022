...
public class ThrowablesTest {
    ...
    public void testThrowIfUnchecked3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.time.chrono.JapaneseDate[] japaneseDateArray = new java.time.chrono.JapaneseDate[0];
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) japaneseDateArray));
    ...
    public void testThrowIfInstanceOf1() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.lang.Object[] privilegedCallableArray = createArray("java.util.concurrent.Executors$PrivilegedCallable", 0);
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) privilegedCallableArray));
    ...
    public void testPropagateIfInstanceOf3() throws Throwable  {
        ...
        try {
            ...
            DateTimeParseException dateTimeParseException = ((DateTimeParseException) createInstance("java.time.format.DateTimeParseException"));
            Class class1 = Object.class;
            
            Throwables.propagateIfInstanceOf(dateTimeParseException, class1);
        } finally {
            mockedStatic.close();
        }
    }
