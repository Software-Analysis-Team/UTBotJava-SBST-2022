...
public class MapDeserializerTest {
    ...
    public void testDeserialze1() throws Throwable  {
        ...
        java.lang.Object[] listenerInfoArray = createArray("javax.management.NotificationBroadcasterSupport$ListenerInfo", 0);
        ...
        Class listenerInfoArrayType = Class.forName("java.lang.Object");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, listenerInfoArrayType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[3];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = genericArrayTypeImpl;
        deserialzeMethodArguments[2] = ((Object) listenerInfoArray);
        try {
    ...
    public void testDeserialze6() throws Throwable  {
        ...
        mapDeserializer.deserialze(defaultJSONParserMock, class1, null);
    ...
    public void testDeserialze7() throws Throwable  {
        ...
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserMockType, genericArrayTypeImplType, objectType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[3];
    ...
    public void testDeserialze8() throws Throwable  {
        ...
        when(defaultJSONParserMock.setContext(any(), any(), any())).thenReturn(parseContextMock);
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Map.class), org.mockito.ArgumentMatchers.any(Object.class))).thenReturn(null);
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(0);
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
        Class class1 = Object.class;
    ...
    public void testDeserialze11() throws Throwable  {
        ...
        mapDeserializer.deserialze(defaultJSONParserMock, parameterizedTypeImpl, null);
    ...
    public void testDeserialze18() throws Throwable  {
        ...
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class genericArrayTypeImplType = Class.forName("java.lang.reflect.Type");
        Class noSuchElementExceptionArrayType = Class.forName("java.lang.Object");
        Class mapType = Class.forName("java.util.Map");
        Method deserialzeMethod = mapDeserializerClazz.getDeclaredMethod("deserialze", defaultJSONParserType, genericArrayTypeImplType, noSuchElementExceptionArrayType, mapType);
        deserialzeMethod.setAccessible(true);
        java.lang.Object[] deserialzeMethodArguments = new java.lang.Object[4];
        deserialzeMethodArguments[0] = null;
        deserialzeMethodArguments[1] = genericArrayTypeImpl;
        deserialzeMethodArguments[2] = ((Object) noSuchElementExceptionArray);
        deserialzeMethodArguments[3] = null;
        try {
            deserialzeMethod.invoke(mapDeserializer, deserialzeMethodArguments);
        } catch (java.lang.reflect.InvocationTargetException invocationTargetException) {
    ...
    public void testCreateMap_errors1()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testCreateMap18() throws Throwable  {
        MapDeserializer mapDeserializer = ((MapDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.MapDeserializer"));
    ...
    public void testCreateMap_errors2()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
    ...
    public void testCreateMap_errors3()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
    ...
    public void testCreateMap_errors4()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
    ...
    public void testCreateMap_errors5()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
    ...
    public void testParseMap1() throws Throwable  {
        ...
        java.lang.Object[] realCallArray = createArray("okhttp3.RealCall", 0);
        
        Class mapDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.MapDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class mapType = Class.forName("java.util.Map");
        Class typeVariableImplType = Class.forName("java.lang.reflect.Type");
        Class realCallArrayType = Class.forName("java.lang.Object");
        Method parseMapMethod = mapDeserializerClazz.getDeclaredMethod("parseMap", defaultJSONParserType, mapType, typeVariableImplType, typeVariableImplType, realCallArrayType);
        parseMapMethod.setAccessible(true);
        java.lang.Object[] parseMapMethodArguments = new java.lang.Object[5];
        parseMapMethodArguments[0] = null;
        parseMapMethodArguments[1] = null;
        parseMapMethodArguments[2] = typeVariableImpl;
        parseMapMethodArguments[3] = wildcardTypeImpl;
        parseMapMethodArguments[4] = ((Object) realCallArray);
        try {
    ...
    public void testParseMap3() throws Throwable  {
        ...
        setField(defaultJSONParserMock, "lexer", jSONLexerMock);
        TypeVariableImpl typeVariableImpl = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        TypeVariableImpl typeVariableImpl1 = ((TypeVariableImpl) createInstance("sun.reflect.generics.reflectiveObjects.TypeVariableImpl"));
        java.lang.Object[] ofDoubleArray = createArray("java.util.stream.StreamSpliterators$SliceSpliterator$OfDouble", 0);
        
        MapDeserializer.parseMap(defaultJSONParserMock, null, typeVariableImpl, typeVariableImpl1, ofDoubleArray);
    }
    ///endregion
    ...
    public void testParseMap5() throws Throwable  {
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        ParserConfig parserConfigMock = mock(ParserConfig.class);
        when(parserConfigMock.getDeserializer(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((ObjectDeserializer) null), ((ObjectDeserializer) null));
    ...
    public void testParseMap6() throws Throwable  {
        ...
        when(parserConfigMock.getDeserializer(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(objectDeserializerMock, ((ObjectDeserializer) null));
        when(defaultJSONParserMock.getConfig()).thenReturn(parserConfigMock, parserConfigMock);
        ...
        Method parseMapMethod = mapDeserializerClazz.getDeclaredMethod("parseMap", defaultJSONParserMockType, mapType, wildcardTypeImplType, wildcardTypeImplType, ofDoubleArrayType);
        parseMapMethod.setAccessible(true);
        java.lang.Object[] parseMapMethodArguments = new java.lang.Object[5];
        parseMapMethodArguments[0] = defaultJSONParserMock;
        parseMapMethodArguments[1] = null;
        parseMapMethodArguments[2] = wildcardTypeImpl;
        parseMapMethodArguments[3] = typeVariableImpl;
    ...
    public void testParseMap8() throws Throwable  {
        ...
        MapDeserializer.parseMap(null, null, class1, ofDoubleArray);
    }
    ///endregion
