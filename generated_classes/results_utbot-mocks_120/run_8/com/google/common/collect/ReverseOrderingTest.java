...
public class ReverseOrderingTest {
    ...
    public void testMin2() throws Throwable  {
        ...
        when(orderingMock.max(org.mockito.ArgumentMatchers.any(Iterable.class))).thenReturn(((Object) shortArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        
        Object actual = reverseOrdering.min(((Iterable) null));
        
        assertArrayEquals(shortArray, ((short[]) actual));
    }
    ///endregion
    ...
    public void testMin4() throws Throwable  {
        ...
        Object actual = reverseOrdering.min(scanner);
    ...
    public void testMin6() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] sizedRefSortingSinkArray = createArray("[Ljava.util.stream.SortedOps$SizedRefSortingSink;", 0);
        
        Object actual = reverseOrdering.min(sizedRefSortingSinkArray, null);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(thaiBuddhistDateArray, actual));
    }
    ///endregion
    ...
    public void testMin8() throws Throwable  {
        ...
        Object actual = reverseOrdering.min(null, null, null, objectArray);
    ...
    public void testMax2() throws Throwable  {
        ...
        Ordering orderingMock = mock(Ordering.class);
        java.time.chrono.ThaiBuddhistDate[] thaiBuddhistDateArray = new java.time.chrono.ThaiBuddhistDate[0];
        when(orderingMock.min(any(), any())).thenReturn(((Object) thaiBuddhistDateArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] findOpArray = createArray("java.util.stream.FindOps$FindOp", 0);
        
        Object actual = reverseOrdering.max(null, findOpArray);
    ...
    public void testMax4() throws Throwable  {
        ...
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterable.class))).thenReturn(((Object) handlerArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(handlerArray, actual));
    }
    ///endregion
    ...
    public void testMax6() throws Throwable  {
        ...
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterator.class))).thenReturn(((Object) japaneseEraArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(japaneseEraArray, actual));
    }
    ///endregion
    ...
    public void testMax8() throws Throwable  {
        ...
        when(orderingMock.min(any(), any(), any(), any())).thenReturn(((Object) stdSocketOptionArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        Object actual = reverseOrdering.max(handlerArray, fifoWaitQueueArray, nodeArray, ((java.lang.Object[]) null));
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(stdSocketOptionArray, actual));
    }
    ///endregion
