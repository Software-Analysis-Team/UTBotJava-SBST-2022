...
public class ParserConfigTest {
    ...
    public void testGetDeserializer3() throws Throwable  {
        ...
        when(identityHashMapMock.get(any())).thenReturn(null, forEachOrderedTask);
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer6() throws Throwable  {
        ...
        ObjectDeserializer actual = parserConfig.getDeserializer(class1, wildcardTypeImpl);
    ...
    public void testCreateFieldDeserializer18() throws Throwable  {
        ...
        when(fieldInfoMock.getAnnotation()).thenReturn(jSONFieldMock);
        ParameterizedTypeImpl parameterizedTypeImpl = ((ParameterizedTypeImpl) createInstance("sun.reflect.generics.reflectiveObjects.ParameterizedTypeImpl"));
        java.lang.reflect.Type[] typeArray = new java.lang.reflect.Type[2];
        WildcardTypeImpl wildcardTypeImpl = ((WildcardTypeImpl) createInstance("sun.reflect.generics.reflectiveObjects.WildcardTypeImpl"));
        java.lang.reflect.Type[] typeArray1 = new java.lang.reflect.Type[0];
        setField(wildcardTypeImpl, "upperBounds", typeArray1);
        typeArray[0] = ((Type) wildcardTypeImpl);
