...
public class QueuesTest {
    ...
    public void testDrain1() throws Throwable  {
        ...
        try {
            ...
            ArrayBlockingQueue arrayBlockingQueue = ((ArrayBlockingQueue) createInstance("java.util.concurrent.ArrayBlockingQueue"));
            
            Queues.drain(arrayBlockingQueue, null, 0, 0L, null);
        } finally {
            mockedStatic.close();
        }
    }
