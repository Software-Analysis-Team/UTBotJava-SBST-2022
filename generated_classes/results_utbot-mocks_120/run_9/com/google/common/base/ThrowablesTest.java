...
public class ThrowablesTest {
    ...
    ///region Errors report for propagateIfPossible
    
    public void testPropagateIfPossible_errors()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
        // Exception sun.security.timestamp.TSResponse$TimestampException is not accessible from package com.google.common.base
        // 
    }
    ///endregion
    ...
    public void testPropagateIfPossible2() throws Throwable  {
        ...
        try {
            ...
            Throwables.propagateIfPossible(fileSystemLoopException, class1, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testPropagateIfPossible4() throws Throwable  {
        ...
        try {
            ...
            XMLStreamException xMLStreamException = ((XMLStreamException) createInstance("jdk.internal.util.xml.XMLStreamException"));
            Class class1 = Object.class;
            
            Throwables.propagateIfPossible(xMLStreamException, class1, class1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testGetCausalChain2() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) fifoWaitQueueArray));
    ...
    public void testGetCausalChain3() throws Throwable  {
        ...
        try {
            ...
            NegativeArraySizeException negativeArraySizeException = ((NegativeArraySizeException) createInstance("java.lang.NegativeArraySizeException"));
            setField(negativeArraySizeException, "cause", negativeArraySizeException);
            
            List actual = Throwables.getCausalChain(negativeArraySizeException);
    ...
    public void testThrowIfUnchecked3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            java.nio.BufferOverflowException[] bufferOverflowExceptionArray = new java.nio.BufferOverflowException[0];
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) bufferOverflowExceptionArray));
