...
public class DefaultJSONParserTest {
    ...
    public void testParseObject19() throws Throwable  {
        ...
        defaultJSONParser.parseObject(class1, collectorTaskArray);
    }
    ///endregion
    ...
    public void testParseObject20() throws Throwable  {
        ...
        when(objectDeserializerMock.deserialze(org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.any(), org.mockito.ArgumentMatchers.any())).thenReturn(((Object) compositeBuilderViaFromArray));
        when(parserConfigMock.getDeserializer(any(Type.class))).thenReturn(objectDeserializerMock);
        defaultJSONParser.config = parserConfigMock;
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(compositeBuilderViaFromArray, actual));
    }
    ///endregion
    ...
    public void testCheckMapResolve2() throws Throwable  {
        ...
        defaultJSONParser.checkMapResolve(null, sliceTaskArray);
    }
    ///endregion
    ...
    public void testParse43() throws Throwable  {
        ...
        JSONLexer jSONLexerMock = mock(JSONLexer.class);
        when(jSONLexerMock.token()).thenReturn(2);
        AtomicLong atomicLong = ((AtomicLong) createInstance("java.util.concurrent.atomic.AtomicLong"));
        when(jSONLexerMock.integerValue()).thenReturn(((Number) atomicLong));
        setField(defaultJSONParser, "lexer", jSONLexerMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(atomicLong, actual));
    }
    ///endregion
