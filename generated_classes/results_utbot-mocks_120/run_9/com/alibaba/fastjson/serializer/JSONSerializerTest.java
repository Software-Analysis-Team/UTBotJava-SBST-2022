...
public class JSONSerializerTest {
    ...
    public void testWriteReference2() throws Throwable  {
        JSONSerializer jSONSerializer = ((JSONSerializer) createInstance("com.alibaba.fastjson.serializer.JSONSerializer"));
        setField(jSONSerializer, "context", null);
        sun.java2d.loops.GraphicsPrimitiveProxy[] graphicsPrimitiveProxyArray = new sun.java2d.loops.GraphicsPrimitiveProxy[0];
        
        jSONSerializer.writeReference(graphicsPrimitiveProxyArray);
    }
    ///endregion
    ...
    public void testWriteWithFieldName3() throws Throwable  {
        ...
        when(serializeConfigMock.getObjectWriter(org.mockito.ArgumentMatchers.any())).thenReturn(objectSerializerMock);
    ...
    public void testGetObjectWriter1() throws Throwable  {
        ...
        ObjectSerializer actual = jSONSerializer.getObjectWriter(null);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(objectSerializerMock, actual));
    }
    ///endregion
