...
public class JSONReaderTest {
    ...
    public void testReadLong2() throws Throwable  {
        ...
        try {
            ...
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            java.lang.Object[] defaultThreadFactoryArray = createArray("[Ljava.util.concurrent.Executors$DefaultThreadFactory;", 0);
            when(defaultJSONParserMock.parse()).thenReturn(((Object) defaultThreadFactoryArray));
            setField(jSONReader, "parser", defaultJSONParserMock);
    ...
    public void testReadObject26() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        sun.java2d.pipe.SpanShapeRenderer.Composite[] compositeArray = new sun.java2d.pipe.SpanShapeRenderer.Composite[0];
        when(defaultJSONParserMock.parse()).thenReturn(((Object) compositeArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(compositeArray, actual));
    }
    ///endregion
