...
public class PrintingContextTest {
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCurrentTypeReference10() throws Throwable  {
        PrintingContext printingContext = ((PrintingContext) createInstance("spoon.reflect.visitor.PrintingContext"));
        CtType ctTypeMock = mock(CtType.class);
        printingContext.currentTopLevel = ctTypeMock;
        ArrayDeque arrayDeque = ((ArrayDeque) createInstance("java.util.ArrayDeque"));
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCurrentTypeReference11() throws Throwable  {
        PrintingContext printingContext = ((PrintingContext) createInstance("spoon.reflect.visitor.PrintingContext"));
        CtType ctTypeMock = mock(CtType.class);
        printingContext.currentTopLevel = ctTypeMock;
        ArrayDeque arrayDeque = ((ArrayDeque) createInstance("java.util.ArrayDeque"));
        setField(arrayDeque, "tail", -536870906);
        setField(arrayDeque, "head", 1073741856);
        java.lang.Object[] objectArray = new java.lang.Object[39];
        setField(arrayDeque, "elements", objectArray);
        setField(printingContext, "currentThis", arrayDeque);
    ...
    public void testGetCurrentTypeContext7() throws Throwable  {
        PrintingContext printingContext = ((PrintingContext) createInstance("spoon.reflect.visitor.PrintingContext"));
        ArrayDeque arrayDeque = ((ArrayDeque) createInstance("java.util.ArrayDeque"));
        setField(arrayDeque, "tail", 536870911);
        setField(arrayDeque, "head", 536870912);
        java.lang.Object[] objectArray = new java.lang.Object[39];
        setField(arrayDeque, "elements", objectArray);
        setField(printingContext, "currentThis", arrayDeque);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCurrentTypeContext9() throws Throwable  {
        PrintingContext printingContext = ((PrintingContext) createInstance("spoon.reflect.visitor.PrintingContext"));
        ...
        setField(printingContext, "currentThis", linkedBlockingDeque);
        ...
        Deque deque = printingContext.currentThis;
        Object dequeCurrentThisLock = getFieldValue(deque, "lock");
        Object dequeCurrentThisLockCurrentThisLockSync = getFieldValue(dequeCurrentThisLock, "sync");
        Object finalPrintingContextCurrentThisLockSyncState = getFieldValue(dequeCurrentThisLockCurrentThisLockSync, "state");
        
        assertEquals(3, finalPrintingContextCurrentThisLockSyncState);
    }
    ///endregion
    ...
    public void testPushCurrentThis4() throws Throwable  {
        PrintingContext printingContext = ((PrintingContext) createInstance("spoon.reflect.visitor.PrintingContext"));
        ArrayDeque arrayDeque = ((ArrayDeque) createInstance("java.util.ArrayDeque"));
        setField(arrayDeque, "head", 1069023232);
        java.lang.Object[] objectArray = new java.lang.Object[0];
        setField(arrayDeque, "elements", objectArray);
        setField(printingContext, "currentThis", arrayDeque);
        CtType ctTypeMock = mock(CtType.class);
        ...
        assertEquals(1069023231, finalPrintingContextCurrentThisHead);
    }
    ///endregion
