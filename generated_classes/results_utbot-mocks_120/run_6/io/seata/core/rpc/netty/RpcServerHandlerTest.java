...
public class RpcServerHandlerTest {
    ...
    public void testExceptionCaught2() throws Throwable  {
        ...
        NotYetConnectedException notYetConnectedException = ((NotYetConnectedException) createInstance("java.nio.channels.NotYetConnectedException"));
        
        rpcServerHandler.exceptionCaught(((ChannelHandlerContext) null), notYetConnectedException);
    }
    ///endregion
