...
public class IntMathTest {
    ...
    public void testGcd4() throws Throwable  {
        ...
        try {
            ...
            int actual = IntMath.gcd(1073741824, 262144);
            
            assertEquals(262144, actual);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000)
    public void testSqrtFloor3() throws Throwable  {
        Class intMathClazz = Class.forName("com.google.common.math.IntMath");
        Class intType = int.class;
        Method sqrtFloorMethod = intMathClazz.getDeclaredMethod("sqrtFloor", intType);
        sqrtFloorMethod.setAccessible(true);
        java.lang.Object[] sqrtFloorMethodArguments = new java.lang.Object[1];
        sqrtFloorMethodArguments[0] = -18;
        int actual = ((int) sqrtFloorMethod.invoke(null, sqrtFloorMethodArguments));
    ...
    public void testCheckedPow16() throws Throwable  {
        ...
        try {
            ...
            int actual = IntMath.checkedPow(46341, 2);
            
            assertEquals(-2147479015, actual);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testCheckedPow17() throws Throwable  {
        ...
        try {
            ...
            int actual = IntMath.checkedPow(-778047984, 3);
            
            assertEquals(1418334208, actual);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testBinomial4() throws Throwable  {
        ...
        try {
            ...
            try {
                ...
                int actual = IntMath.binomial(1073741824, 134217736);
    ...
    public void testDivide3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(com.google.common.base.Preconditions.class);
            java.lang.Object[] tzdbZoneRulesProviderArray = createArray("java.time.zone.TzdbZoneRulesProvider", 0);
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any());
            }).thenReturn(((Object) tzdbZoneRulesProviderArray));
            
            int actual = IntMath.divide(0, 268435456, null);
    ...
    public void testDivide4() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any());
            }).thenReturn(((Object) intSortingSinkArray));
            
            IntMath.divide(-134217728, 2145386496, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testDivide5() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(com.google.common.base.Preconditions.class);
            sun.net.ExtendedOptionsHelper[] extendedOptionsHelperArray = new sun.net.ExtendedOptionsHelper[0];
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any());
            }).thenReturn(((Object) extendedOptionsHelperArray));
            RoundingMode roundingMode = RoundingMode.UP;
            
            int actual = IntMath.divide(1, 1610612736, roundingMode);
