...
public class QueuesTest {
    ...
    public void testDrain1() throws Throwable  {
        ...
        try {
            ...
            PriorityBlockingQueue priorityBlockingQueue = ((PriorityBlockingQueue) createInstance("java.util.concurrent.PriorityBlockingQueue"));
            
            Queues.drain(priorityBlockingQueue, null, 0, 0L, null);
        } finally {
            mockedStatic.close();
        }
    }
