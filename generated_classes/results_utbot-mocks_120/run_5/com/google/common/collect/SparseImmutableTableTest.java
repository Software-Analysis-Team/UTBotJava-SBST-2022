...
public class SparseImmutableTableTest {
    ...
    public void testRowMap1() throws Throwable  {
        ...
        try {
            ...
            setField(sparseImmutableTable, "rowMap", immutableMapMock1);
            
            ImmutableMap actual = sparseImmutableTable.rowMap();
            
            
            // Current deep equals depth exceeds max depth 0
            assertTrue(deepEquals(immutableMapMock, actual));
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000)
    public void testGetCell21() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(ImmutableTable.class);
            mockedStatic.when(() -> {
            ...
            ImmutableSet immutableSetMock1 = mock(ImmutableSet.class);
            ImmutableList immutableListMock1 = mock(ImmutableList.class);
            Object treeNode = createInstance("java.util.concurrent.ConcurrentHashMap$TreeNode");
            sun.net.www.http.ChunkedInputStream[] chunkedInputStreamArray = new sun.net.www.http.ChunkedInputStream[0];
            setField(treeNode, "val", chunkedInputStreamArray);
            setField(treeNode, "key", chunkedInputStreamArray);
            when(immutableListMock1.get(anyInt())).thenReturn(((Object) immutableEntry), treeNode);
            when(immutableSetMock1.asList()).thenReturn(immutableListMock1);
            setField(immutableSortedMap, "entrySet", immutableSetMock1);
            setField(immutableEntry, "value", immutableSortedMap);
            java.lang.Object[] nativeObjectArray = createArray("sun.nio.ch.NativeObject", 0);
            setField(immutableEntry, "key", nativeObjectArray);
            when(immutableListMock.get(anyInt())).thenReturn(((Object) immutableEntry), treeNode);
            when(immutableSetMock.asList()).thenReturn(immutableListMock);
            when(immutableMapMock.entrySet()).thenReturn(immutableSetMock);
            setField(immutableMapMock, "entrySet", null);
            setField(sparseImmutableTable, "rowMap", immutableMapMock);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testGetCell22() throws Throwable  {
        SparseImmutableTable sparseImmutableTable = ((SparseImmutableTable) createInstance("com.google.common.collect.SparseImmutableTable"));
        int[] intArray = new int[9];
        setField(sparseImmutableTable, "cellRowIndices", intArray);
        ImmutableMap immutableMapMock = mock(ImmutableMap.class);
        ...
        java.util.concurrent.ThreadPoolExecutor.AbortPolicy[] abortPolicyArray = new java.util.concurrent.ThreadPoolExecutor.AbortPolicy[0];
        setField(treeNode, "value", abortPolicyArray);
        when(immutableListMock.get(anyInt())).thenReturn(treeNode);
        when(immutableSetMock.asList()).thenReturn(immutableListMock);
        when(immutableMapMock.entrySet()).thenReturn(immutableSetMock);
        setField(sparseImmutableTable, "rowMap", immutableMapMock);
    ...
    @Test(timeout = 10000)
    public void testGetCell23() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(ImmutableTable.class);
            mockedStatic.when(() -> {
            ...
            Object treeNode = createInstance("java.util.HashMap$TreeNode");
            sun.net.www.http.ChunkedInputStream[] chunkedInputStreamArray = new sun.net.www.http.ChunkedInputStream[0];
            setField(treeNode, "value", chunkedInputStreamArray);
            setField(treeNode, "key", chunkedInputStreamArray);
            when(immutableListMock1.get(anyInt())).thenReturn(attributeEntry, treeNode);
            when(immutableSetMock1.asList()).thenReturn(immutableListMock1);
            setField(inverse, "entrySet", immutableSetMock1);
            setField(attributeEntry, "value", inverse);
            AttributedCharacterIterator.Attribute attribute = ((AttributedCharacterIterator.Attribute) createInstance("java.text.AttributedCharacterIterator$Attribute"));
            setField(attributeEntry, "key", attribute);
            when(immutableListMock.get(anyInt())).thenReturn(attributeEntry, treeNode);
            when(immutableSetMock.asList()).thenReturn(immutableListMock);
            when(immutableMapMock.entrySet()).thenReturn(immutableSetMock);
            setField(immutableMapMock, "entrySet", null);
            setField(sparseImmutableTable, "rowMap", immutableMapMock);
    ...
    public void testSparseImmutableTable10() throws Throwable  {
        ...
        try {
            ...
            when(immutableListMock.get(anyInt())).thenReturn(((Object) workerArray));
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(false, false);
            when(immutableSetMock.iterator()).thenReturn(unmodifiableIteratorMock, unmodifiableIteratorMock);
    ...
    public void testSparseImmutableTable13() throws Throwable  {
        ...
        try {
            ...
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(9, 10, 8388608);
    ...
    public void testSparseImmutableTable15() throws Throwable  {
        ...
        try {
            ...
            ImmutableMap immutableMapMock = mock(ImmutableMap.class);
            Tables.ImmutableCell immutableCell = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            java.lang.TypeNotPresentException[] typeNotPresentExceptionArray = new java.lang.TypeNotPresentException[0];
            setField(immutableCell, "value", typeNotPresentExceptionArray);
            ThreadGroup threadGroup = ((ThreadGroup) createInstance("java.lang.ThreadGroup"));
            setField(immutableCell, "columnKey", threadGroup);
            java.lang.Object[] type6Array = createArray("sun.nio.ch.MembershipKeyImpl$Type6", 0);
            setField(immutableCell, "rowKey", type6Array);
            when(immutableMapMock.get(org.mockito.ArgumentMatchers.any())).thenReturn(((Object) immutableCell));
            mockedStatic.when(() -> {
                Maps.indexMap(org.mockito.ArgumentMatchers.any());
            }).thenReturn(immutableMapMock);
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(((LinkedHashMap) null), linkedHashMap);
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(0, 4, 4);
            when(immutableListMock.get(anyInt())).thenReturn(((Object) immutableCell));
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(false);
    ...
    public void testSparseImmutableTable16() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(linkedHashMap, linkedHashMap);
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(8, 12, 1);
            Tables.ImmutableCell immutableCell = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            java.lang.Object[] workerArray = createArray("java.util.concurrent.ThreadPoolExecutor$Worker", 0);
            setField(immutableCell, "value", workerArray);
            setField(immutableCell, "columnKey", workerArray);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testSparseImmutableTable19() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Maps.class);
            mockedStatic.when(() -> {
            ...
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            java.lang.Object[] weakKeyValueMapArray = createArray("javax.security.auth.SubjectDomainCombiner$WeakKeyValueMap", 0);
            LinkedHashMap linkedHashMap1 = ((LinkedHashMap) createInstance("java.util.LinkedHashMap"));
            linkedHashMap.put(weakKeyValueMapArray, linkedHashMap1);
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(((LinkedHashMap) null), linkedHashMap);
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(false);
            ...
            ImmutableSet immutableSetMock1 = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock1 = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock1.hasNext()).thenReturn(true, false);
            when(unmodifiableIteratorMock1.next()).thenReturn(((Object) weakKeyValueMapArray));
            when(immutableSetMock1.iterator()).thenReturn(unmodifiableIteratorMock1);
            new SparseImmutableTable(null, immutableSetMock, immutableSetMock1);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testSparseImmutableTable20() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Maps.class);
            ImmutableMap immutableMapMock = mock(ImmutableMap.class);
            ...
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(linkedHashMap, linkedHashMap1);
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(12, 1, 1);
            Tables.ImmutableCell immutableCell = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            java.lang.Object[] arrayNodeArray = createArray("java.util.stream.Nodes$ArrayNode", 0);
            setField(immutableCell, "value", arrayNodeArray);
            java.lang.Object[] cIArray = createArray("java.time.format.DateTimeFormatterBuilder$PrefixTree$CI", 0);
            setField(immutableCell, "columnKey", cIArray);
            Object weakKeyValueMap = createInstance("javax.security.auth.SubjectDomainCombiner$WeakKeyValueMap");
            setField(immutableCell, "rowKey", weakKeyValueMap);
            when(immutableListMock.get(anyInt())).thenReturn(((Object) immutableCell));
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(false);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testSparseImmutableTable21() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Maps.class);
            ImmutableMap immutableMapMock = mock(ImmutableMap.class);
            ...
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            LinkedHashMap linkedHashMap1 = ((LinkedHashMap) createInstance("java.util.LinkedHashMap"));
            linkedHashMap.put(null, linkedHashMap1);
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(linkedHashMap, ((LinkedHashMap) null));
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(Integer.MIN_VALUE);
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(true, false);
            when(unmodifiableIteratorMock.next()).thenReturn(null);
            when(immutableSetMock.iterator()).thenReturn(unmodifiableIteratorMock);
            ImmutableSet immutableSetMock1 = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock1 = mock(UnmodifiableIterator.class);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testSparseImmutableTable22() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Maps.class);
            ImmutableMap immutableMapMock = mock(ImmutableMap.class);
            ...
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(true, false, false);
            when(unmodifiableIteratorMock.next()).thenReturn(null);
            when(immutableSetMock.iterator()).thenReturn(unmodifiableIteratorMock);
            ImmutableSet immutableSetMock1 = mock(ImmutableSet.class);
            when(immutableSetMock1.iterator()).thenReturn(unmodifiableIteratorMock);
    ...
    @Test(timeout = 10000, expected = Throwable.class)
    public void testSparseImmutableTable23() throws Throwable  {
        org.mockito.MockedStatic mockedStatic = null;
        try {
            mockedStatic = mockStatic(Maps.class);
            ImmutableMap immutableMapMock = mock(ImmutableMap.class);
            ...
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(linkedHashMap, ((LinkedHashMap) null));
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(9, 10, 1);
            Tables.ImmutableCell immutableCell = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            java.lang.Object[] delegatedExecutorServiceArray = createArray("java.util.concurrent.Executors$DelegatedExecutorService", 0);
            setField(immutableCell, "value", delegatedExecutorServiceArray);
            java.lang.Object[] defaultThreadFactoryArray = createArray("java.util.concurrent.Executors$DefaultThreadFactory", 0);
            setField(immutableCell, "columnKey", defaultThreadFactoryArray);
            Character character = '\u0000';
            setField(immutableCell, "rowKey", character);
            when(immutableListMock.get(anyInt())).thenReturn(((Object) immutableCell));
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(false);
