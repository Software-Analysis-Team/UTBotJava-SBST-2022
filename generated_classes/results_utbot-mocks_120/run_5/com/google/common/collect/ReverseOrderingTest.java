...
public class ReverseOrderingTest {
    ...
    public void testCompare2() throws Throwable  {
        ...
        java.lang.Object[] operatorArray1 = createArray("[Lsun.security.util.DisabledAlgorithmConstraints$Constraint$Operator;", 0);
        
        int actual = reverseOrdering.compare(operatorArray, operatorArray1);
    ...
    public void testMin2() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] ofLongArray = createArray("java.util.stream.StreamSpliterators$InfiniteSupplyingSpliterator$OfLong", 0);
        when(orderingMock.max(org.mockito.ArgumentMatchers.any(Iterable.class))).thenReturn(((Object) ofLongArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
    ...
    public void testMin4() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        jdk.internal.org.xml.sax.helpers.DefaultHandler[] defaultHandlerArray = new jdk.internal.org.xml.sax.helpers.DefaultHandler[0];
        when(orderingMock.max(org.mockito.ArgumentMatchers.any(Iterator.class))).thenReturn(((Object) defaultHandlerArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(defaultHandlerArray, actual));
    }
    ///endregion
    ...
    public void testMin6() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        java.lang.Object[] operatorArray1 = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.min(operatorArray, operatorArray1);
    ...
    public void testMax2() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] rBTableBuilderArray = createArray("java.text.RBTableBuilder", 0);
        when(orderingMock.min(any(), any())).thenReturn(((Object) rBTableBuilderArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.lang.Object[] operatorArray = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        java.lang.Object[] operatorArray1 = createArray("sun.security.util.DisabledAlgorithmConstraints$Constraint$Operator", 0);
        
        Object actual = reverseOrdering.max(operatorArray, operatorArray1);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(rBTableBuilderArray, actual));
    }
    ///endregion
    ...
    public void testMax4() throws Throwable  {
        ...
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterable.class))).thenReturn(((Object) thaiBuddhistDateArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
