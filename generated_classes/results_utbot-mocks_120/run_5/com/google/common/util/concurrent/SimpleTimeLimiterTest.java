...
public class SimpleTimeLimiterTest {
    ...
    public void testNewProxy1() throws Throwable  {
        ...
        try {
            ...
            simpleTimeLimiter.newProxy(null, null, 1L, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testNewProxy2() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                com.google.common.base.Preconditions.checkNotNull(any());
            }).thenReturn(((Object) connectionResetExceptionArray), ((Object) connectionResetExceptionArray), ((Object) connectionResetExceptionArray));
            SimpleTimeLimiter simpleTimeLimiter = ((SimpleTimeLimiter) createInstance("com.google.common.util.concurrent.SimpleTimeLimiter"));
            sun.net.ConnectionResetException[] connectionResetExceptionArray1 = new sun.net.ConnectionResetException[0];
            
            simpleTimeLimiter.newProxy(connectionResetExceptionArray1, null, -9223372036854775807L, null);
        } finally {
            mockedStatic.close();
        }
    }
    ...
    public void testNewProxy3() throws Throwable  {
        Object annotationInvocationHandler = createInstance("sun.reflect.annotation.AnnotationInvocationHandler");
        
        Class simpleTimeLimiterClazz = Class.forName("com.google.common.util.concurrent.SimpleTimeLimiter");
        Class classType = Class.forName("java.lang.Class");
        Class annotationInvocationHandlerType = Class.forName("java.lang.reflect.InvocationHandler");
        Method newProxyMethod = simpleTimeLimiterClazz.getDeclaredMethod("newProxy", classType, annotationInvocationHandlerType);
        ...
        newProxyMethodArguments[1] = annotationInvocationHandler;
        try {
    ...
    public void testCreate3() throws Throwable  {
        ...
        try {
            ...
            Object directExecutorService = createInstance("com.google.common.util.concurrent.MoreExecutors$DirectExecutorService");
            
            Class simpleTimeLimiterClazz = Class.forName("com.google.common.util.concurrent.SimpleTimeLimiter");
            Class directExecutorServiceType = Class.forName("java.util.concurrent.ExecutorService");
            Method createMethod = simpleTimeLimiterClazz.getDeclaredMethod("create", directExecutorServiceType);
            createMethod.setAccessible(true);
            java.lang.Object[] createMethodArguments = new java.lang.Object[1];
            createMethodArguments[0] = directExecutorService;
            try {
