...
public class JSONReaderTest {
    ...
    public void testReadInteger2() throws Throwable  {
        ...
        try {
            ...
            setField(jSONReader, "context", null);
            DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
            java.lang.Object[] accessibleJComboBoxListSelectionListenerArray = createArray("javax.swing.JComboBox$AccessibleJComboBox$AccessibleJComboBoxListSelectionListener", 0);
            when(defaultJSONParserMock.parse()).thenReturn(((Object) accessibleJComboBoxListSelectionListenerArray));
            setField(jSONReader, "parser", defaultJSONParserMock);
    ...
    public void testReadObject10() throws Throwable  {
        ...
        setField(jSONReader, "context", null);
        DefaultJSONParser defaultJSONParserMock = mock(DefaultJSONParser.class);
        java.lang.Object[] unitArray = createArray("java.time.temporal.IsoFields$Unit", 0);
        when(defaultJSONParserMock.parse()).thenReturn(((Object) unitArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(unitArray, actual));
    }
    ///endregion
    ...
    public void testReadObject25() throws Throwable  {
        ...
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Class.class))).thenReturn(((Object) basicBordersArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(basicBordersArray, actual));
    }
    ///endregion
    ...
    public void testReadObject33() throws Throwable  {
        ...
        when(defaultJSONParserMock.parseObject(org.mockito.ArgumentMatchers.any(Type.class))).thenReturn(((Object) entryArray));
        setField(jSONReader, "parser", defaultJSONParserMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(entryArray, actual));
    }
    ///endregion
