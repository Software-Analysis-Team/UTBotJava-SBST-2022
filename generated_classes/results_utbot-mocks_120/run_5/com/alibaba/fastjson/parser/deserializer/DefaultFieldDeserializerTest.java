...
public class DefaultFieldDeserializerTest {
    ...
    public void testParseField4() throws Throwable  {
        ...
        try {
            ...
            }).thenReturn(((Type) typeVariableImpl));
            DefaultFieldDeserializer defaultFieldDeserializer = ((DefaultFieldDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer"));
            Class class1 = Object.class;
            ...
            setField(parseContextMock, "type", typeVariableImpl1);
            ...
            Class mapType = Class.forName("java.util.Map");
            Method parseFieldMethod = defaultFieldDeserializerClazz.getDeclaredMethod("parseField", defaultJSONParserMockType, class1, parameterizedTypeImpl1Type, mapType);
            parseFieldMethod.setAccessible(true);
            java.lang.Object[] parseFieldMethodArguments = new java.lang.Object[4];
    ...
    public void testParseField5() throws Throwable  {
        ...
        WildcardTypeImpl wildcardTypeImpl = ((WildcardTypeImpl) createInstance("sun.reflect.generics.reflectiveObjects.WildcardTypeImpl"));
        setField(fieldInfoMock, "fieldType", wildcardTypeImpl);
        String string1 = new String("");
        setField(fieldInfoMock, "name", string1);
        setField(defaultFieldDeserializer, "fieldInfo", fieldInfoMock);
        ObjectDeserializer objectDeserializerMock = mock(ObjectDeserializer.class);
        java.lang.Object[] checkedSortedSetArray = createArray("[Ljava.util.Collections$CheckedSortedSet;", 10);
        checkedSortedSetArray[0] = null;
        checkedSortedSetArray[1] = null;
        checkedSortedSetArray[2] = null;
        checkedSortedSetArray[3] = null;
        checkedSortedSetArray[4] = null;
        checkedSortedSetArray[5] = null;
        checkedSortedSetArray[6] = null;
        checkedSortedSetArray[7] = null;
        checkedSortedSetArray[8] = null;
        checkedSortedSetArray[9] = null;
        when(objectDeserializerMock.deserialze(any(), any(), any())).thenReturn(((Object) checkedSortedSetArray));
        defaultFieldDeserializer.fieldValueDeserilizer = objectDeserializerMock;
        sun.font.EAttribute[][] eAttributeArray = new sun.font.EAttribute[0][];
        Object genericArrayTypeImpl = createInstance("retrofit2.Utils$GenericArrayTypeImpl");
        
        Class defaultFieldDeserializerClazz = Class.forName("com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer");
        Class defaultJSONParserType = Class.forName("com.alibaba.fastjson.parser.DefaultJSONParser");
        Class eAttributeArrayType = Class.forName("java.lang.Object");
        Class genericArrayTypeImplType = Class.forName("java.lang.reflect.Type");
        Class mapType = Class.forName("java.util.Map");
        Method parseFieldMethod = defaultFieldDeserializerClazz.getDeclaredMethod("parseField", defaultJSONParserType, eAttributeArrayType, genericArrayTypeImplType, mapType);
        parseFieldMethod.setAccessible(true);
        java.lang.Object[] parseFieldMethodArguments = new java.lang.Object[4];
        parseFieldMethodArguments[0] = null;
        parseFieldMethodArguments[1] = ((Object) eAttributeArray);
    ...
    public void testParseField8() throws Throwable  {
        ...
        Method parseFieldMethod = defaultFieldDeserializerClazz.getDeclaredMethod("parseField", defaultJSONParserMockType, class1, wildcardTypeImplType, linkedHashMapType);
        parseFieldMethod.setAccessible(true);
        java.lang.Object[] parseFieldMethodArguments = new java.lang.Object[4];
        parseFieldMethodArguments[0] = defaultJSONParserMock;
        parseFieldMethodArguments[1] = ((Object) filteredKeyMultimapArray);
        parseFieldMethodArguments[2] = wildcardTypeImpl;
    ...
    public void testParseFieldUnwrapped2() throws Throwable  {
        ...
        defaultFieldDeserializer.parseFieldUnwrapped(null, doubleArray, typeVariableImpl, null);
    }
    ///endregion
    ...
    public void testGetFieldValueDeserilizer_errors5()
     {
        // Couldn't generate some tests. List of errors:
        // 
        // 1 occurrences of:
