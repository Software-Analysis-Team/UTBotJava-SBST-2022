...
public class RmRpcClientTest {
    ...
    public void testUserEventTriggered2() throws Throwable  {
        RmRpcClient rmRpcClient = ((RmRpcClient) createInstance("io.seata.core.rpc.netty.RmRpcClient"));
        java.lang.Object[] heapDoubleBufferRArray = createArray("java.nio.HeapDoubleBufferR", 0);
        
        rmRpcClient.userEventTriggered(((ChannelHandlerContext) null), heapDoubleBufferRArray);
    }
    ///endregion
    ...
    public void testSendMsgWithResponse2() throws Throwable  {
        ...
        try {
            ...
            String string = new String("");
            setField(rmRpcClient, "transactionServiceGroup", string);
            java.lang.Object[] calendarAccessControlContextArray = createArray("java.util.Calendar$CalendarAccessControlContext", 0);
            
            rmRpcClient.sendMsgWithResponse(calendarAccessControlContextArray, 0L);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
            mockedStatic2.close();
    ...
    public void testSendMsgWithResponse5() throws Throwable  {
        ...
        try {
            ...
            rmRpcClient.sendMsgWithResponse(directByteBufferRArray);
        } finally {
            mockedStatic.close();
            mockedStatic1.close();
            mockedStatic2.close();
