...
public class ByteVectorTest {
    ...
    public void testPutByteArray3() throws Throwable  {
        ByteVector byteVector = ((ByteVector) createInstance("com.alibaba.fastjson.asm.ByteVector"));
        byteVector.length = 2147029502;
        byte[] byteArray = new byte[0];
        byteVector.data = byteArray;
        
        ByteVector actual = byteVector.putByteArray(null, 0, 1073680895);
        ...
        assertEquals(-1074256899, finalByteVectorLength);
    }
    ///endregion
    ...
    public void testPutByteArray6() throws Throwable  {
        ...
        ByteVector actual = byteVector.putByteArray(null, 0, 21);
        ...
        assertEquals(23, finalByteVectorLength);
    ...
    public void testPutByteArray7() throws Throwable  {
        ByteVector byteVector = ((ByteVector) createInstance("com.alibaba.fastjson.asm.ByteVector"));
        byteVector.length = -1074725248;
        byte[] byteArray = new byte[3];
        byteVector.data = byteArray;
        byte[] byteArray1 = new byte[18];
        
        byteVector.putByteArray(byteArray1, 0, 1074725252);
    }
    ///endregion
