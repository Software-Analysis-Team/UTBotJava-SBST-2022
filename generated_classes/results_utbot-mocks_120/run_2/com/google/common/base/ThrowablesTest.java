...
public class ThrowablesTest {
    ...
    public void testThrowIfUnchecked3() throws Throwable  {
        ...
        try {
            mockedStatic = mockStatic(Preconditions.class);
            Object linearCongruentialGenerator = createInstance("com.google.common.hash.Hashing$LinearCongruentialGenerator");
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(linearCongruentialGenerator);
    ...
    public void testThrowIfInstanceOf1() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(() -> {
                Preconditions.checkNotNull(any());
            }).thenReturn(((Object) cOWSubListIteratorArray));
    ...
    public void testPropagateIfInstanceOf3() throws Throwable  {
        ...
        try {
            ...
            FormatFlagsConversionMismatchException formatFlagsConversionMismatchException = ((FormatFlagsConversionMismatchException) createInstance("java.util.FormatFlagsConversionMismatchException"));
            Class class1 = Object.class;
            
            Throwables.propagateIfInstanceOf(formatFlagsConversionMismatchException, class1);
        } finally {
            mockedStatic.close();
        }
    }
