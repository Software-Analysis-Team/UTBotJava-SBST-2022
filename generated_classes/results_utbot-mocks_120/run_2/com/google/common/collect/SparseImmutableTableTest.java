...
public class SparseImmutableTableTest {
    ...
    public void testGetCell16() throws Throwable  {
        ...
        try {
            ...
            Format.Field field = ((Format.Field) createInstance("java.text.Format$Field"));
            ...
            setField(immutableEntry, "key", fileBuilderArray);
            when(immutableListMock.get(anyInt())).thenReturn(((Object) immutableEntry));
            when(immutableSetMock.asList()).thenReturn(immutableListMock);
            when(immutableMapMock.entrySet()).thenReturn(immutableSetMock);
            setField(immutableMapMock, "entrySet", null);
    ...
    public void testSparseImmutableTable15() throws Throwable  {
        ...
        try {
            ...
            ImmutableMap immutableMapMock = mock(ImmutableMap.class);
            Tables.ImmutableCell immutableCell = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            Tables.ImmutableCell immutableCell1 = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            setField(immutableCell1, "value", null);
            setField(immutableCell1, "columnKey", null);
            setField(immutableCell1, "rowKey", null);
            setField(immutableCell, "value", immutableCell1);
            Object checkedRandomAccessList = createInstance("java.util.Collections$CheckedRandomAccessList");
            setField(immutableCell, "columnKey", checkedRandomAccessList);
            ...
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(((LinkedHashMap) null), ((LinkedHashMap) null));
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(10, 12, 1);
            when(immutableListMock.get(anyInt())).thenReturn(((Object) immutableCell));
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(false);
    ...
    public void testSparseImmutableTable19() throws Throwable  {
        ...
        try {
            ...
            LinkedHashMap linkedHashMap2 = ((LinkedHashMap) createInstance("java.util.LinkedHashMap"));
            linkedHashMap1.put(handlerArray, linkedHashMap2);
            ...
            when(unmodifiableIteratorMock1.next()).thenReturn(((Object) handlerArray));
            when(immutableSetMock1.iterator()).thenReturn(unmodifiableIteratorMock1);
    ...
    public void testSparseImmutableTable20() throws Throwable  {
        ...
        try {
            ...
            mockedStatic.when(Maps::newLinkedHashMap).thenReturn(linkedHashMap, linkedHashMap1);
            ImmutableList immutableListMock = mock(ImmutableList.class);
            when(immutableListMock.size()).thenReturn(12, 0, 1);
            Tables.ImmutableCell immutableCell = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            ...
            Object fixedNodeBuilder = createInstance("java.util.stream.Nodes$FixedNodeBuilder");
            setField(immutableCell, "rowKey", fixedNodeBuilder);
            when(immutableListMock.get(anyInt())).thenReturn(((Object) immutableCell));
            ImmutableSet immutableSetMock = mock(ImmutableSet.class);
            UnmodifiableIterator unmodifiableIteratorMock = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock.hasNext()).thenReturn(false);
    ...
    public void testSparseImmutableTable21() throws Throwable  {
        ...
        try {
            ...
            UnmodifiableIterator unmodifiableIteratorMock1 = mock(UnmodifiableIterator.class);
            when(unmodifiableIteratorMock1.hasNext()).thenReturn(false);
            when(immutableSetMock.iterator()).thenReturn(unmodifiableIteratorMock, unmodifiableIteratorMock1);
            new SparseImmutableTable(immutableListMock, immutableSetMock, immutableSetMock);
        } finally {
            mockedStatic.close();
        }
    ...
    public void testSparseImmutableTable23() throws Throwable  {
        ...
        try {
            ...
            when(immutableListMock.size()).thenReturn(9, 9, 1);
            Tables.ImmutableCell immutableCell = ((Tables.ImmutableCell) createInstance("com.google.common.collect.Tables$ImmutableCell"));
            java.util.Objects[] objectsArray = new java.util.Objects[0];
            setField(immutableCell, "value", objectsArray);
            java.lang.Object[] fixedNodeBuilderArray = createArray("java.util.stream.Nodes$FixedNodeBuilder", 0);
            setField(immutableCell, "columnKey", fixedNodeBuilderArray);
            Character character = '\u0000';
