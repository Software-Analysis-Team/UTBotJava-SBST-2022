...
public class DefaultCoreFactoryTest {
    ...
    public void testCreateComment1() throws Throwable  {
    ...
    public void testSetMainFactory2() throws Throwable  {
        ...
        Object initialDefaultCoreFactoryFactory = getFieldValue(defaultCoreFactory, "factory");
        
        defaultCoreFactory.setMainFactory(factoryMock);
        
        Object finalDefaultCoreFactoryFactory = getFieldValue(defaultCoreFactory, "factory");
        
        assertFalse(initialDefaultCoreFactoryFactory == finalDefaultCoreFactoryFactory);
    }
    ///endregion
    ...
    public void testCreateSourcePosition2() throws Throwable  {
        ...
        SourcePosition actual = defaultCoreFactory.createSourcePosition(compilationUnitMock, 0, 0, intArray);
        
        SourcePositionImpl expected = ((SourcePositionImpl) createInstance("spoon.support.reflect.cu.position.SourcePositionImpl"));
        setField(expected, "compilationUnit", compilationUnitMock);
        setField(expected, "lineSeparatorPositions", intArray);
        setField(expected, "sourceStartline", -1);
        setField(expected, "sourceEnd", 0);
        setField(expected, "sourceStart", 0);
    ...
    public void testCreatePartialSourcePosition2() throws Throwable  {
        ...
        defaultCoreFactory.createPartialSourcePosition(compilationUnitMock);
    }
    ///endregion
    ...
    public void testCreateCompoundSourcePosition2() throws Throwable  {
        ...
        CompoundSourcePosition actual = defaultCoreFactory.createCompoundSourcePosition(compilationUnitMock, 0, 0, 0, 0, intArray);
    ...
    public void testCreateDeclarationSourcePosition2() throws Throwable  {
        ...
        DeclarationSourcePosition actual = defaultCoreFactory.createDeclarationSourcePosition(compilationUnitMock, 0, 0, 1, 0, 0, 0, intArray);
        ...
        setField(expected, "declarationSourceEnd", 0);
        setField(expected, "declarationSourceStart", 0);
        setField(expected, "modifierSourceStart", 1);
        setField(expected, "modifierSourceEnd", 0);
    ...
    public void testCreateDeclarationSourcePosition3() throws Throwable  {
        ...
        DeclarationSourcePosition actual = defaultCoreFactory.createDeclarationSourcePosition(compilationUnitMock, 0, 0, 0, 0, 0, 0, intArray);
    ...
    public void testCreateBodyHolderSourcePosition2() throws Throwable  {
        ...
        BodyHolderSourcePosition actual = defaultCoreFactory.createBodyHolderSourcePosition(compilationUnitMock, 0, 0, 0, 0, 0, 0, 0, 0, intArray);
        
        BodyHolderSourcePositionImpl expected = ((BodyHolderSourcePositionImpl) createInstance("spoon.support.reflect.cu.position.BodyHolderSourcePositionImpl"));
        setField(expected, "compilationUnit", compilationUnitMock);
        setField(expected, "lineSeparatorPositions", intArray);
        setField(expected, "sourceStartline", -1);
        setField(expected, "sourceEnd", 0);
        ...
        setField(expected, "modifierSourceStart", 0);
        setField(expected, "modifierSourceEnd", 0);
        setField(expected, "bodyEnd", 0);
        setField(expected, "bodyStart", 0);
    ...
    public void testCreateBodyHolderSourcePosition3() throws Throwable  {
        ...
        BodyHolderSourcePosition actual = defaultCoreFactory.createBodyHolderSourcePosition(compilationUnitMock, 0, 0, 1, 0, 0, 0, 0, 0, intArray);
    ...
    public void testCreateCompilationUnit2() throws Throwable  {
        ...
        setField(expected, "imports", linkedHashSet);
        ArrayList arrayList = new ArrayList();
        setField(expected, "declaredTypes", arrayList);
        setField(expected, "factory", null);
