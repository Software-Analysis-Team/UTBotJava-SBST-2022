...
public class RpcServerHandlerTest {
    ...
    public void testExceptionCaught2() throws Throwable  {
        ...
        BadBinaryOpValueExpException badBinaryOpValueExpException = ((BadBinaryOpValueExpException) createInstance("javax.management.BadBinaryOpValueExpException"));
        
        rpcServerHandler.exceptionCaught(((ChannelHandlerContext) null), badBinaryOpValueExpException);
    }
    ///endregion
    ...
    public void testUserEventTriggered2() throws Throwable  {
        RpcServerHandler rpcServerHandler = ((RpcServerHandler) createInstance("io.seata.core.rpc.netty.RpcServerHandler"));
        java.lang.Object[] heapDoubleBufferRArray = createArray("[Ljava.nio.HeapDoubleBufferR;", 0);
        
        rpcServerHandler.userEventTriggered(((ChannelHandlerContext) null), heapDoubleBufferRArray);
    }
    ///endregion
