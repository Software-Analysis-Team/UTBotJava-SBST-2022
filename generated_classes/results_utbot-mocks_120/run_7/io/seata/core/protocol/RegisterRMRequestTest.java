...
public class RegisterRMRequestTest {
    ...
    public void testDecode6() throws Throwable  {
        ...
        when(byteBufMock.readShort()).thenReturn(java.lang.Short.MIN_VALUE, (short) 0, java.lang.Short.MIN_VALUE, java.lang.Short.MIN_VALUE);
        when(byteBufMock.readInt()).thenReturn(-2147483647);
