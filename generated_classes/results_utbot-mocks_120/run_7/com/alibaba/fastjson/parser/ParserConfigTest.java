...
public class ParserConfigTest {
    ...
    public void testGetDeserializer3() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        sun.security.provider.X509Factory[] x509FactoryArray = new sun.security.provider.X509Factory[0];
        when(identityHashMapMock.get(any())).thenReturn(null, ((Object) x509FactoryArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
        Class class1 = Object.class;
        ...
        parserConfig.getDeserializer(class1, wildcardTypeImpl);
    }
    ///endregion
    ...
    public void testGetDeserializer15() throws Throwable  {
        ParserConfig parserConfig = ((ParserConfig) createInstance("com.alibaba.fastjson.parser.ParserConfig"));
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        java.lang.Object[] typeConvertingMethodAdapterArray = createArray("java.lang.invoke.TypeConvertingMethodAdapter", 0);
        when(identityHashMapMock.get(any())).thenReturn(((Object) typeConvertingMethodAdapterArray));
        setField(parserConfig, "deserializers", identityHashMapMock);
    ...
    public void testGetDeserializer16() throws Throwable  {
        ...
        IdentityHashMap identityHashMapMock = mock(IdentityHashMap.class);
        StackTraceElementDeserializer stackTraceElementDeserializer = ((StackTraceElementDeserializer) createInstance("com.alibaba.fastjson.parser.deserializer.StackTraceElementDeserializer"));
        when(identityHashMapMock.get(any())).thenReturn(((Object) stackTraceElementDeserializer));
        setField(parserConfig, "deserializers", identityHashMapMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(stackTraceElementDeserializer, actual));
    }
    ///endregion
    ...
    public void testConfigFromPropety3() throws Throwable  {
        ...
        java.lang.Object[] entryArray = createArray("java.util.Hashtable$Entry", 0);
    ...
    public void testCreateFieldDeserializer10() throws Throwable  {
        ...
        setField(expected, "clazz", class1);
        setField(expected, "fieldInfo", fieldInfoMock);
        setField(expected, "itemType", parameterizedTypeImpl);
    ...
    public void testCreateFieldDeserializer15() throws Throwable  {
        ...
        typeArray1[0] = ((Type) parameterizedTypeImpl);
        setField(wildcardTypeImpl, "upperBounds", typeArray1);
        typeArray[0] = ((Type) wildcardTypeImpl);
        setField(parameterizedTypeImpl, "actualTypeArguments", typeArray);
        setField(fieldInfoMock, "fieldType", parameterizedTypeImpl);
