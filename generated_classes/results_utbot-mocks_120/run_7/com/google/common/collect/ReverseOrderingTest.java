...
public class ReverseOrderingTest {
    ...
    public void testCompare2() throws Throwable  {
        ...
        int actual = reverseOrdering.compare(thaiBuddhistDateArray, nonfairSyncArray);
    ...
    public void testMin2() throws Throwable  {
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(fixedNodeBuilderArray, actual));
    }
    ///endregion
    ...
    public void testMin4() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        Object directed = createInstance("com.google.common.graph.EndpointPairIterator$Directed");
        
        Class reverseOrderingClazz = Class.forName("com.google.common.collect.ReverseOrdering");
        Class directedType = Class.forName("java.util.Iterator");
        Method minMethod = reverseOrderingClazz.getDeclaredMethod("min", directedType);
        minMethod.setAccessible(true);
        java.lang.Object[] minMethodArguments = new java.lang.Object[1];
        minMethodArguments[0] = directed;
        Object actual = minMethod.invoke(reverseOrdering, minMethodArguments);
    ...
    public void testMin6() throws Throwable  {
        ...
        setField(reverseOrdering, "forwardOrder", orderingMock);
        java.time.chrono.ThaiBuddhistDate[] thaiBuddhistDateArray = new java.time.chrono.ThaiBuddhistDate[0];
        jdk.internal.org.xml.sax.SAXException[] sAXExceptionArray = new jdk.internal.org.xml.sax.SAXException[0];
        
        Object actual = reverseOrdering.min(thaiBuddhistDateArray, sAXExceptionArray);
    ...
    public void testMin8() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] subRangeSetRangesByLowerBoundArray = createArray("com.google.common.collect.TreeRangeSet$SubRangeSetRangesByLowerBound", 0);
        when(orderingMock.max(any(), any(), any(), any())).thenReturn(((Object) subRangeSetRangesByLowerBoundArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        java.lang.Object[] handlerArray = createArray("[Ljdk.internal.org.objectweb.asm.Handler;", 0);
        
        Object actual = reverseOrdering.min(stdSocketOptionArray, compactByteArrayArray, handlerArray, ((java.lang.Object[]) null));
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(subRangeSetRangesByLowerBoundArray, actual));
    }
    ///endregion
    ...
    public void testMax2() throws Throwable  {
        ...
        when(orderingMock.min(any(), any())).thenReturn(((Object) fifoWaitQueueArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        sun.net.ConnectionResetException[] connectionResetExceptionArray = new sun.net.ConnectionResetException[0];
        jdk.internal.org.xml.sax.SAXException[][] sAXExceptionArray = new jdk.internal.org.xml.sax.SAXException[0][];
        
        Object actual = reverseOrdering.max(connectionResetExceptionArray, sAXExceptionArray);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(fifoWaitQueueArray, actual));
    }
    ///endregion
    ...
    public void testMax4() throws Throwable  {
        ReverseOrdering reverseOrdering = ((ReverseOrdering) createInstance("com.google.common.collect.ReverseOrdering"));
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] rangesMatcherArray = createArray("com.google.common.base.CharMatcher$RangesMatcher", 0);
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterable.class))).thenReturn(((Object) rangesMatcherArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        ...
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(rangesMatcherArray, actual));
    }
    ///endregion
    ...
    public void testMax6() throws Throwable  {
        ...
        Ordering orderingMock = mock(Ordering.class);
        java.lang.Object[] fifoWaitQueueArray = createArray("java.util.concurrent.SynchronousQueue$FifoWaitQueue", 0);
        when(orderingMock.min(org.mockito.ArgumentMatchers.any(Iterator.class))).thenReturn(((Object) fifoWaitQueueArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
    ...
    public void testMax8() throws Throwable  {
        ...
        Ordering orderingMock = mock(Ordering.class);
        sun.net.ConnectionResetException[] connectionResetExceptionArray = new sun.net.ConnectionResetException[0];
        when(orderingMock.min(any(), any(), any(), any())).thenReturn(((Object) connectionResetExceptionArray));
        setField(reverseOrdering, "forwardOrder", orderingMock);
        Object handler = createInstance("jdk.internal.org.objectweb.asm.Handler");
        java.lang.Object[] ofLongArray = createArray("[Ljava.util.stream.StreamSpliterators$ArrayBuffer$OfLong;", 0);
        java.lang.Object[] objectArray = new java.lang.Object[9];
        
        Object actual = reverseOrdering.max(handler, null, ofLongArray, objectArray);
        
        
        // Current deep equals depth exceeds max depth 0
        assertTrue(deepEquals(connectionResetExceptionArray, actual));
    }
    ///endregion
